 ...
 * @property {('path'|'unsupported_extension'|'unsupported_image'|'encrypted_content'|'conversion_error'|'access_denied'|'not_found'|'other')} .tag - Tag identifying the union variant.
 */
