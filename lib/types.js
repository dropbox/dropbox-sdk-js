 ...
 * @property {('account_takeover'|'data_loss_protection'|'malware_sharing'|'massive_file_operation'|'na'|'threat_management'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('billing_admin'|'limited_admin'|'member_only'|'support_admin'|'team_admin'|'user_management_admin'|'other')} .tag - Tag identifying the union variant.
 */
