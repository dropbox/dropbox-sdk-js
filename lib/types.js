...
/**
 * @typedef {Object} OpenidAuthError
 * @property {('invalid_token'|'no_openid_auth'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {OpeniderrUnion} [err]
 * @property {string} error_message - Brief explanation of the error.
 */
...
/**
 * @typedef {Object} OpeniderrUnion
 * @property {OpenidAuthError} [auth_error] - Available if .tag is auth_error.
 * @property {('auth_error'|'other')} .tag - Tag identifying the union variant.
 */
