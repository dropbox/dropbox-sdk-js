 ...
 * @property {FilesThumbnailQuality} quality - Field is only returned for
 * "internal" callers. Quality of the thumbnail image.
 ...
 * @property {('w32h32'|'w64h64'|'w128h128'|'w256h256'|'w480h320'|'w640h480'|'w960h640'|'w1024h768'|'w2048h1536'|'w3200h2400')} .tag - Tag identifying the union variant.
 */
 ...
 * the way.
 * @property {('malformed_path'|'conflict'|'no_write_permission'|'insufficient_space'|'disallowed_name'|'team_folder'|'operation_suppressed'|'too_many_write_operations'|'access_restricted'|'team_folder_insufficient_space'|'member_folder_insufficient_space'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} [family_name] - Last name of user.
 * @property {string} [given_name] - First name of user.
 * @property {string} [email] - Email address of user.
 * @property {boolean} [email_verified] - If user is email verified.
 * @property {string} iss - Issuer of token (in this case Dropbox).
 ...
 * @property {string} [fp_sealed_result] - Field is only returned for "internal"
 * callers. The FingerprintJS Sealed Client Result value
 */
 ...
 * user has since lost access to their email.
