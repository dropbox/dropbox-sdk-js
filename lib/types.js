 ...
 * @property {string} [content_hash] - A hash of the entire request body which
 * is all the concatenated pieces of file content that were uploaded in this
 * call. If provided and the uploaded content does not match this hash, an error
