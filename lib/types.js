 ...
 * destination.
 * @property {boolean} allow_shared_folder - This flag has no effect.
 * @property {boolean} autorename - If there's a conflict, have the Dropbox
 ...
 * @property {('filename'|'file_content'|'filename_and_content'|'image_content'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {boolean} [include_highlights] - Deprecated and moved this option
 ...
 * the way.
 * @property {('malformed_path'|'conflict'|'no_write_permission'|'insufficient_space'|'disallowed_name'|'team_folder'|'operation_suppressed'|'too_many_write_operations'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {boolean} allow_comments - Whether comments are enabled for the
 * linked file. This takes the team commenting policy into account.
 * @property {boolean} team_restricts_comments - Whether the team has disabled
 * commenting globally.
 ...
 * @property {SharingRequestedVisibility} [requested_visibility] - Use audience
 ...
 * @property {string} team_member_id - The unique id of the member owning the
 * device.
 * @property {boolean} keep_app_folder - This flag is not longer supported, the
 * application dedicated folder (in case the application uses  one) will be
 * kept.
 */
 ...
 * @property {('all_users'|'disabled'|'invited_users'|'prevent_personal_creation'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('billing_admin'|'compliance_admin'|'content_admin'|'limited_admin'|'member_only'|'reporting_admin'|'security_admin'|'support_admin'|'team_admin'|'user_management_admin'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('admin_alerting'|'apps'|'comments'|'data_governance'|'devices'|'domains'|'encryption'|'file_operations'|'file_requests'|'groups'|'logins'|'members'|'paper'|'passwords'|'reports'|'sharing'|'showcase'|'sso'|'team_folders'|'team_policies'|'team_profile'|'tfa'|'trusted_teams'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * replay_file_shared_link_modified. (sharing) Modified shared link in Replay
 ...
 * @property {('exceed_license_cap'|'success'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * field instead.
 * @property {boolean} [was_linked_apps_truncated] - (Deprecated) True if the
 * linked_apps list was truncated to the maximum supported length (50).
 * @property {boolean} [was_linked_devices_truncated] - (Deprecated) True if the
 * linked_devices list was truncated to the maximum supported length (50).
 * @property {boolean} [was_linked_shared_folders_truncated] - (Deprecated) True
 * if the linked_shared_folders list was truncated to the maximum supported
 * length (50).
 ...
 * @property {('apple_oauth'|'first_party_token_exchange'|'google_oauth'|'lenovo_oauth'|'password'|'qr_code'|'saml'|'two_factor_authentication'|'web_session'|'other')} .tag - Tag identifying the union variant.
 */
