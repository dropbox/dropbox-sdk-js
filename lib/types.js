 ...
 * .tag is cant_move_into_family. Some content cannot be moved into the Family
 * Room folder under certain circumstances, see detailed error.
 * @property {('from_lookup'|'from_write'|'to'|'cant_copy_shared_folder'|'cant_nest_shared_folder'|'cant_move_folder_into_itself'|'too_many_files'|'duplicated_or_nested_paths'|'cant_transfer_ownership'|'insufficient_quota'|'internal_error'|'cant_move_shared_folder'|'cant_move_into_vault'|'cant_move_into_family'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * the way.
 * @property {('malformed_path'|'conflict'|'no_write_permission'|'insufficient_space'|'disallowed_name'|'team_folder'|'operation_suppressed'|'too_many_write_operations'|'access_restricted'|'other')} .tag - Tag identifying the union variant.
 */
