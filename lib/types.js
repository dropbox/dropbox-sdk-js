 ...
 * @property {number} latitude - Latitude / longitude in decimal degrees
 ...
 * reference direction).
 * @property {string} timestamp - Timestamp / datestamp of the GPS fix, in the
 * EXIF-provided format.
 ...
 * @property {string} exposure_time - fraction in string form, e.g. "1/250"
 * @property {number} aperture_value
 * @property {number} iso_speed
 * @property {string} focal_length - e.g. "26.0 mm"
 * @property {number} megapixels
 * @property {string} artist
 * @property {string} copyright
 * @property {RivieraApiExifGpsMetadata} [gps_metadata]
 */
 ...
 * @property {string} codec_type - "audio", "video", etc.
 * @property {string} codec_name
 * @property {number} bitrate_bps
 * @property {number} duration_s
 * @property {number} width - Video-specific fields (zero / empty for audio
 * streams).
 * @property {number} height
 * @property {number} frames_per_second
 * @property {number} rotation
 * @property {string} display_aspect_ratio - e.g. "16:9"
 * @property {number} channels - Audio-specific fields (zero / empty for video
 * streams).
 * @property {string} channel_layout
 * @property {number} sample_rate_s
 ...
 * PowerPoint, `words`/`pages` for Word).
 * @typedef {Object} RivieraApiOfficeMetadata
 * @property {RivieraOfficeFileType} file_type
 ...
 * @property {number} total_edit_time_minutes
 * @property {number} pages - Word only.
 * @property {number} words
 * @property {number} slides - PowerPoint only.
 ...
 * @property {number} width - Width / height of the first page, in PDF points.
 * @property {number} height
 */
 ...
 * @property {Array.<RivieraApiTranscriptSegment>} [segments]
 * @property {string} transcript_locale
 */
 ...
 * extracted for the requested file. Callers should read the matching field of
 * the `metadata` oneof.
 ...
 * @property {string} audio_language - Optional ISO 639-1 two-letter language
 * code hinting the spoken language of the source audio (e.g. "en", "ja"). When
 * empty, the service auto-detects the language; supplying a hint improves
 * accuracy and latency for short or ambiguous clips. Unsupported languages fall
 ...
 * structured transcript produced for the requested media asset, with
 ...
 * @property {RivieraApiExifMetadata} [exif] - Available if .tag is exif.
 * @property {RivieraApiMediaMetadata} [media] - Available if .tag is media.
 * @property {RivieraApiPdfMetadata} [pdf] - Available if .tag is pdf.
