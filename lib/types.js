 ...
 * .tag is cant_move_into_vault. Some content cannot be moved into Vault under
 * certain circumstances, see detailed error.
 * @property {('from_lookup'|'from_write'|'to'|'cant_copy_shared_folder'|'cant_nest_shared_folder'|'cant_move_folder_into_itself'|'too_many_files'|'duplicated_or_nested_paths'|'cant_transfer_ownership'|'insufficient_quota'|'internal_error'|'cant_move_shared_folder'|'cant_move_into_vault'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * Available if .tag is properties_error. The supplied property group is
 * invalid. The file has uploaded without property groups.
 * @property {('lookup_failed'|'path'|'properties_error'|'too_many_shared_folder_targets'|'too_many_write_operations'|'concurrent_session_data_not_allowed'|'concurrent_session_not_closed'|'concurrent_session_missing_data'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('not_found'|'incorrect_offset'|'closed'|'not_closed'|'too_large'|'concurrent_session_invalid_offset'|'concurrent_session_invalid_data_size'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('concurrent_session_data_not_allowed'|'concurrent_session_close_not_allowed'|'other')} .tag - Tag identifying the union variant.
 */
