...
/**
 * @typedef {Object} AccountAccountPhotoGetArg
 * @property {string} dbx_account_id - Encoded ID of the user. Must start either
 * with 'dbid:' or 'dbaphid:'.
 * @property {string} size - A string representing the size of the photo.
 * @property {boolean} circle_crop - True if the photo should be cropped and
 * false otherwise.
 * @property {boolean} expect_account_photo - True if we expect account photo to
 * exist.
 */

/**
 * @typedef {Object} AccountAccountPhotoGetError
 * @property {AccountThumbnailError} [thumbnail_error] - Available if .tag is
 * thumbnail_error. Indicates infrastructural failure.
 * @property {('thumbnail_error'|'account_photo_missing'|'expected_account_photo_missing'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} AccountAccountPhotoGetResult
 * @property {string} content_type - The data returned by get_photo.
 */

/**
 * This struct is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} AccountDeleteProfilePhotoArg
 */

/**
 * This union is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} AccountDeleteProfilePhotoError
 ...
 * This struct is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} AccountDeleteProfilePhotoResult
 */
...
/**
 * @typedef {Object} AccountThumbnailError
 * @property {('permanent_failure'|'temporary_failure'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {AuthNoPermissionError} [no_permission] - Available if .tag is
 * no_permission. Caller does not have permission to access the resource.
 * @property {('invalid_account_type'|'paper_access_denied'|'team_access_denied'|'no_permission'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} AuthNoPermissionError
 * @property {AuthUnauthorizedAccountIdUsageError}
 * [unauthorized_account_id_usage] - Available if .tag is
 * unauthorized_account_id_usage. Current caller does not have permission to
 * access the account information for one or more of the specified account IDs.
 * @property {('unauthorized_account_id_usage'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} AuthUnauthorizedAccountIdUsageError
 * @property {Array.<string>} unauthorized_account_ids - The account IDs that
 * the caller does not have permission to use.
 */
 ...
 * @typedef {Object} CheckEchoError
 * @property {('user_requested'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} CommonDropboxDuration
 ...
 * member of a team with a separate team root, or the user root if user is
 * member of a team with separate distinct roots for users. Otherwise it will be
 * the same as RootInfo.home_namespace_id.
 ...
 * @property {FilePropertiesPropertyType} type
 */
 ...
 * @property {string} [video_project_id] - If this request was created from
 ...
 * @property {('disabled_for_team'|'other'|'not_found'|'not_a_folder'|'app_lacks_access'|'no_permission'|'email_unverified'|'validation_error'|'no_write_permission'|'invalid_location'|'rate_limit')} .tag - Tag identifying the union variant.
 */

/**
 * There was an error deleting all closed file requests.
 * @typedef {Object} FileRequestsDeleteAllClosedFileRequestsError
 * @property {('disabled_for_team'|'other'|'not_found'|'not_a_folder'|'app_lacks_access'|'no_permission'|'email_unverified'|'validation_error'|'no_write_permission')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('disabled_for_team'|'other'|'not_found'|'not_a_folder'|'app_lacks_access'|'no_permission'|'email_unverified'|'validation_error'|'no_write_permission'|'file_request_open')} .tag - Tag identifying the union variant.
 */
 ...
 * results will include a flag for each file indicating whether or not that file
 ...
 * templates.
 * @property {Array.<Object>} [include_property_templates] - Field is
 ...
 * mounted.
 * @property {string} [parent_shared_folder_id] - Field is deprecated. Please
 * use FileSharingInfo.parent_shared_folder_id or
 * FolderSharingInfo.parent_shared_folder_id instead.
 * @property {string} [preview_url] - The preview URL of the file.
 * @property {boolean} [is_restorable] - If present, indicates whether this
 ...
 * @property {string} [rev] - Field is deprecated. Please specify revision in
 * path instead.
 */
 ...
 * @property {boolean} [is_restorable] - If present, indicates whether this file
 ...
 * FolderSharingInfo.parent_shared_folder_id instead.
 * @property {string} [preview_url] - The preview URL of the file.
 * @property {string} [shared_folder_id] - Field is deprecated. Please use
 ...
 * @property {FilesLookupError} [path] - Available if .tag is path.
 * @property {('path'|'email_not_verified'|'unsupported_file'|'not_allowed'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} FilesImportFormat
 ...
 * of all subfolders. In some cases, setting ListFolderArg.recursive to true may
 * lead to performance issues or errors, especially when traversing folder
 * structures with a large number of items. A workaround for such cases is to
 * set ListFolderArg.recursive to false and traverse subfolders one at a time.
 * @property {boolean} include_media_info - Field is deprecated. If true,
 * FileMetadata.media_info is set for photo and video. This parameter will no
 ...
 * @property {boolean} include_restorable_info - If true, each returned deleted
 ...
 * @property {string} [before_rev] - If set, ListRevisions will only return
 * revisions prior to before_rev. Can be set using the last revision from a
 * previous call to list_revisions to fetch the next page of revisions. Only
 * supported in path mode.
 * @property {boolean} include_restorable_info - If true, each returned revision
 ...
 * @property {FilesLookupError} [path] - Available if .tag is path.
 * @property {('path'|'invalid_before_rev'|'before_rev_not_supported'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * revision in the response is either deleted or moved. If before_rev is set,
 ...
 * @property {boolean} has_more - If true, then there are more entries
 * available. Call list_revisions again with before_rev equal to the revision of
 * the last returned entry to retrieve the rest.
 ...
 * @property {FilesFileLock} lock - Field is deprecated. The file lock state
 * after the operation.
 */
 ...
 * @property {('malformed_path'|'not_found'|'not_file'|'not_folder'|'restricted_content'|'unsupported_content_type'|'locked'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesMediaInfo
 * @property {(FilesPhotoMetadata|FilesVideoMetadata)} [metadata] - Available if
 * .tag is metadata. The metadata for the photo/video. Uses
...
/**
 * @typedef {Object} FilesMoveIntoFamilyError
 * @property {('is_shared_folder'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesMoveIntoVaultError
 * @property {('is_shared_folder'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesPaperContentError
 * @property {('insufficient_permissions'|'content_malformed'|'doc_length_exceeded'|'image_size_exceeded'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesPaperCreateArg
 * @property {Object} [contents] - The file contents to be uploaded.
 * @property {string} path - The fully qualified path to the location in the
 * user's Dropbox where the Paper Doc should be created. This should include the
 * document's title and end with .paper.
 * @property {FilesImportFormat} import_format - The format of the provided
 * data.
 */

/**
 * @typedef {Object} FilesPaperCreateError
 * @property {('insufficient_permissions'|'content_malformed'|'doc_length_exceeded'|'image_size_exceeded'|'other'|'invalid_path'|'email_unverified'|'invalid_file_extension'|'paper_disabled')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesPaperCreateResult
 * @property {string} url - URL to open the Paper Doc.
 * @property {string} result_path - The fully qualified path the Paper Doc was
 * actually created at.
 * @property {string} file_id - The id to use in Dropbox APIs when referencing
 * the Paper Doc.
 * @property {number} paper_revision - The current doc revision.
 */

/**
 * @typedef {Object} FilesPaperDocUpdatePolicy
 * @property {('update'|'overwrite'|'prepend'|'append'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesPaperUpdateArg
 * @property {Object} [contents] - The file contents to be uploaded.
 * @property {string} path - Path in the user's Dropbox to update. The path must
 * correspond to a Paper doc or an error will be returned.
 * @property {FilesImportFormat} import_format - The format of the provided
 * data.
 * @property {FilesPaperDocUpdatePolicy} doc_update_policy - How the provided
 * content should be applied to the doc.
 * @property {number} [paper_revision] - The latest doc revision. Required when
...
/**
 * @typedef {Object} FilesPaperUpdateError
 * @property {FilesLookupError} [path] - Available if .tag is path.
 * @property {('insufficient_permissions'|'content_malformed'|'doc_length_exceeded'|'image_size_exceeded'|'other'|'path'|'revision_mismatch'|'doc_archived'|'doc_deleted')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesPaperUpdateResult
 * @property {number} paper_revision - The current doc revision.
 */
 ...
 * destination.
 * @property {boolean} allow_shared_folder - Field is deprecated. This flag has
 * no effect.
 * @property {boolean} autorename - If there's a conflict, have the Dropbox
 ...
 * @property {FilesMoveIntoVaultError} [cant_move_into_vault] - Available if
 * .tag is cant_move_into_vault. Some content cannot be moved into Vault under
 * certain circumstances, see detailed error.
 * @property {FilesMoveIntoFamilyError} [cant_move_into_family] - Available if
 * .tag is cant_move_into_family. Some content cannot be moved into the Family
 * Room folder under certain circumstances, see detailed error.
 * @property {('from_lookup'|'from_write'|'to'|'cant_copy_shared_folder'|'cant_nest_shared_folder'|'cant_move_folder_into_itself'|'too_many_files'|'duplicated_or_nested_paths'|'cant_transfer_ownership'|'insufficient_quota'|'internal_error'|'cant_move_shared_folder'|'cant_move_into_vault'|'cant_move_into_family'|'team_folder_insufficient_quota'|'member_folder_insufficient_quota'|'other'|'too_many_write_operations')} .tag - Tag identifying the union variant.
 */
 ...
 * .tag is cant_move_into_family. Some content cannot be moved into the Family
 * Room folder under certain circumstances, see detailed error.
 * @property {('from_lookup'|'from_write'|'to'|'cant_copy_shared_folder'|'cant_nest_shared_folder'|'cant_move_folder_into_itself'|'too_many_files'|'duplicated_or_nested_paths'|'cant_transfer_ownership'|'insufficient_quota'|'internal_error'|'cant_move_shared_folder'|'cant_move_into_vault'|'cant_move_into_family'|'team_folder_insufficient_quota'|'member_folder_insufficient_quota'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} tag_text - The tag to remove. Will be automatically
 ...
 * @property {('path_lookup'|'path_write'|'invalid_revision'|'in_progress'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * invalid_argument.
 * @property {('path'|'invalid_argument'|'internal_error'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} FilesSearchMatchFieldOptions
 * @property {boolean} include_highlights - Whether to include highlight span
 * from file title.
 */
...
/**
 * Indicates what type of match was found for a given item.
 * @typedef {Object} FilesSearchMatchTypeV2
 * @property {('filename'|'file_content'|'filename_and_content'|'image_content'|'metadata'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * folder.
 * @property {FilesSearchMatchTypeV2} [match_type] - The type of the match.
 * @property {Array.<FilesHighlightSpan>} [highlight_spans] - The list of
 * HighlightSpan determines which parts of the file title should be highlighted.
 */
 ...
 * @property {number} max_results - The maximum number of search results to
 * return.
 * @property {FilesSearchOrderBy} [order_by] - Specified property of the order
 * of search results. By default, results are sorted by relevance.
...
/**
 * @typedef {Object} FilesSearchOrderBy
 * @property {('relevance'|'last_modified_time'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * results.
 * @property {FilesSearchMatchFieldOptions} [match_field_options] - Options for
 * search results match fields.
 * @property {boolean} [include_highlights] - Field is deprecated. Deprecated
 ...
 * password-protected shared links to files unless it can be read from a cookie.
 */
 ...
 * jpeg (default), png, or webp. For images that are photos, jpeg should be
 * preferred, while png is better for screenshots and digital arts, and web for
 * compression.
 ...
 * @property {boolean} [exclude_media_info] - Normally, FileMetadata.media_info
 * is set for photo and video. When this flag is true, FileMetadata.media_info
 * is not populated. This improves latency for use cases where `media_info` is
 * not needed.
 */
 ...
 * @property {('path'|'unsupported_extension'|'unsupported_image'|'encrypted_content'|'conversion_error')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesThumbnailFormat
 * @property {('jpeg'|'png'|'webp')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesThumbnailMode
 * @property {('strict'|'bestfit'|'fitone_bestfit'|'original')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesThumbnailQuality
 * @property {('quality_80'|'quality_90')} .tag - Tag identifying the union variant.
 */
 ...
 * is not populated. This improves latency for use cases where `media_info` is
 * not needed.
 * @property {boolean} preserve_transparency - Whether to preserve the original
 * image's transparency in the thumbnail. This is supported only when the output
 * format is PNG or WebP. Requests that set this flag with JPEG output return an
 * error.
 */
 ...
 * @property {('path'|'unsupported_extension'|'unsupported_image'|'encrypted_content'|'conversion_error'|'access_denied'|'not_found'|'unsupported_output_format'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * error will be returned. Optional, but recommended to avoid committing data
 * corrupted in transit. For more information see our Content hash
 * https://www.dropbox.com/developers/reference/content-hash page.
 */
 ...
 * @property {('path'|'properties_error'|'payload_too_large'|'content_hash_mismatch'|'encryption_not_supported'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} FilesUploadSessionAppendBatchArg
 * @property {Object} [contents] - The file contents to be uploaded.
 * @property {Array.<FilesUploadSessionAppendBatchArgEntry>} entries - Append
 * information for each file in the batch.
 * @property {string} [content_hash] - A single hash of all the concatenated
 * file contents uploaded in this call. If provided and the uploaded content
 * does not match this hash, an error will be returned. Optional, but
...
/**
 * @typedef {Object} FilesUploadSessionAppendBatchArgEntry
 * @property {FilesUploadSessionCursor} cursor - Contains the upload session ID
 * and the offset.
 * @property {number} length - Length in bytes of the data that should be
 * appended for this session. Used to split the batched upload data for multiple
 * upload sessions.
 * @property {boolean} close - If true, the current session will be closed, at
 * which point you won't be able to call upload_session/append_batch anymore
 * with the current session.
 */

/**
 * @typedef {Object} FilesUploadSessionAppendBatchEntryError
 ...
 * @property {('not_found'|'incorrect_offset'|'closed'|'too_large'|'concurrent_session_invalid_offset'|'concurrent_session_invalid_data_size'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesUploadSessionAppendBatchError
 * @property {('payload_too_large'|'content_hash_mismatch'|'length_mismatch'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} FilesUploadSessionAppendBatchResult
 * @property {Array.<FilesUploadSessionAppendBatchResultEntry>} entries - Each
 * entry in UploadSessionAppendBatchArg.entries will appear at the same position
 * inside UploadSessionAppendBatchResult.entries.
 */

/**
 * @typedef {Object} FilesUploadSessionAppendBatchResultEntry
 * @property {FilesUploadSessionAppendBatchEntryError} [failure] - Available if
 * .tag is failure.
 * @property {('success'|'failure')} .tag - Tag identifying the union variant.
 */
 ...
 * received and processed successfully but the client did not receive the
 * response, e.g. due to a network error.
 * @property {('not_found'|'incorrect_offset'|'closed'|'too_large'|'concurrent_session_invalid_offset'|'concurrent_session_invalid_data_size'|'payload_too_large'|'content_hash_mismatch'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {number} offset - Offset in bytes at which data should be appended.
 ...
 * received and processed successfully but the client did not receive the
 * response, e.g. due to a network error.
 * @property {('not_found'|'incorrect_offset'|'closed'|'not_closed'|'too_large'|'concurrent_session_invalid_offset'|'concurrent_session_invalid_data_size'|'payload_too_large'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} FilesUploadSessionStartBatchArg
 * @property {number} num_sessions - The number of upload sessions to start.
 * @property {FilesUploadSessionType} [session_type] - Type of upload session
 * you want to start. If not specified, default is UploadSessionType.sequential.
 */

/**
 * @typedef {Object} FilesUploadSessionStartBatchResult
 * @property {Array.<string>} session_ids - A List of unique identifiers for the
 * upload session. Pass each session_id to upload_session/append:2 and
...
/**
 * @typedef {Object} FilesUploadSessionType
 * @property {('sequential'|'concurrent'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * the way.
 * @property {('malformed_path'|'conflict'|'no_write_permission'|'insufficient_space'|'disallowed_name'|'team_folder'|'operation_suppressed'|'too_many_write_operations'|'access_restricted'|'team_folder_insufficient_space'|'member_folder_insufficient_space'|'upload_traffic_limit_reached'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * given "rev" matches the existing file's "rev". The supplied value should be
 * the latest known "rev" of the file, for example, from :type:`FileMetadata`,
 * from when the file was last downloaded by the app. This will cause the file
 * on the Dropbox servers to be overwritten if the given "rev" matches the
 * existing file's current "rev" on the Dropbox servers. The autorename strategy
 * is to append the string "conflicted copy" to the file name. For example,
...
/**
 * @typedef {Object} OpenidOpenIdError
 * @property {('incorrect_openid_scopes'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * No Parameters
 * @typedef {Object} OpenidUserInfoArgs
 */

/**
 * @typedef {Object} OpenidUserInfoError
 * @property {OpenidOpenIdError} [openid_error] - Available if .tag is
 * openid_error.
 * @property {('openid_error'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} OpenidUserInfoResult
 * @property {string} [family_name] - Last name of the user.
 * @property {string} [given_name] - First name of the user.
 * @property {string} [email] - The user's email address. Be aware it's possible
 * that the user has since lost access to their email. Note: email is not a
 * unique or stable identifier for a Dropbox account. Users can change their
 * email, and emails can be reused by different accounts. Apps should not use
 * email as a key for account identification; use sub instead.
 * @property {boolean} [email_verified] - If the user's email address is
 * verified.
 * @property {string} iss - Issuer of the token (in this case Dropbox).
 * @property {string} sub - An identifier for the user. This is the Dropbox
 * account_id, a string value such as dbid:AAH4f99T0taONIb-OurWxbNQ6ywGRopQngc.
 * The account_id is a unique and stable identifier for a Dropbox account,
 ...
 * @property {('html'|'markdown'|'json'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * Argument for retrieving Paper doc metadata. Accepts either a legacy Paper doc
 * ID or a Cloud Doc file ID.
 * @typedef {Object} PaperGetDocMetadataArg
 * @property {string} [doc_id] - Legacy Paper doc identifier.
 * @property {string} [file_id] - Dropbox file ID for Cloud Docs (post-PiFS
 * migration).
 */
 ...
 * arguments error.
 * @property {Timestamp} [stop_at_date] - Do not return results beyond this
 * date. Behavior depends on sort order.
 */
 ...
 * @property {boolean} include_comments - When true, export includes comment
 * threads (e.g. markdown footnotes). When false or omitted, body only. Other
 * formats may adopt this later; currently only markdown uses it. Plain bool
 ...
 * @typedef {Object} PaperPaperDocGetMetadataResult
 * @property {string} doc_id - The Paper doc ID.
 * @property {string} owner - The Paper doc owner's email address.
 * @property {string} title - The Paper doc title.
 * @property {Timestamp} created_date - The Paper doc creation date.
 * @property {PaperPaperDocStatus} status - The Paper doc status.
 * @property {number} revision - The Paper doc revision. Simply an ever
 * increasing number.
 * @property {Timestamp} last_updated_date - The date when the Paper doc was
 * last edited.
 * @property {string} last_editor - The email address of the last editor of the
 * Paper doc.
 */
 ...
 * @typedef {Object} PaperPaperDocStatus
 * @property {('active'|'deleted'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * file.
 * @typedef {Object} RivieraApiExifGpsMetadata
 * @property {number} latitude - Latitude in decimal degrees (positive = north,
 * negative = south).
 * @property {number} longitude - Longitude in decimal degrees (positive = east,
 * negative = west).
 * @property {string} altitude - Altitude in meters, as reported by the source
 * (string to preserve the original representation, which may include a
 * reference direction).
 * @property {string} timestamp - Time of the GPS fix, in the EXIF-provided
 * format.
 * @property {string} datestamp - Date of the GPS fix, in the EXIF-provided
 * format.
 */
 ...
 * @typedef {Object} RivieraApiExifMetadata
 * @property {number} image_width - Width of the image, in pixels.
 * @property {number} image_height - Height of the image, in pixels.
 * @property {string} camera_make - Manufacturer of the device that captured the
 * image, e.g. "Apple".
 * @property {string} camera_model - Model of the device that captured the
 * image, e.g. "iPhone 15 Pro".
 * @property {string} lens_model - Model of the lens the image was captured
 * with, when the source records it.
 * @property {string} date_time_original - Capture time in the EXIF-provided
 * format (local time of the camera).
 * @property {string} offset_time_original - Timezone offset for
 * ApiExifMetadata.date_time_original, e.g. "+09:00".
 * @property {number} orientation - EXIF orientation value (1-8). See the EXIF
 * spec; 1 is the normal upright orientation.
 * @property {string} exposure_time - Exposure time the image was captured with,
 * as a fractional-second string, e.g. "1/250".
 * @property {number} aperture_value - Aperture the image was captured at, as
 * reported by the EXIF aperture tag.
 * @property {number} iso_speed - ISO sensitivity the image was captured at.
 * @property {string} focal_length - Focal length the image was captured at,
 * including the unit, e.g. "26.0 mm".
 * @property {number} megapixels - Total pixel count of the image, in
 * megapixels.
 * @property {string} artist - Creator credited in the EXIF artist tag.
 * @property {string} copyright - Copyright notice from the EXIF copyright tag.
 * @property {RivieraApiExifGpsMetadata} [gps_metadata] - Location tags from the
 * image, when the source recorded a location.
 */

/**
 * A single extracted scene-change keyframe.
 * @typedef {Object} RivieraApiKeyframe
 * @property {number} timestamp - Presentation timestamp of the keyframe, in
 * seconds from the start of the video.
 * @property {number} scene_score - Scene-change score that triggered this
 * keyframe, in the range [0.0, 1.0]. Higher values indicate a more pronounced
 * scene change relative to the preceding frame. The first keyframe of a video
 * is always reported as 1.0: the start of a video is a scene boundary by
 * definition, so that score is not a measured frame-to-frame comparison.
 * @property {string} image_base64 - The extracted frame as a base64-encoded
 * JPEG image. Empty when the request set `include_images = false`.
 */
 ...
 * @typedef {Object} RivieraApiMediaMetadata
 * @property {number} bitrate_bps - Overall bitrate of the container, in bits
 * per second.
 * @property {number} duration_s - Duration of the media, in seconds.
 * @property {string} creation_time - Container-level creation time, when
 * present.
 * @property {Array.<RivieraApiMediaStream>} [streams] - The audio and video
 * streams the container holds, in container order.
 */

/**
 * A single audio or video stream within a media file.
 * @typedef {Object} RivieraApiMediaStream
 * @property {number} index - Zero-based index of the stream within the
 * container.
 * @property {string} codec_type - Kind of media the stream carries, e.g.
 * "audio" or "video".
 * @property {string} codec_name - Name of the codec the stream is encoded with,
 * e.g. "h264" or "aac".
 * @property {number} bitrate_bps - Bitrate of this stream, in bits per second.
 * @property {number} duration_s - Duration of this stream, in seconds.
 * @property {number} width - Width of the video frame, in pixels. Zero for
 * audio streams.
 * @property {number} height - Height of the video frame, in pixels. Zero for
 * audio streams.
 * @property {number} frames_per_second - Frame rate of the stream, in frames
 * per second. Zero for audio streams.
 * @property {number} rotation - Rotation to apply on playback, in degrees, as
 * recorded in the stream metadata. Zero for audio streams and for video that
 * needs no rotation.
 * @property {string} display_aspect_ratio - Aspect ratio the video should be
 * displayed at, as a "width:height" string, e.g. "16:9". Empty for audio
 * streams.
 * @property {number} channels - Number of audio channels in the stream. Zero
 * for video streams.
 * @property {string} channel_layout - Layout of the audio channels, e.g.
 * "stereo". Empty for video streams.
 * @property {number} sample_rate_s - Sample rate of the audio stream, in
 * samples per second. Zero for video streams.
 * @property {string} language_iso_639 - ISO 639 language code for the stream,
 * when present.
 */

/**
 * MS Office document metadata. Some fields apply only to specific document
 * types (e.g. ApiOfficeMetadata.slides for PowerPoint, ApiOfficeMetadata.words
 * and ApiOfficeMetadata.pages for Word).
 * @typedef {Object} RivieraApiOfficeMetadata
 * @property {RivieraOfficeFileType} file_type - Which kind of Office document
 * this metadata was extracted from.
 * @property {string} creator - Author recorded in the document properties.
 * @property {string} company - Company recorded in the document properties.
 * @property {string} title - Title recorded in the document properties.
 * @property {string} subject - Subject recorded in the document properties.
 * @property {string} keywords - Keywords recorded in the document properties,
 * in the document's own formatting (typically a single comma- or
 * space-separated string).
 * @property {string} description - Description recorded in the document
 * properties.
 * @property {number} total_edit_time_minutes - Total editing time recorded in
 * the document properties, in minutes.
 * @property {number} pages - Page count recorded in the document properties.
 * Word documents only; zero for PowerPoint and Excel.
 * @property {number} words - Word count recorded in the document properties.
 * Word documents only; zero for PowerPoint and Excel.
 * @property {number} slides - Slide count recorded in the document properties.
 * PowerPoint documents only; zero for Word and Excel.
 * @property {string} revision_number - Revision number recorded in the document
 * properties.
 */

/**
 * PDF document metadata.
 * @typedef {Object} RivieraApiPdfMetadata
 * @property {number} pages - Number of pages in the document.
 * @property {number} width - Width of the first page, in PDF points.
 * @property {number} height - Height of the first page, in PDF points.
 */

/**
 * A transcript, split into segments.
 * @typedef {Object} RivieraApiStructuredTranscript
 * @property {Array.<RivieraApiTranscriptSegment>} [segments] - The segments of
 * the transcript, in playback order.
 * @property {string} transcript_locale - The language of the transcript, as an
 * ISO 639-1 code (e.g. "en"). This is the language detected in the audio, or
 * the one supplied in GetTranscriptArgs.audio_language.
 */

/**
 * A contiguous span of transcribed speech. The span covered by a segment
 * depends on the requested TimestampLevel.
 * @typedef {Object} RivieraApiTranscriptSegment
 * @property {string} text - The transcribed text of this segment.
 * @property {number} start_time - Offset of the start of this segment, in
 * seconds from the beginning of the media.
 * @property {number} end_time - Offset of the end of this segment, in seconds
 * from the beginning of the media.
 */

/**
 * Reason a transcript job failed. Returned in the
 * GetTranscriptAsyncCheckResult.failed variant. This is a semantic error union:
 ...
 * .tag is media_duration_error. The audio to transcribe is longer than the
 * supported maximum.
 ...
 * file ID for a file the authenticated user has access to, e.g.
 * "id:a4ayc_80_OEAAAAAAAAAYa".
 * @property {string} [url] - Available if .tag is url. Either a Dropbox shared
 * link (www.dropbox.com) or an internet-accessible URL pointing to a supported
 ...
 * disabled are rejected as well. - Other URLs are fetched by Dropbox's servers,
 * so they must be reachable from the public internet -- not only from the
 * calling application's network -- and must point at a supported file
 * extension.
 ...
 * the video whose scene-change keyframes should be extracted.
 * @typedef {Object} RivieraGetKeyframesArgs
 * @property {RivieraFileIdOrUrl} [file_id_or_url] - Identifier of the video
 * file to extract keyframes from. Callers must set exactly one of the
 * `FileIdOrUrl` variants. Keyframe extraction is supported for video files
 * only; see the route description for the supported formats. Requests against
 * unsupported formats return `unsupported_format_error`.
 * @property {number} scene_change_threshold - Sensitivity of scene-change
 * detection. A keyframe is emitted whenever the frame-to-frame scene score
 * crosses this threshold, so a LOWER value yields MORE keyframes. Valid range
 * is (0.0, 1.0]. When omitted (0.0) the service uses a default of 0.3, which is
 * a good starting point for most videos.
 * @property {boolean} include_images - When true, each returned keyframe
 * includes the JPEG image bytes, base64-encoded, in `ApiKeyframe.image_base64`.
 * When false, the response contains only per-keyframe metadata (timestamp and
 * scene score) and `image_base64` is left empty -- useful when you only need
 * the scene boundaries and want a small response. NOTE: because the field
 * defaults to false in proto3, callers who want images must set this explicitly
 * to true.
 */

/**
 * Result type for EventBus async check - must end in "CheckResult"
 * @typedef {Object} RivieraGetKeyframesAsyncCheckResult
 * @property {RivieraGetKeyframesResult} [complete] - Available if .tag is
 * complete.
 * @property {RivieraKeyframesExtractionApiV2Error} [failed] - Available if .tag
 * is failed.
 * @property {('in_progress'|'complete'|'failed'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} RivieraGetKeyframesResult
 * @property {Array.<RivieraApiKeyframe>} [frames] - The extracted keyframes,
 * ordered by `timestamp`. May be empty when no scene changes are detected in
 * the source.
 */

/**
 * Arguments for the asynchronous get_markdown_async route. Exactly one of
 * FileIdOrUrl.file_id, FileIdOrUrl.path, or FileIdOrUrl.url must be supplied
 * via GetMarkdownArgs.file_id_or_url to identify the document to convert to
 * markdown.
 ...
 * URIs in the markdown output. This can significantly increase output size.
 */

/**
 * Status of a markdown conversion job started by get_markdown_async, as
 * returned by get_markdown_async/check.
 ...
 * is failed. The job finished unsuccessfully.
 * @property {('in_progress'|'complete'|'failed'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} RivieraGetMarkdownResult
 * @property {string} markdown - The markdown the source document was converted
 * to.
 */
 ...
 * FileIdOrUrl.file_id, FileIdOrUrl.path, or FileIdOrUrl.url must be supplied
 * via GetMetadataArgs.file_id_or_url to identify the file whose metadata should
 * be extracted.
...
/**
 * Status of a metadata extraction job started by get_metadata_async, as
 * returned by get_metadata_async/check.
...
/**
 * @typedef {Object} RivieraGetMetadataResult
 * @property {RivieraMetadataType} metadata_type - The kind of metadata that was
 * extracted for the requested file. Callers should read the matching variant of
 * GetMetadataResult.metadata.
 * @property {RivierametadataUnion} [metadata]
 */

/**
 * Arguments for the asynchronous `get_ocr_async` route. Exactly one of
 * `file_id`, `path`, or `url` must be supplied via `file_id_or_url` to identify
 * the image or PDF whose text should be extracted via OCR (optical character
 * recognition).
 * @typedef {Object} RivieraGetOcrArgs
 * @property {RivieraFileIdOrUrl} [file_id_or_url] - Identifier of the file to
 * run OCR on. Callers must set exactly one of the `FileIdOrUrl` variants. OCR
 * is supported for image files and PDFs, including scanned / non-text PDFs; see
 * the route description for the supported formats. Requests against unsupported
 * formats return `unsupported_format_error`. NOTE: for the `url` variant, only
 * Dropbox shared links (www.dropbox.com) are supported. External (non-Dropbox)
 * URLs are not supported and return `unsupported_format_error`; import the file
 * into Dropbox and reference it by `file_id` or `path` instead.
 */

/**
 * Result type for EventBus async check - must end in "CheckResult"
 * @typedef {Object} RivieraGetOcrAsyncCheckResult
 * @property {RivieraGetOcrResult} [complete] - Available if .tag is complete.
 * @property {RivieraOcrExtractionApiV2Error} [failed] - Available if .tag is
 * failed.
 * @property {('in_progress'|'complete'|'failed'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} RivieraGetOcrResult
 * @property {string} text - The plain-text content extracted from the file via
 * OCR. Words within a line are separated by a single space, lines are
 ...
 * @property {string} hocr - The same content as hOCR: HTML that carries the
 * position of every recognized word. Each page is a `<section>` holding `<p
 * class="line">` elements with one `<span>` per word, and each element carries
 * `data-x`, `data-y`, `data-width`, and `data-height` attributes in pixels
 * relative to the upright page (whose dimensions are on the `<section>`). Use
 * this when you need word coordinates -- to highlight matches over a page
 ...
 * FileIdOrUrl.file_id, FileIdOrUrl.path, or FileIdOrUrl.url must be supplied
 * via GetTranscriptArgs.file_id_or_url to identify the audio or video asset to
 * transcribe.
 ...
 * no audio track fail with ContentApiV2Error.no_audio_error.
 * @property {RivieraTimestampLevel} timestamp_level - Granularity of the time
 * offsets returned for each transcript segment. Defaults to
 ...
 * ignored. Leave empty to use the default filtering behavior.
 * @property {string} audio_language - Hint for the spoken language of the
 * source audio, as an ISO 639-1 code (e.g. "en", "ja"). When empty, the service
 * auto-detects the language; supplying a hint improves accuracy and latency for
 * short or ambiguous clips. Languages the service does not support fall back to
 * auto-detection.
 */

/**
 * Status of a transcript job started by get_transcript_async, as returned by
...
/**
 * @typedef {Object} RivieraGetTranscriptResult
 * @property {RivieraApiStructuredTranscript} [structured_transcript] - The
 * transcript produced for the requested media asset.
 */
 ...
 * on the variant.
 * @typedef {Object} RivieraKeyframesExtractionApiV2Error
 * @property {string} [server_error] - Available if .tag is server_error. An
 * unexpected, typically transient, server-side failure. The string is a
 * human-readable message; retrying with backoff may succeed.
 * @property {string} [user_error] - Available if .tag is user_error. The
 ...
 * GetMarkdownAsyncCheckResult.failed variant. This is a semantic error union:
 * the HTTP status of the poll request itself is unaffected (a poll that
 * surfaces a failed job is still a normal successful poll response). Callers
 * should branch on the variant.
 ...
 * limit. The string is a human-readable message; retrying the same request will
 * not help.
 * @property {('server_error'|'user_error'|'unsupported_format_error'|'link_download_disabled_error'|'shared_link_password_protected'|'limit_exceeded_error'|'conversion_failure_error'|'not_found_error'|'is_a_folder_error'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} RivieraMediaDurationError
 * @property {number} limit - The maximum supported duration, in seconds, of the
 * audio to transcribe.
 */

/**
 * Reason a metadata extraction job failed. Returned in the
 * GetMetadataAsyncCheckResult.failed variant. This is a semantic error union:
 * the HTTP status of the poll request itself is unaffected (a poll that
 * surfaces a failed job is still a normal successful poll response). Callers
 * should branch on the variant.
 ...
 * request could not be processed as supplied (a problem with the caller's
 * input) -- for example an unsupported file format or a file over the size
 * limit for its metadata kind. The string is a human-readable message; retrying
 ...
 * file type.
 * @typedef {Object} RivieraMetadataType
 * @property {('metadata_type_unknown'|'metadata_type_exif'|'metadata_type_media'|'metadata_type_pdf'|'metadata_type_office'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * variant.
 * @typedef {Object} RivieraOcrExtractionApiV2Error
 * @property {string} [server_error] - Available if .tag is server_error. An
 * unexpected, typically transient, server-side failure. The string is a
 * human-readable message; retrying with backoff may succeed.
 * @property {string} [user_error] - Available if .tag is user_error. The
 ...
 * @typedef {Object} RivieraOfficeFileType
 * @property {('office_filetype_unknown'|'office_filetype_word'|'office_filetype_powerpoint'|'office_filetype_excel'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} RivierametadataUnion
 * @property {RivieraApiExifMetadata} [exif] - Available if .tag is exif. EXIF
 * metadata, for image files.
 * @property {RivieraApiMediaMetadata} [media] - Available if .tag is media.
 * Container and per-stream metadata, for audio and video files.
 * @property {RivieraApiPdfMetadata} [pdf] - Available if .tag is pdf. Document
 * metadata, for PDFs.
 * @property {RivieraApiOfficeMetadata} [office] - Available if .tag is office.
 * Document metadata, for MS Office files.
 * @property {('exif'|'media'|'pdf'|'office'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('owner'|'editor'|'viewer'|'viewer_no_comment'|'traverse'|'no_access'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * even an email address is given, this may result in a user being directly
 ...
 * email and device notifications of their invitation.
 ...
 * is access_error.
 * @property {('user_error'|'access_error'|'rate_limit'|'invalid_comment'|'banned_member'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * reached.
 * @property {('access_error'|'email_unverified'|'banned_member'|'bad_member'|'cant_share_outside_team'|'too_many_members'|'too_many_pending_invites'|'rate_limit'|'too_many_invitees'|'insufficient_plan'|'team_folder'|'no_permission'|'invalid_shared_folder'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * unverified email address. Invite unverified users by email address instead of
 * by their Dropbox ID.
 * @property {('automatic_group'|'invalid_dropbox_id'|'invalid_email'|'invalid_group'|'unverified_dropbox_id'|'group_deleted'|'group_not_on_team'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * check documentation for ResolvedVisibility.
 * @typedef {Object} SharingAlphaResolvedVisibility
 * @property {('public'|'team_only'|'password'|'team_and_password'|'shared_folder_only'|'no_one'|'only_you'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} SharingChangeLinkExpirationPolicy
 * @property {('allowed'|'not_allowed'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {boolean} short_url - Field is deprecated. None
 ...
 * metadata if it is returned. Existing link metadata will not be returned if
 * custom settings were specified in the request that could make the existing
 * link incompatible with the requested settings.
 ...
 * @property {('path'|'email_not_verified'|'shared_link_already_exists'|'settings_error'|'access_denied'|'banned_member'|'too_many_shared_folders')} .tag - Tag identifying the union variant.
 */
 ...
 * link with an expiry will have its audience changed to members when the expiry
 * is reached.
 */
 ...
 * only if the linked file is in the authenticated user's dropbox and the user
 ...
 * @property {SharingAccessLevel} [success] - Available if .tag is success. Part
 * of the response for both add_file_member and remove_file_member_v1
 * (deprecated). For add_file_member, indicates giving access was successful and
 * at what AccessLevel. For remove_file_member_v1, indicates member was
 * successfully removed from the file. If AccessLevel is given, the member still
 ...
 * @property {string} [sckey_sha1] - The SHA-1 encrypted shared content key.
 * @property {Array.<string>} [invitation_signature] - The sharing
 * sender-recipient invitation signatures for the input member_id. A member_id
 * can be a group and thus have multiple users and multiple invitation
 * signatures.
 */
 ...
 * @property {('change_options'|'disable_viewer_info'|'edit_contents'|'enable_viewer_info'|'invite_editor'|'invite_viewer'|'invite_viewer_no_comment'|'relinquish_membership'|'unmount'|'unshare'|'leave_a_copy'|'share_link'|'create_link'|'create_view_link'|'create_edit_link'|'set_access_inheritance'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * SharedFileMetadata.permissions field describing the actions the authenticated
 ...
 * @property {('shared_link_not_found'|'shared_link_access_denied'|'unsupported_link_type'|'unsupported_parameter_field'|'other'|'shared_link_is_directory')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamCommonGroupType} group_type - Field is deprecated. The type of
 * group.
 ...
 * @property {string} [initials] - Field is deprecated. Never set.
 * @property {boolean} is_inherited - True if the member has access on a parent
 * folder.
 */
 ...
 * @property {string} [email] - Available if .tag is email. Email address of
 * invited user.
 ...
 * @typedef {Object} SharingLinkAudienceDisallowedReason
 * @property {('delete_and_recreate'|'restricted_by_shared_folder'|'restricted_by_team'|'user_not_on_team'|'user_account_type'|'permission_denied'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} SharingLinkAudienceOption
 * @property {SharingLinkAudience} audience - Specifies who can access the link.
 * @property {boolean} allowed - Whether the user calling this API can select
 * this audience option.
 * @property {SharingLinkAudienceDisallowedReason} [disallowed_reason] - If
 * allowed is false, this will provide the reason that the user is not permitted
 ...
 * link.
 * @property {Array.<SharingVisibilityPolicy>} visibility_policies - A list of
 * policies that the user might be able to set for the visibility.
 * @property {boolean} can_set_expiry - Whether the user can set the expiry
 * settings of the link. This refers to the ability to create a new expiry and
 * modify an existing expiry.
 * @property {boolean} can_remove_expiry - Whether the user can remove the
 * expiry of the link.
 * @property {boolean} allow_download - Whether the link can be downloaded or
 * not.
 * @property {boolean} can_allow_download - Whether the user can allow downloads
 * via the link. This refers to the ability to remove a no-download restriction
 * on the link.
 * @property {boolean} can_disallow_download - Whether the user can disallow
 * downloads via the link. This refers to the ability to impose a no-download
 * restriction on the link.
 * @property {boolean} allow_comments - Field is deprecated. Whether comments
 * are enabled for the linked file. This takes the team commenting policy into
 * account.
 * @property {boolean} team_restricts_comments - Field is deprecated. Whether
 * the team has disabled commenting globally.
 ...
 * @property {Array.<SharingLinkAudienceOption>} [audience_options] - A list of
 * link audience options the user might be able to set as the new audience.
 * @property {boolean} [can_set_password] - Whether the user can set a password
 * for the link.
 * @property {boolean} [can_remove_password] - Whether the user can remove the
 * password of the link.
 * @property {boolean} [require_password] - Whether the user is required to
 * provide a password to view the link.
 * @property {boolean} [can_use_extended_sharing_controls] - Whether the user
 * can use extended sharing controls, based on their account type.
 * @property {boolean} [can_sync] - Whether a user can save the content to their
 * Dropbox account.
 * @property {boolean} [can_request_access] - Whether the user can request
 * access to the content.
 * @property {TeamPoliciesEnforceLinkPasswordPolicy}
 * [enforce_shared_link_password_policy] - Whether the updated externally
 * available shared link must have password set. Not provided if the link is not
 * team owned.
 * @property {TeamPoliciesDefaultLinkExpirationDaysPolicy}
 * [days_to_expire_policy] - Existing owning team's policy for default number of
 * days from today to link's expiration. Not provided if the link is not team
 * owned.
 * @property {SharingChangeLinkExpirationPolicy}
 * [change_shared_link_expiration_policy] - When owning team's policy
 * change_shared_link_expiration_policy is
 * ChangeLinkExpirationPolicy.not_allowed, the updated externally available
 * shared link expiration value cannot be less strict than
 * days_to_expire_policy. In this case days_to_expire_policy is expected to be
 * different from `none`. Not provided if the link is not team owned.
 */
 ...
 * @property {string} shared_folder_id - The ID for the shared folder. When path
 * is provided, the folder ID will be extracted from the path instead.
 ...
 * @property {string} [path] - Optional path to get inherited members. When
 * omitted, uses shared_folder_id to return direct members. When provided,
 * extracts folder ID from this path and returns users who have access through
 ...
 * @property {('team'|'anyone'|'team_and_approved'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {SharingSharedLinkSettingsError} [settings_error] - Available if
 * .tag is settings_error. There is an error with the given settings.
 * @property {('shared_link_not_found'|'shared_link_access_denied'|'unsupported_link_type'|'unsupported_parameter_field'|'other'|'settings_error'|'email_not_verified')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('access_error'|'inside_shared_folder'|'insufficient_quota'|'already_mounted'|'no_permission'|'not_mountable'|'must_automount'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} SharingRelinquishAccessArg
 * @property {string} file_id - The id for the file or folder.
 */

/**
 * Error result for the relinquish_access endpoint.
 * @typedef {Object} SharingRelinquishAccessError
 * @property {('invalid_file_id'|'email_unverified'|'owner'|'no_explicit_access'|'team_folder'|'no_permission'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Returns an empty response for the relinquish_access endpoint.
 * @typedef {Object} SharingRelinquishAccessResult
 */
 ...
 * relinquishing membership. This must be set to false when the folder is within
 * a team folder or another shared folder.
 */
 ...
 * it will be removed from their Dropbox. This must be set to false when
 * removing a group, or when the folder is within a team folder or another
 * shared folder.
 */
 ...
 * @property {('viewer'|'editor'|'max'|'default'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('shared_link_not_found'|'shared_link_access_denied'|'unsupported_link_type'|'unsupported_parameter_field'|'other'|'shared_link_malformed')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} path - The path or the file id to the folder to share. If
...
/**
 * @typedef {Object} SharingShareFolderErrorBaseV2
 * @property {('email_unverified'|'team_policy_disallows_member_policy'|'disallowed_shared_link_policy'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} SharingShareFolderErrorV2
 * @property {('email_unverified'|'team_policy_disallows_member_policy'|'disallowed_shared_link_policy'|'other'|'no_permission')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('is_file'|'inside_shared_folder'|'contains_shared_folder'|'contains_app_folder'|'contains_team_folder'|'is_app_folder'|'inside_app_folder'|'is_public_folder'|'inside_public_folder'|'already_shared'|'invalid_path'|'is_osx_package'|'inside_osx_package'|'is_vault'|'is_vault_locked'|'is_family'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} SharingSharePathErrorBaseV2
 * @property {SharingSharedFolderMetadata} [already_shared] - Available if .tag
 * is already_shared. Folder is already shared. Contains metadata about the
 * existing shared folder.
 * @property {('is_file'|'inside_shared_folder'|'contains_shared_folder'|'contains_team_folder'|'is_app_folder'|'inside_app_folder'|'is_public_folder'|'inside_public_folder'|'already_shared'|'invalid_path'|'is_osx_package'|'inside_osx_package'|'is_vault'|'is_vault_locked'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} SharingSharePathErrorV2
 * @property {SharingSharedFolderMetadata} [already_shared] - Available if .tag
 * is already_shared. Folder is already shared. Contains metadata about the
 * existing shared folder.
 * @property {('is_file'|'inside_shared_folder'|'contains_shared_folder'|'contains_team_folder'|'is_app_folder'|'inside_app_folder'|'is_public_folder'|'inside_public_folder'|'already_shared'|'invalid_path'|'is_osx_package'|'inside_osx_package'|'is_vault'|'is_vault_locked'|'other'|'is_family'|'contains_app_folder')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('invalid_id'|'not_a_member'|'invalid_member'|'email_unverified'|'unmounted'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * shared folder.
 * @property {string} [path_display] - The full path of this shared folder.
 ...
 * @property {string} [folder_id] - The ID of the content.
 */
 ...
 * @property {('shared_link_not_found'|'shared_link_access_denied'|'unsupported_link_type'|'unsupported_parameter_field'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} SharingSharedLinkMetadataError
 * @property {('shared_link_not_found'|'shared_link_access_denied'|'unsupported_link_type'|'unsupported_parameter_field'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {boolean} [require_password] - Boolean flag to enable or disable
 * password protection.
 * @property {string} [link_password] - If require_password is true, this is
 ...
 * @property {SharingRequestedVisibility} [requested_visibility] - Field is
 * deprecated. Use audience instead.  The requested access for this shared link.
 * @property {boolean} [allow_download] - Boolean flag to allow or not download
...
/**
 * Arguments for update_file_policy.
 * @typedef {Object} SharingUpdateFilePolicyArg
 * @property {string} file - File that we are changing the policy for.
 * @property {Array.<SharingFileAction>} [actions] - A list of `FileAction`s
 * corresponding to `FilePermission`s that should appear in the response's
 * SharedFileMetadata.permissions field describing the actions the authenticated
 * user can perform on the file.
 * @property {SharingLinkSettings} [link_settings] - Field is deprecated.
 * Settings on the link for the file.
 * @property {SharingViewerInfoPolicy} [viewer_info_policy] - The presence and
 * seen state policy on the file.
 */

/**
 * Error result for update_file_policy.
 * @typedef {Object} SharingUpdateFilePolicyError
 * @property {SharingSharingFileAccessError} [access_error] - Available if .tag
 * is access_error.
 * @property {('access_error'|'invalid_file_settings'|'no_permission'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * has last seen the content. Only populated if the user has seen the content
 * and the caller has a plan that includes viewer history.
...
/**
 * @typedef {Object} SharingVisibilityPolicy
 * @property {SharingRequestedVisibility} policy - This is the value to submit
 * when saving the visibility setting.
 * @property {SharingAlphaResolvedVisibility} resolved_policy - This is what the
 * effective policy would be, if you selected this option. The resolved policy
 * is obtained after considering external effects such as shared folder settings
 * and team policy. This value is guaranteed to be provided.
 * @property {boolean} allowed - Whether the user is permitted to set the
 * visibility to this policy.
 * @property {SharingVisibilityPolicyDisallowedReason} [disallowed_reason] - If
 * allowed is false, this will provide the reason that the user is not permitted
 * to set the visibility to this policy.
 */

/**
 * @typedef {Object} SharingVisibilityPolicyDisallowedReason
 * @property {('delete_and_recreate'|'restricted_by_shared_folder'|'restricted_by_team'|'user_not_on_team'|'user_account_type'|'permission_denied'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('upload_api_rate_limit'|'has_team_shared_dropbox'|'has_team_file_events'|'has_team_selective_sync'|'has_distinct_member_homes'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamHasDistinctMemberHomesValue} [has_distinct_member_homes] -
 * Available if .tag is has_distinct_member_homes.
 * @property {('upload_api_rate_limit'|'has_team_shared_dropbox'|'has_team_file_events'|'has_team_selective_sync'|'has_distinct_member_homes'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * the group. Note that the default value will cause all the group members to be
 ...
 * @property {string} async_job_id - Field is deprecated. For legacy purposes
 * async_job_id will always return one space ' '. Formerly, it was an ID that
 * was used to obtain the status of granting/revoking group-owned resources.
 ...
 * @typedef {Object} TeamHasDistinctMemberHomesValue
 * @property {boolean} [has_distinct_member_homes] - Available if .tag is
 * has_distinct_member_homes. Does this team have distinct team member homes.
 * @property {('has_distinct_member_homes'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamMembersInfo} members - Team members IDs and number of
 * permanently deleted members under hold.
 * @property {TeamLegalHoldStatus} status - The current state of the hold.
 ...
 * @property {Array.<TeamLegalHoldHeldRevisionMetadata>} entries - List of file
 * entries that under the hold.
 * @property {boolean} has_more - True if there are more file entries that
 * haven't been returned. You can retrieve them with a call to
 * /legal_holds/list_held_revisions_continue.
 * @property {string} [cursor] - The cursor idicates where to continue reading
 * file metadata entries for the next API call. When there are no more entries,
 * the cursor will return none. Pass the cursor into
 ...
 * @property {string} name - Policy name.
 * @property {Array.<Object>} members - List of team member IDs added to the
 * hold.
 * @property {string} [description] - A description of the legal hold policy.
 * @property {Timestamp} [start_date] - start date of the legal hold policy.
 * @property {Timestamp} [end_date] - end date of the legal hold policy.
 ...
 * @property {Array.<Object>} [members] - List of team member IDs to apply the
 * policy on.
 */

/**
 * @typedef {Object} TeamLegalHoldsPolicyUpdateError
 * @property {('unknown_legal_hold_error'|'insufficient_permissions'|'other'|'transient_error'|'inactive_legal_hold'|'legal_hold_performing_another_operation'|'invalid_members'|'number_of_users_on_hold_is_greater_than_hold_limitation'|'empty_members_list'|'name_must_be_unique'|'legal_hold_policy_not_found')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamMemberAddArgBase
 * @property {string} member_email
 * @property {string} [member_given_name] - Member's first name.
 * @property {string} [member_surname] - Member's last name.
 * @property {string} [member_external_id] - External ID for member.
 ...
 * @property {('team_license_limit'|'free_team_member_limit_reached'|'user_already_on_team'|'user_on_another_team'|'user_already_paired'|'user_migration_failed'|'duplicate_external_member_id'|'duplicate_member_persistent_id'|'persistent_id_disabled'|'user_creation_failed'|'success')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamMemberAddResultBase
 * @property {string} [team_license_limit] - Available if .tag is
 * team_license_limit. Team is already full. The organization has no available
 * licenses.
 * @property {string} [free_team_member_limit_reached] - Available if .tag is
 ...
 * @property {string} [user_creation_failed] - Available if .tag is
 * user_creation_failed. User creation has failed.
 * @property {('team_license_limit'|'free_team_member_limit_reached'|'user_already_on_team'|'user_on_another_team'|'user_already_paired'|'user_migration_failed'|'duplicate_external_member_id'|'duplicate_member_persistent_id'|'persistent_id_disabled'|'user_creation_failed')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamMemberAddV2Arg
 * @property {string} member_email
 * @property {string} [member_given_name] - Member's first name.
 * @property {string} [member_surname] - Member's last name.
 * @property {string} [member_external_id] - External ID for member.
 ...
 * @property {boolean} [is_directory_restricted] - Whether a user is directory
 * restricted.
 * @property {Array.<Object>} [role_ids]
 */
 ...
 * team - the other values explain the type of failure that occurred, and
 * include the email of the user for which the operation has failed.
 * @typedef {Object} TeamMemberAddV2Result
 * @property {string} [team_license_limit] - Available if .tag is
 * team_license_limit. Team is already full. The organization has no available
 * licenses.
 * @property {string} [free_team_member_limit_reached] - Available if .tag is
 ...
 * @property {string} [user_creation_failed] - Available if .tag is
 * user_creation_failed. User creation has failed.
 * @property {TeamTeamMemberInfoV2} [success] - Available if .tag is success.
 * Describes a user that was successfully added to the team.
 * @property {('team_license_limit'|'free_team_member_limit_reached'|'user_already_on_team'|'user_on_another_team'|'user_already_paired'|'user_migration_failed'|'duplicate_external_member_id'|'duplicate_member_persistent_id'|'persistent_id_disabled'|'user_creation_failed'|'success'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamMembersAddArgBase
 * @property {boolean} force_async - Whether to force the add to happen
 * asynchronously.
 */
...
/**
 * @typedef {Object} TeamMembersAddJobStatusV2Result
 * @property {Array.<TeamMemberAddV2Result>} [complete] - Available if .tag is
 * complete. The asynchronous job has finished. For each member that was
 * specified in the parameter :type:`MembersAddArg` that was provided to
...
/**
 * @typedef {Object} TeamMembersAddLaunchV2Result
 * @property {string} [async_job_id] - Available if .tag is async_job_id. This
 * response indicates that the processing is asynchronous. The string is an id
 * that can be used to obtain the status of the asynchronous job.
 * @property {Array.<TeamMemberAddV2Result>} [complete] - Available if .tag is
...
/**
 * @typedef {Object} TeamMembersAddV2Arg
 * @property {Array.<TeamMemberAddV2Arg>} new_members - Details of new members
...
/**
 * @typedef {Object} TeamMembersDeleteFormerMemberFilesError
 * @property {('user_not_found'|'user_not_in_team'|'other'|'transfer_in_progress'|'already_transferred'|'already_transferred_or_deleted'|'user_not_removed')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamMembersFormerMemberArg
 * @property {TeamUserSelectorArg} user - Identity of user whose files will be
 * permanently deleted.
 */

/**
 * Available TeamMemberRole for the connected team. To be used with
 * members/set_admin_permissions:2.
 * @typedef {Object} TeamMembersGetAvailableTeamMemberRolesResult
 * @property {Array.<TeamTeamMemberRole>} roles - Available roles.
 */
 ...
 * @property {string} [id_not_found] - Available if .tag is id_not_found. An ID
 * that was provided as a parameter to :route:`members/get_info` or
 * :route:`members/get_info:2`, and did not match a corresponding user. This
...
/**
 * @typedef {Object} TeamMembersGetInfoItemBase
 * @property {string} [id_not_found] - Available if .tag is id_not_found. An ID
 * that was provided as a parameter to :route:`members/get_info` or
 * :route:`members/get_info:2`, and did not match a corresponding user. This
 * might be a team_member_id, an email, or an external ID, depending on how the
 * method was called.
 * @property {'id_not_found'} .tag - Tag identifying the union variant.
 */

/**
 * Describes a result obtained for a single user whose id was specified in the
 * parameter of members/get_info:2.
 * @typedef {Object} TeamMembersGetInfoItemV2
 * @property {string} [id_not_found] - Available if .tag is id_not_found. An ID
 * that was provided as a parameter to :route:`members/get_info` or
 * :route:`members/get_info:2`, and did not match a corresponding user. This
 * might be a team_member_id, an email, or an external ID, depending on how the
 * method was called.
 * @property {TeamTeamMemberInfoV2} [member_info] - Available if .tag is
 * member_info. Info about a team member.
 * @property {('id_not_found'|'member_info'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamMembersGetInfoV2Arg
 * @property {Array.<TeamUserSelectorArg>} members - List of team members.
 */

/**
 * @typedef {Object} TeamMembersGetInfoV2Result
 * @property {Array.<TeamMembersGetInfoItemV2>} members_info - List of team
 * members info.
 */
...
/**
 * @typedef {Object} TeamMembersListV2Result
 * @property {Array.<TeamTeamMemberInfoV2>} members - List of team members.
 * @property {string} cursor - Pass the cursor into members/list/continue:2 to
 * obtain the additional members.
 * @property {boolean} has_more - Is true if there are additional team members
 * that have not been returned yet. An additional call to
 * members/list/continue:2 can retrieve them.
 */

/**
 * @typedef {Object} TeamMembersPermanentlyDeleteFilesError
 * @property {('user_not_found'|'user_not_in_team'|'other'|'transfer_in_progress'|'already_transferred'|'already_transferred_or_deleted')} .tag - Tag identifying the union variant.
 */
 ...
 * keep access to Dropbox folders (not Dropbox Paper folders) already explicitly
 * shared with them (not via a group) when they are downgraded to a Basic
 * account. Users will not retain access to folders that do not allow external
 * sharing. In order to keep the sharing relationships, the arguments wipe_data
 * should be set to false and keep_account should be set to true.
 * @property {boolean} permanently_delete_files - Permanently delete the data in
 * the deleted member's account. After permanent deletion, the data is no longer
 * available to be transferred to a different user.
 */

/**
 * @typedef {Object} TeamMembersRemoveError
 * @property {('user_not_found'|'user_not_in_team'|'other'|'transfer_in_progress'|'already_transferred'|'already_transferred_or_deleted'|'removed_and_transfer_dest_should_differ'|'removed_and_transfer_admin_should_differ'|'transfer_dest_user_not_found'|'transfer_dest_user_not_in_team'|'transfer_admin_user_not_in_team'|'transfer_admin_user_not_found'|'unspecified_transfer_admin_id'|'transfer_admin_is_not_admin'|'recipient_not_verified'|'remove_last_admin'|'cannot_keep_account_and_transfer'|'cannot_keep_account_and_delete_data'|'cannot_keep_account_and_permanently_delete'|'email_address_too_long_to_be_disabled'|'cannot_keep_invited_user_account'|'cannot_retain_shares_when_data_wiped'|'cannot_retain_shares_when_no_account_kept'|'cannot_retain_shares_when_team_external_sharing_off'|'cannot_keep_account'|'cannot_keep_account_under_legal_hold'|'cannot_keep_account_required_to_sign_tos'|'cannot_permanently_delete_and_transfer'|'member_is_transfer_destination')} .tag - Tag identifying the union variant.
 */
 ...
 * Exactly one of team_member_id, email, or external_id must be provided to
 * identify the user account.
 * @typedef {Object} TeamMembersSetPermissions2Arg
 * @property {TeamUserSelectorArg} user - Identity of user whose role will be
 * set.
 * @property {Array.<Object>} [new_roles] - The new roles for the member. Send
 * empty list to make user member only. For now, only up to one role is allowed.
 */

/**
 * @typedef {Object} TeamMembersSetPermissions2Error
 * @property {('user_not_found'|'last_admin'|'user_not_in_team'|'cannot_set_permissions'|'role_not_found'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamMembersSetPermissions2Result
 * @property {string} team_member_id - The member ID of the user to which the
 * change was applied.
 * @property {Array.<TeamTeamMemberRole>} [roles] - The roles after the change.
 ...
 * @property {number} quota_limit - The quota limit in bytes for this namespace
 * tree. Only applicable to team folders.
 */

/**
 * @typedef {Object} TeamNamespaceType
 * @property {('app_folder'|'shared_folder'|'team_folder'|'team_member_folder'|'team_member_root'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} team_member_id - The unique id of the member owning the
 * device.
 * @property {boolean} keep_app_folder - Field is deprecated. This flag is not
 * longer supported, the application dedicated folder (in case the application
 ...
 * @property {('app_not_found'|'member_not_found'|'app_folder_removal_not_supported'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamSharingAllowlistAddArgs
 * @property {Array.<string>} [domains] - List of domains represented by valid
 * string representation (RFC-1034/5).
 * @property {Array.<string>} [emails] - List of emails represented by valid
 * string representation (RFC-5322/822).
 */

/**
 * @typedef {Object} TeamSharingAllowlistAddError
 * @property {string} [malformed_entry] - Available if .tag is malformed_entry.
 * One of provided values is not valid.
 * @property {string} [entries_already_exist] - Available if .tag is
 * entries_already_exist. Entries already exists.
 * @property {('malformed_entry'|'no_entries_provided'|'too_many_entries_provided'|'team_limit_reached'|'unknown_error'|'entries_already_exist'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * This struct is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} TeamSharingAllowlistAddResponse
 */

/**
 * @typedef {Object} TeamSharingAllowlistListArg
 * @property {number} limit - The number of entries to fetch at one time.
 */

/**
 * @typedef {Object} TeamSharingAllowlistListContinueArg
 * @property {string} cursor - The cursor returned from a previous call to
 * sharing_allowlist/list or sharing_allowlist/list/continue.
 */

/**
 * @typedef {Object} TeamSharingAllowlistListContinueError
 * @property {('invalid_cursor'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * This struct is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} TeamSharingAllowlistListError
 */

/**
 * @typedef {Object} TeamSharingAllowlistListResponse
 * @property {Array.<string>} domains - List of domains represented by valid
 * string representation (RFC-1034/5).
 * @property {Array.<string>} emails - List of emails represented by valid
 * string representation (RFC-5322/822).
 * @property {string} cursor - If this is nonempty, there are more entries that
 * can be fetched with sharing_allowlist/list/continue.
 * @property {boolean} has_more - if true indicates that more entries can be
 * fetched with sharing_allowlist/list/continue.
 */

/**
 * @typedef {Object} TeamSharingAllowlistRemoveArgs
 * @property {Array.<string>} [domains] - List of domains represented by valid
 * string representation (RFC-1034/5).
 * @property {Array.<string>} [emails] - List of emails represented by valid
 * string representation (RFC-5322/822).
...
/**
 * @typedef {Object} TeamSharingAllowlistRemoveError
 * @property {string} [malformed_entry] - Available if .tag is malformed_entry.
 * One of provided values is not valid.
 * @property {string} [entries_do_not_exist] - Available if .tag is
 * entries_do_not_exist. One or more provided values do not exist.
 * @property {('malformed_entry'|'entries_do_not_exist'|'no_entries_provided'|'too_many_entries_provided'|'unknown_error'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * This struct is empty. The comment here is intentionally emitted to avoid
 * indentation issues with Stone.
 * @typedef {Object} TeamSharingAllowlistRemoveResponse
 */
 ...
 * @property {('invalid_folder_name'|'folder_name_already_used'|'folder_name_reserved'|'sync_settings_error'|'folder_count_limit_exceeded'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {number} quota_limit - The quota limit in bytes for this team
 * folder namespace tree.
 */
...
/**
 * @typedef {Object} TeamTeamFolderRestoreError
 * @property {TeamTeamFolderAccessError} [access_error] - Available if .tag is
 * access_error.
 * @property {TeamTeamFolderInvalidStatusError} [status_error] - Available if
 * .tag is status_error.
 ...
 * @property {('active'|'archived'|'archive_in_progress'|'inactive'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {number} num_used_licenses - The number of licenses used on the
 * team.
 */
...
/**
 * Information about a team member.
 * @typedef {Object} TeamTeamMemberInfoV2
 * @property {TeamTeamMemberProfile} profile - Profile of a user as a member of
 * a team.
 * @property {Array.<TeamTeamMemberRole>} [roles] - The user's roles in the
 * team.
 */

/**
 * Information about a team member, after the change, like at
 * members/set_profile:2.
 * @typedef {Object} TeamTeamMemberInfoV2Result
 * @property {TeamTeamMemberInfoV2} member_info - Member info, after the change.
 */
 ...
 * belongs to.
 * @property {string} member_folder_id - The namespace id of the user's member
 * folder.
 * @property {string} root_folder_id - The namespace id of the user's root
 * folder.
 * @property {string} [external_id] - External ID that a team can attach to the
 * user. An application using the API may find it easier to use their own IDs
 * instead of Dropbox IDs like account_id or team_member_id.
 ...
 * @typedef {Object} TeamTeamMemberRole
 * @property {string} role_id - A string containing encoded role ID. For roles
 * defined by Dropbox, this is the same across all teams.
 * @property {string} name - The role display name.
 * @property {string} description - Role description. Describes which
 ...
 * @property {number} limit - Field is deprecated. Specifying a value here has
 * no effect.
 */
 ...
 * @property
 * {(TeamLogDesktopSessionLogInfo|TeamLogMobileSessionLogInfo|TeamLogWebSessionLogInfo|TeamLogSessionLogInfo)}
 ...
 * @property {('admin_console'|'api'|'content_manager'|'end_user'|'enterprise_console'|'sign_in_as'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogAccountCaptureAvailability
 * @property {('available'|'unavailable'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('actionable_notification'|'proactive_warning_notification'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogAccountCapturePolicy
 * @property {('all_users'|'disabled'|'invited_users'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * the team.
 * @property {('remove_action'|'team_invite_details'|'team_join_details'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property
 * {(TeamLogNonTeamMemberLogInfo|TeamLogTeamMemberLogInfo|TeamLogTrustedNonTeamMemberLogInfo|TeamLogUserLogInfo)}
 * [admin] - Available if .tag is admin. The admin who did the action.
 * @property
 * {(TeamLogTeamLinkedAppLogInfo|TeamLogUserLinkedAppLogInfo|TeamLogUserOrTeamLinkedAppLogInfo|TeamLogAppLogInfo)}
 ...
 * @property {('admin'|'anonymous'|'app'|'dropbox'|'reseller'|'user'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Add-on Assigned.
 * @typedef {Object} TeamLogAddonAssignedDetails
 * @property {TeamLogUserNameLogInfo} user_name - User's name.
 * @property {TeamLogAddonLogInfo} addon_name - Add-on name.
 */

/**
 * @typedef {Object} TeamLogAddonAssignedType
 * @property {string} description
 */

/**
 * Add-on logged information
 * @typedef {Object} TeamLogAddonLogInfo
 * @property {string} addon_name - Add-on name.
 */

/**
 * Add-on Removed.
 * @typedef {Object} TeamLogAddonRemovedDetails
 * @property {TeamLogUserNameLogInfo} user_name - User's name.
 * @property {TeamLogAddonLogInfo} addon_name - Add-on name.
 */

/**
 * @typedef {Object} TeamLogAddonRemovedType
 * @property {string} description
 */

/**
 * Alert category
 * @typedef {Object} TeamLogAdminAlertCategoryEnum
 * @property {('account_takeover'|'data_loss_protection'|'information_governance'|'malware_sharing'|'massive_file_operation'|'na'|'threat_management'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Alert state
 * @typedef {Object} TeamLogAdminAlertGeneralStateEnum
 * @property {('active'|'dismissed'|'in_progress'|'na'|'resolved'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Alert severity
 * @typedef {Object} TeamLogAdminAlertSeverityEnum
 * @property {('high'|'info'|'low'|'medium'|'na'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Alert configurations
 * @typedef {Object} TeamLogAdminAlertingAlertConfiguration
 * @property {TeamLogAdminAlertingAlertStatePolicy} [alert_state] - Alert state.
 * @property {TeamLogAdminAlertingAlertSensitivity} [sensitivity_level] -
 * Sensitivity level.
 ...
 * @property {TeamLogMalwareExclusionState} [malware_exclusion_state] - Malware
 * exclusion list state.
 */

/**
 * Alert sensitivity
 * @typedef {Object} TeamLogAdminAlertingAlertSensitivity
 * @property {('high'|'highest'|'invalid'|'low'|'lowest'|'medium'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed an alert state.
 * @typedef {Object} TeamLogAdminAlertingAlertStateChangedDetails
 * @property {string} alert_name - Alert name.
 * @property {TeamLogAdminAlertSeverityEnum} alert_severity - Alert severity.
 * @property {TeamLogAdminAlertCategoryEnum} alert_category - Alert category.
 * @property {string} alert_instance_id - Alert ID.
 * @property {TeamLogAdminAlertGeneralStateEnum} previous_value - Alert state
 * before the change.
 * @property {TeamLogAdminAlertGeneralStateEnum} new_value - Alert state after
 * the change.
 */

/**
 * @typedef {Object} TeamLogAdminAlertingAlertStateChangedType
 * @property {string} description
 */

/**
 * Policy for controlling whether an alert can be triggered or not
 * @typedef {Object} TeamLogAdminAlertingAlertStatePolicy
 * @property {('off'|'on'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed an alert setting.
 * @typedef {Object} TeamLogAdminAlertingChangedAlertConfigDetails
 * @property {string} alert_name - Alert Name.
 * @property {TeamLogAdminAlertingAlertConfiguration} previous_alert_config -
 * Previous alert configuration.
 * @property {TeamLogAdminAlertingAlertConfiguration} new_alert_config - New
 * alert configuration.
 */

/**
 * @typedef {Object} TeamLogAdminAlertingChangedAlertConfigType
 * @property {string} description
 */

/**
 * Triggered security alert.
 * @typedef {Object} TeamLogAdminAlertingTriggeredAlertDetails
 * @property {string} alert_name - Alert name.
 * @property {TeamLogAdminAlertSeverityEnum} alert_severity - Alert severity.
 * @property {TeamLogAdminAlertCategoryEnum} alert_category - Alert category.
 * @property {string} alert_instance_id - Alert ID.
...
/**
 * @typedef {Object} TeamLogAdminAlertingTriggeredAlertType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogAdminConsoleAppPermission
 * @property {('default_for_listed_apps'|'default_for_unlisted_apps'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogAdminConsoleAppPolicy
 * @property {('allow'|'block'|'default'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed admin reminder settings for requests to join the team.
 * @typedef {Object} TeamLogAdminEmailRemindersChangedDetails
 * @property {TeamLogAdminEmailRemindersPolicy} new_value - To.
 * @property {TeamLogAdminEmailRemindersPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogAdminEmailRemindersChangedType
 * @property {string} description
 */
 ...
 * to join the team
 * @typedef {Object} TeamLogAdminEmailRemindersPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogAdminRole
 * @property {('billing_admin'|'compliance_admin'|'content_admin'|'deprecated_freemium_team_member'|'freemium_team_creator'|'limited_admin'|'member_only'|'reporting_admin'|'security_admin'|'support_admin'|'team_admin'|'user_management_admin'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Policy for deciding whether team users can use third party AI services
 * @typedef {Object} TeamLogAiThirdPartySharingDropboxBasePolicy
 * @property {('admins_only'|'default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed AI third party sharing policy for team.
 * @typedef {Object} TeamLogAiThirdPartySharingDropboxBasePolicyChangedDetails
 * @property {TeamLogAiThirdPartySharingDropboxBasePolicy} new_value - To.
 * @property {TeamLogAiThirdPartySharingDropboxBasePolicy} previous_value -
 * From.
 */

/**
 * @typedef {Object} TeamLogAiThirdPartySharingDropboxBasePolicyChangedType
 * @property {string} description
 */

/**
 * Alert recipients setting type
 * @typedef {Object} TeamLogAlertRecipientsSettingType
 * @property {('custom_list'|'invalid'|'none'|'team_admins'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogAppBlockedByPermissionsDetails
 * @property
 * {(TeamLogTeamLinkedAppLogInfo|TeamLogUserLinkedAppLogInfo|TeamLogUserOrTeamLinkedAppLogInfo|TeamLogAppLogInfo)}
...
/**
 * @typedef {Object} TeamLogAppBlockedByPermissionsType
 * @property {string} description
 */
...
@property {("team_linked_app"|"user_linked_app"|"user_or_team_linked_app")} .tag
- Tag identifying the subtype variant.
 * @property {string} [app_id] - App unique ID.
 * @property {string} [display_name] - App display name.
 */

/**
 * Changed app permissions.
 * @typedef {Object} TeamLogAppPermissionsChangedDetails
 * @property {TeamLogAdminConsoleAppPolicy} previous_value - Previous policy.
 * @property {TeamLogAdminConsoleAppPolicy} new_value - New policy.
 * @property {string} [app_name] - Name of the app.
 * @property {TeamLogAdminConsoleAppPermission} [permission] - Permission that
 * was changed.
 */

/**
 * @typedef {Object} TeamLogAppPermissionsChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogAppleLoginChangePolicyDetails
 * @property {TeamLogAppleLoginPolicy} new_value - New Apple login policy.
 * @property {TeamLogAppleLoginPolicy} [previous_value] - Previous Apple login
 * policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogAppleLoginChangePolicyType
 * @property {string} description
 */

/**
 * Apple login policy
 * @typedef {Object} TeamLogAppleLoginPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Applied naming convention.
 * @typedef {Object} TeamLogApplyNamingConventionDetails
 */

/**
 * @typedef {Object} TeamLogApplyNamingConventionType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogBackupAdminInvitationSentDetails
 */

/**
 * @typedef {Object} TeamLogBackupAdminInvitationSentType
 * @property {string} description
 */

/**
 * Opened Backup invite.
 * @typedef {Object} TeamLogBackupInvitationOpenedDetails
 */

/**
 * @typedef {Object} TeamLogBackupInvitationOpenedType
 * @property {string} description
 */

/**
 * Backup status
 * @typedef {Object} TeamLogBackupStatus
 ...
 * @typedef {Object} TeamLogCaptureTeamSpacePolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Capture team space policy for team.
 * @typedef {Object} TeamLogCaptureTeamSpacePolicyChangedDetails
 * @property {TeamLogCaptureTeamSpacePolicy} new_value - To.
 * @property {TeamLogCaptureTeamSpacePolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogCaptureTeamSpacePolicyChangedType
 * @property {string} description
 */

/**
 * Policy for deciding whether team users can transcription in Capture
 * @typedef {Object} TeamLogCaptureTranscriptPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Capture transcription policy for team.
 * @typedef {Object} TeamLogCaptureTranscriptPolicyChangedDetails
 * @property {TeamLogCaptureTranscriptPolicy} new_value - To.
 * @property {TeamLogCaptureTranscriptPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogCaptureTranscriptPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogChangeLinkExpirationPolicy
 * @property {('allowed'|'not_allowed'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogClassificationChangePolicyDetails
 * @property {TeamLogClassificationPolicyEnumWrapper} previous_value - Previous
 * classification policy.
 * @property {TeamLogClassificationPolicyEnumWrapper} new_value - New
 * classification policy.
 * @property {TeamLogClassificationType} classification_type - Policy type.
 */

/**
 * @typedef {Object} TeamLogClassificationChangePolicyType
 * @property {string} description
 */

/**
 * Created Classification report.
 * @typedef {Object} TeamLogClassificationCreateReportDetails
 */

/**
 * Couldn't create Classification report.
 * @typedef {Object} TeamLogClassificationCreateReportFailDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogClassificationCreateReportFailType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogClassificationCreateReportType
 * @property {string} description
 */

/**
 * Policy for controlling team access to the classification feature
 * @typedef {Object} TeamLogClassificationPolicyEnumWrapper
 * @property {('disabled'|'enabled'|'member_and_team_folders'|'team_folders'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * The type of classification (currently only personal information)
 * @typedef {Object} TeamLogClassificationType
 * @property {('personal_information'|'pii'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogComputerBackupPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed computer backup policy for team.
 * @typedef {Object} TeamLogComputerBackupPolicyChangedDetails
 * @property {TeamLogComputerBackupPolicy} new_value - New computer backup
 * policy.
 * @property {TeamLogComputerBackupPolicy} previous_value - Previous computer
 * backup policy.
 */

/**
 * @typedef {Object} TeamLogComputerBackupPolicyChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogContentAdministrationPolicyChangedType
 * @property {string} description
 */

/**
 * Changed content deletion protection policy for team.
 * @typedef {Object} TeamLogContentDeletionProtectionChangePolicyDetails
 * @property {TeamLogContentDeletionProtectionPolicy} new_value - New content
 * deletion protection policy.
 * @property {number} [new_threshold_bytes] - New threshold value in bytes (only
 * present when new policy is on_above_threshold).
 * @property {TeamLogContentDeletionProtectionPolicy} [previous_value] -
 * Previous content deletion protection policy. Might be missing due to
 * historical data gap.
 * @property {number} [previous_threshold_bytes] - Previous threshold value in
 * bytes (only present when previous policy was on_above_threshold).
 */

/**
 * @typedef {Object} TeamLogContentDeletionProtectionChangePolicyType
 * @property {string} description
 */

/**
 * Content deletion protection policy
 * @typedef {Object} TeamLogContentDeletionProtectionPolicy
 * @property {('off'|'on_above_threshold'|'on_all_files'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('anonymous'|'non_team_member'|'organization_team'|'team'|'team_member'|'trusted_non_team_member'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogDashAddedCommentToStackDetails
 * @property {string} stack_name - The name of the stack where the comment
 * exists.
 * @property {string} stack_item_name - The name of the stack item that the
 * comment is tied to.
 * @property {string} comment_text - The text of the comment.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashAddedCommentToStackType
 * @property {string} description
 */

/**
 * Connected to a user connector.
 * @typedef {Object} TeamLogDashAddedConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} connector_status - The status of the
 * Connector.
 */

/**
 * @typedef {Object} TeamLogDashAddedConnectorType
 * @property {string} description
 */

/**
 * Added a link to a stack.
 * @typedef {Object} TeamLogDashAddedLinkToStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {string} stack_item_link - The link to the item in the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashAddedLinkToStackType
 * @property {string} description
 */

/**
 * Admin added an email domain to the team allowlist.
 * @typedef {Object} TeamLogDashAddedTeamEmailDomainAllowlistDetails
 * @property {string} email_domain - The email domain that gets added/removed
 * from the team allowlist.
 */

/**
 * @typedef {Object} TeamLogDashAddedTeamEmailDomainAllowlistType
 * @property {string} description
 */

/**
 * Admin added an admin connector.
 * @typedef {Object} TeamLogDashAdminAddedOrgWideConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} connector_status - The status of the
 * Connector.
 */
...
/**
 * @typedef {Object} TeamLogDashAdminAddedOrgWideConnectorType
 * @property {string} description
 */

/**
 * Admin disabled a user connector.
 * @typedef {Object} TeamLogDashAdminDisabledConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} [connector_status] - The status of the
 * Connector.
 */
...
/**
 * @typedef {Object} TeamLogDashAdminDisabledConnectorType
 * @property {string} description
 */

/**
 * Admin enabled a user connector.
 * @typedef {Object} TeamLogDashAdminEnabledConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} [connector_status] - The status of the
 * Connector.
 */
...
/**
 * @typedef {Object} TeamLogDashAdminEnabledConnectorType
 * @property {string} description
 */

/**
 * Admin removed an admin connector.
 * @typedef {Object} TeamLogDashAdminRemovedOrgWideConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} connector_status - The status of the
 * Connector.
 */
...
/**
 * @typedef {Object} TeamLogDashAdminRemovedOrgWideConnectorType
 * @property {string} description
 */

/**
 * Archived a stack.
 * @typedef {Object} TeamLogDashArchivedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashArchivedStackType
 * @property {string} description
 */

/**
 * Changed the audience of a shared link to a stack.
 * @typedef {Object} TeamLogDashChangedAudienceOfSharedLinkToStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashChangedAudienceOfSharedLinkToStackType
 * @property {string} description
 */

/**
 * Cloned stack.
 * @typedef {Object} TeamLogDashClonedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {string} actor_email - Email of the actor.
 * @property {string} new_cloned_stack_name - New cloned stack name.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashClonedStackType
 * @property {string} description
 */

/**
 * The status of the Connector
 * @typedef {Object} TeamLogDashConnectorStatus
 * @property {('fail'|'success'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Called a tool on a connector.
 * @typedef {Object} TeamLogDashConnectorToolsCallDetails
 * @property {string} connector_name - The name of the connector.
 * @property {string} tool_name - The name of the tool that was called.
 * @property {string} [surface] - The surface from which the tool was called.
 */

/**
 * @typedef {Object} TeamLogDashConnectorToolsCallType
 * @property {string} description
 */

/**
 * Created a stack.
 * @typedef {Object} TeamLogDashCreatedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashCreatedStackType
 * @property {string} description
 */

/**
 * Deleted a comment from a stack.
 * @typedef {Object} TeamLogDashDeletedCommentFromStackDetails
 * @property {string} stack_name - The name of the stack where the comment
 * exists.
 * @property {string} stack_item_name - The name of the stack item that the
 * comment is tied to.
...
/**
 * @typedef {Object} TeamLogDashDeletedCommentFromStackType
 * @property {string} description
 */

/**
 * Deleted a stack.
 * @typedef {Object} TeamLogDashDeletedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashDeletedStackType
 * @property {string} description
 */

/**
 * Edited a comment in a stack.
 * @typedef {Object} TeamLogDashEditedCommentInStackDetails
 * @property {string} stack_name - The name of the stack where the comment
 * exists.
 * @property {string} stack_item_name - The name of the stack item that the
 * comment is tied to.
...
/**
 * @typedef {Object} TeamLogDashEditedCommentInStackType
 * @property {string} description
 */

/**
 * Policy for deciding whether team users can share Dash content externally
 * @typedef {Object} TeamLogDashExternalSharingPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Dash external sharing policy for team.
 * @typedef {Object} TeamLogDashExternalSharingPolicyChangedDetails
 * @property {TeamLogDashExternalSharingPolicy} new_value - To.
 * @property {TeamLogDashExternalSharingPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogDashExternalSharingPolicyChangedType
 * @property {string} description
 */

/**
 * External user opened a stack.
 * @typedef {Object} TeamLogDashExternalUserOpenedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackSharingScope} stack_sharing_scope - The sharing
 * scope of the stack.
 * @property {boolean} is_invited - Whether the user was invited to the stack.
 * @property {boolean} is_verified - Whether the user has verified their email
 * address.
 * @property {number} [stack_owner_team_id] - The team ID of the stack owner.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashExternalUserOpenedStackType
 * @property {string} description
 */

/**
 * Opened the desktop app for the first time.
 * @typedef {Object} TeamLogDashFirstLaunchedDesktopDetails
 * @property {string} os_name - The name of the operating system.
 */

/**
 * @typedef {Object} TeamLogDashFirstLaunchedDesktopType
 * @property {string} description
 */

/**
 * Opened the extension for the first time.
 * @typedef {Object} TeamLogDashFirstLaunchedExtensionDetails
 * @property {string} browser_name - The name of the web browser.
 */

/**
 * @typedef {Object} TeamLogDashFirstLaunchedExtensionType
 * @property {string} description
 */

/**
 * Opened the web Start Page for the first time.
 * @typedef {Object} TeamLogDashFirstLaunchedWebStartPageDetails
 * @property {string} browser_name - The name of the web browser.
 */

/**
 * @typedef {Object} TeamLogDashFirstLaunchedWebStartPageType
 * @property {string} description
 */

/**
 * Checked access permissions to a stack.
 * @typedef {Object} TeamLogDashOpenedSharedLinkToStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashOpenedSharedLinkToStackType
 * @property {string} description
 */

/**
 * Opened a stack.
 * @typedef {Object} TeamLogDashOpenedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashOpenedStackType
 * @property {string} description
 */

/**
 * The new preview opt-out status
 * @typedef {Object} TeamLogDashPreviewOptOutStatus
 * @property {('opted_in'|'opted_out'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed the preview opt-out status.
 * @typedef {Object} TeamLogDashPreviewOptOutStatusChangedDetails
 * @property {TeamLogDashPreviewOptOutStatus} opt_out_status - The new preview
 * opt-out status.
 */

/**
 * @typedef {Object} TeamLogDashPreviewOptOutStatusChangedType
 * @property {string} description
 */

/**
 * Disconnected a user connector.
 * @typedef {Object} TeamLogDashRemovedConnectorDetails
 * @property {string} connector_name - The name of the Connector.
 * @property {TeamLogDashConnectorStatus} connector_status - The status of the
 * Connector.
 */
...
/**
 * @typedef {Object} TeamLogDashRemovedConnectorType
 * @property {string} description
 */

/**
 * Removed a link from a stack.
 * @typedef {Object} TeamLogDashRemovedLinkFromStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {string} stack_item_link - The link to the item in the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */
...
/**
 * @typedef {Object} TeamLogDashRemovedLinkFromStackType
 * @property {string} description
 */

/**
 * Removed a shared link to a stack.
 * @typedef {Object} TeamLogDashRemovedSharedLinkToStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashRemovedSharedLinkToStackType
 * @property {string} description
 */

/**
 * Admin removed an email domain from the team allowlist.
 * @typedef {Object} TeamLogDashRemovedTeamEmailDomainAllowlistDetails
 * @property {string} email_domain - The email domain that gets added/removed
 * from the team allowlist.
 */

/**
 * @typedef {Object} TeamLogDashRemovedTeamEmailDomainAllowlistType
 * @property {string} description
 */

/**
 * Renamed a stack.
 * @typedef {Object} TeamLogDashRenamedStackDetails
 * @property {string} old_name - The old name of the stack.
 * @property {string} new_name - The new name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashRenamedStackType
 * @property {string} description
 */

/**
 * Shared a link to a stack.
 * @typedef {Object} TeamLogDashSharedLinkToStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashSharedLinkToStackType
 * @property {string} description
 */

/**
 * The stack sharing scope
 * @typedef {Object} TeamLogDashStackSharingScope
 * @property {('invited'|'public'|'team'|'unknown'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * The type of stack backend
 * @typedef {Object} TeamLogDashStackType
 * @property {('cypress'|'reference_container'|'unknown'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Unarchived a stack.
 * @typedef {Object} TeamLogDashUnarchivedStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashUnarchivedStackType
 * @property {string} description
 */

/**
 * Member viewed a company stack.
 * @typedef {Object} TeamLogDashViewedCompanyStackDetails
 * @property {string} stack_name - The name of the stack.
 * @property {TeamLogDashStackType} [stack_type] - The type of stack backend.
 */

/**
 * @typedef {Object} TeamLogDashViewedCompanyStackType
 * @property {string} description
 */

/**
 * Admin viewed the external AI activity report.
 * @typedef {Object} TeamLogDashViewedExternalAiActivityReportDetails
 */

/**
 * @typedef {Object} TeamLogDashViewedExternalAiActivityReportType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogDataResidencyMigrationRequestSuccessfulDetails
 */

/**
 * @typedef {Object} TeamLogDataResidencyMigrationRequestSuccessfulType
 * @property {string} description
 */

/**
 * Request for data residency migration for team data has failed.
 * @typedef {Object} TeamLogDataResidencyMigrationRequestUnsuccessfulDetails
 */

/**
 * @typedef {Object} TeamLogDataResidencyMigrationRequestUnsuccessfulType
 * @property {string} description
 */

/**
 * Policy for the default number of days until an externally shared link expires
 * @typedef {Object} TeamLogDefaultLinkExpirationDaysPolicy
 * @property {('day_1'|'day_180'|'day_3'|'day_30'|'day_7'|'day_90'|'none'|'year_1'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property
 * {(TeamLogDesktopDeviceSessionLogInfo|TeamLogLegacyDeviceSessionLogInfo|TeamLogMobileDeviceSessionLogInfo|TeamLogWebDeviceSessionLogInfo|TeamLogDeviceSessionLogInfo)}
...
@property
{("desktop_device_session"|"legacy_device_session"|"mobile_device_session"|"web_device_session")}
 ...
 * @typedef {Object} TeamLogDeviceSyncBackupStatusChangedDetails
 * @property {TeamLogDesktopDeviceSessionLogInfo} desktop_device_session_info -
 * Device's session logged information.
 * @property {TeamLogBackupStatus} previous_value - Previous status of computer
 * backup on the device.
 * @property {TeamLogBackupStatus} new_value - Next status of computer backup on
 * the device.
 */

/**
 * @typedef {Object} TeamLogDeviceSyncBackupStatusChangedType
 * @property {string} description
 */
 ...
 * @property {('keep'|'remove'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamLogDispositionActionType
 * @property {('automatic_delete'|'automatic_permanently_delete'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * Exported passwords.
 * @typedef {Object} TeamLogDropboxPasswordsExportedDetails
 * @property {string} platform - The platform the device runs export.
 */

/**
 * @typedef {Object} TeamLogDropboxPasswordsExportedType
 * @property {string} description
 */

/**
 * Enrolled new Dropbox Passwords device.
 * @typedef {Object} TeamLogDropboxPasswordsNewDeviceEnrolledDetails
 * @property {boolean} is_first_device - Whether it's a first device enrolled.
 * @property {string} platform - The platform the device is enrolled.
 */

/**
 * @typedef {Object} TeamLogDropboxPasswordsNewDeviceEnrolledType
 * @property {string} description
 */

/**
 * Policy for deciding whether team users can use Dropbox Passwords
 * @typedef {Object} TeamLogDropboxPasswordsPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Dropbox Passwords policy for team.
 * @typedef {Object} TeamLogDropboxPasswordsPolicyChangedDetails
 * @property {TeamLogDropboxPasswordsPolicy} new_value - To.
 * @property {TeamLogDropboxPasswordsPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogDropboxPasswordsPolicyChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogEmailIngestPolicyChangedType
 * @property {string} description
 */
 ...
 * @property {string} [from_name] - The name as provided by the submitter.
 * @property {string} [from_email] - The email as provided by the submitter.
 */

/**
 * @typedef {Object} TeamLogEmailIngestReceiveFileType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogEncryptedFolderCancelTeamKeyRotationDetails
 * @property {string} team_key_id - Identifier of the team key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderCancelTeamKeyRotationType
 * @property {string} description
 */

/**
 * Added recovery key.
 * @typedef {Object} TeamLogEncryptedFolderEnrollBackupKeyDetails
 * @property {string} backup_key_id - Identifier of the recovery key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderEnrollBackupKeyType
 * @property {string} description
 */

/**
 * Enrolled device.
 * @typedef {Object} TeamLogEncryptedFolderEnrollClientDetails
 * @property {string} client_key_id - Identifier of the client key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderEnrollClientType
 * @property {string} description
 */

/**
 * Activated team folder encryption.
 * @typedef {Object} TeamLogEncryptedFolderEnrollTeamDetails
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderEnrollTeamType
 * @property {string} description
 */

/**
 * Deactivated team folder encryption.
 * @typedef {Object} TeamLogEncryptedFolderFinishTeamUnenrollmentDetails
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderFinishTeamUnenrollmentType
 * @property {string} description
 */

/**
 * Initiated team key rotation.
 * @typedef {Object} TeamLogEncryptedFolderInitTeamKeyRotationDetails
 * @property {string} team_key_id - Identifier of the team key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderInitTeamKeyRotationType
 * @property {string} description
 */

/**
 * Initiated deactivation of team folder encryption.
 * @typedef {Object} TeamLogEncryptedFolderInitTeamUnenrollmentDetails
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderInitTeamUnenrollmentType
 * @property {string} description
 */

/**
 * Removed recovery key.
 * @typedef {Object} TeamLogEncryptedFolderRemoveBackupKeyDetails
 * @property {string} backup_key_id - Identifier of the recovery key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderRemoveBackupKeyType
 * @property {string} description
 */

/**
 * Rotated team key.
 * @typedef {Object} TeamLogEncryptedFolderRotateTeamKeyDetails
 * @property {string} team_key_id - Identifier of the team key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderRotateTeamKeyType
 * @property {string} description
 */

/**
 * Unenrolled device.
 * @typedef {Object} TeamLogEncryptedFolderUnenrollClientDetails
 * @property {string} client_key_id - Identifier of the client key.
 */

/**
 * @typedef {Object} TeamLogEncryptedFolderUnenrollClientType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogEnforceLinkPasswordPolicy
 * @property {('optional'|'required'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('admin_alerting'|'apps'|'comments'|'dash'|'data_governance'|'devices'|'domains'|'encryption'|'file_operations'|'file_requests'|'groups'|'logins'|'members'|'paper'|'passwords'|'protect'|'reports'|'sharing'|'showcase'|'signatures'|'sso'|'team_folders'|'team_policies'|'team_profile'|'tfa'|'trusted_teams'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Additional fields depending on the event type.
 * @typedef {Object} TeamLogEventDetails
 * @property {TeamLogAdminAlertingAlertStateChangedDetails}
 * [admin_alerting_alert_state_changed_details] - Available if .tag is
 * admin_alerting_alert_state_changed_details.
 * @property {TeamLogAdminAlertingChangedAlertConfigDetails}
 * [admin_alerting_changed_alert_config_details] - Available if .tag is
 * admin_alerting_changed_alert_config_details.
 * @property {TeamLogAdminAlertingTriggeredAlertDetails}
 * [admin_alerting_triggered_alert_details] - Available if .tag is
 * admin_alerting_triggered_alert_details.
 * @property {TeamLogRansomwareRestoreProcessCompletedDetails}
 * [ransomware_restore_process_completed_details] - Available if .tag is
 * ransomware_restore_process_completed_details.
 * @property {TeamLogRansomwareRestoreProcessStartedDetails}
 * [ransomware_restore_process_started_details] - Available if .tag is
 * ransomware_restore_process_started_details.
 * @property {TeamLogAppBlockedByPermissionsDetails}
 * [app_blocked_by_permissions_details] - Available if .tag is
 ...
 * @property {TeamLogDashAddedCommentToStackDetails}
 * [dash_added_comment_to_stack_details] - Available if .tag is
 * dash_added_comment_to_stack_details.
 * @property {TeamLogDashAddedConnectorDetails} [dash_added_connector_details] -
 * Available if .tag is dash_added_connector_details.
 * @property {TeamLogDashAddedLinkToStackDetails}
 * [dash_added_link_to_stack_details] - Available if .tag is
 * dash_added_link_to_stack_details.
 * @property {TeamLogDashAddedTeamEmailDomainAllowlistDetails}
 * [dash_added_team_email_domain_allowlist_details] - Available if .tag is
 * dash_added_team_email_domain_allowlist_details.
 * @property {TeamLogDashAdminAddedOrgWideConnectorDetails}
 * [dash_admin_added_org_wide_connector_details] - Available if .tag is
 * dash_admin_added_org_wide_connector_details.
 * @property {TeamLogDashAdminDisabledConnectorDetails}
 * [dash_admin_disabled_connector_details] - Available if .tag is
 * dash_admin_disabled_connector_details.
 * @property {TeamLogDashAdminEnabledConnectorDetails}
 * [dash_admin_enabled_connector_details] - Available if .tag is
 * dash_admin_enabled_connector_details.
 * @property {TeamLogDashAdminRemovedOrgWideConnectorDetails}
 * [dash_admin_removed_org_wide_connector_details] - Available if .tag is
 * dash_admin_removed_org_wide_connector_details.
 * @property {TeamLogDashArchivedStackDetails} [dash_archived_stack_details] -
 * Available if .tag is dash_archived_stack_details.
 * @property {TeamLogDashChangedAudienceOfSharedLinkToStackDetails}
 * [dash_changed_audience_of_shared_link_to_stack_details] - Available if .tag
 * is dash_changed_audience_of_shared_link_to_stack_details.
 * @property {TeamLogDashClonedStackDetails} [dash_cloned_stack_details] -
 * Available if .tag is dash_cloned_stack_details.
 * @property {TeamLogDashConnectorToolsCallDetails}
 * [dash_connector_tools_call_details] - Available if .tag is
 * dash_connector_tools_call_details.
 * @property {TeamLogDashCreatedStackDetails} [dash_created_stack_details] -
 * Available if .tag is dash_created_stack_details.
 * @property {TeamLogDashDeletedCommentFromStackDetails}
 * [dash_deleted_comment_from_stack_details] - Available if .tag is
 * dash_deleted_comment_from_stack_details.
 * @property {TeamLogDashDeletedStackDetails} [dash_deleted_stack_details] -
 * Available if .tag is dash_deleted_stack_details.
 * @property {TeamLogDashEditedCommentInStackDetails}
 * [dash_edited_comment_in_stack_details] - Available if .tag is
 * dash_edited_comment_in_stack_details.
 * @property {TeamLogDashExternalUserOpenedStackDetails}
 * [dash_external_user_opened_stack_details] - Available if .tag is
 * dash_external_user_opened_stack_details.
 * @property {TeamLogDashFirstLaunchedDesktopDetails}
 * [dash_first_launched_desktop_details] - Available if .tag is
 * dash_first_launched_desktop_details.
 * @property {TeamLogDashFirstLaunchedExtensionDetails}
 * [dash_first_launched_extension_details] - Available if .tag is
 * dash_first_launched_extension_details.
 * @property {TeamLogDashFirstLaunchedWebStartPageDetails}
 * [dash_first_launched_web_start_page_details] - Available if .tag is
 * dash_first_launched_web_start_page_details.
 * @property {TeamLogDashOpenedSharedLinkToStackDetails}
 * [dash_opened_shared_link_to_stack_details] - Available if .tag is
 * dash_opened_shared_link_to_stack_details.
 * @property {TeamLogDashOpenedStackDetails} [dash_opened_stack_details] -
 * Available if .tag is dash_opened_stack_details.
 * @property {TeamLogDashPreviewOptOutStatusChangedDetails}
 * [dash_preview_opt_out_status_changed_details] - Available if .tag is
 * dash_preview_opt_out_status_changed_details.
 * @property {TeamLogDashRemovedConnectorDetails}
 * [dash_removed_connector_details] - Available if .tag is
 * dash_removed_connector_details.
 * @property {TeamLogDashRemovedLinkFromStackDetails}
 * [dash_removed_link_from_stack_details] - Available if .tag is
 * dash_removed_link_from_stack_details.
 * @property {TeamLogDashRemovedSharedLinkToStackDetails}
 * [dash_removed_shared_link_to_stack_details] - Available if .tag is
 * dash_removed_shared_link_to_stack_details.
 * @property {TeamLogDashRemovedTeamEmailDomainAllowlistDetails}
 * [dash_removed_team_email_domain_allowlist_details] - Available if .tag is
 * dash_removed_team_email_domain_allowlist_details.
 * @property {TeamLogDashRenamedStackDetails} [dash_renamed_stack_details] -
 * Available if .tag is dash_renamed_stack_details.
 * @property {TeamLogDashSharedLinkToStackDetails}
 * [dash_shared_link_to_stack_details] - Available if .tag is
 * dash_shared_link_to_stack_details.
 * @property {TeamLogDashUnarchivedStackDetails} [dash_unarchived_stack_details]
 * - Available if .tag is dash_unarchived_stack_details.
 * @property {TeamLogDashViewedCompanyStackDetails}
 * [dash_viewed_company_stack_details] - Available if .tag is
 * dash_viewed_company_stack_details.
 * @property {TeamLogDashViewedExternalAiActivityReportDetails}
 * [dash_viewed_external_ai_activity_report_details] - Available if .tag is
 * dash_viewed_external_ai_activity_report_details.
 * @property {TeamLogGovernancePolicyAddFoldersDetails}
 * [governance_policy_add_folders_details] - Available if .tag is
 * governance_policy_add_folders_details.
 * @property {TeamLogGovernancePolicyAddFolderFailedDetails}
 * [governance_policy_add_folder_failed_details] - Available if .tag is
 * governance_policy_add_folder_failed_details.
 * @property {TeamLogGovernancePolicyContentDisposedDetails}
 * [governance_policy_content_disposed_details] - Available if .tag is
 * governance_policy_content_disposed_details.
 * @property {TeamLogGovernancePolicyCreateDetails}
 * [governance_policy_create_details] - Available if .tag is
 * governance_policy_create_details.
 * @property {TeamLogGovernancePolicyDeleteDetails}
 * [governance_policy_delete_details] - Available if .tag is
 * governance_policy_delete_details.
 * @property {TeamLogGovernancePolicyEditDetailsDetails}
 * [governance_policy_edit_details_details] - Available if .tag is
 * governance_policy_edit_details_details.
 * @property {TeamLogGovernancePolicyEditDurationDetails}
 * [governance_policy_edit_duration_details] - Available if .tag is
 * governance_policy_edit_duration_details.
 * @property {TeamLogGovernancePolicyExportCreatedDetails}
 * [governance_policy_export_created_details] - Available if .tag is
 * governance_policy_export_created_details.
 * @property {TeamLogGovernancePolicyExportRemovedDetails}
 * [governance_policy_export_removed_details] - Available if .tag is
 * governance_policy_export_removed_details.
 * @property {TeamLogGovernancePolicyRemoveFoldersDetails}
 * [governance_policy_remove_folders_details] - Available if .tag is
 * governance_policy_remove_folders_details.
 * @property {TeamLogGovernancePolicyReportCreatedDetails}
 * [governance_policy_report_created_details] - Available if .tag is
 * governance_policy_report_created_details.
 * @property {TeamLogGovernancePolicyZipPartDownloadedDetails}
 * [governance_policy_zip_part_downloaded_details] - Available if .tag is
 ...
 * [device_sync_backup_status_changed_details] - Available if .tag is
 ...
 * @property {TeamLogDropboxPasswordsExportedDetails}
 * [dropbox_passwords_exported_details] - Available if .tag is
 * dropbox_passwords_exported_details.
 * @property {TeamLogDropboxPasswordsNewDeviceEnrolledDetails}
 * [dropbox_passwords_new_device_enrolled_details] - Available if .tag is
 ...
 * @property {TeamLogExternalDriveBackupEligibilityStatusCheckedDetails}
 * [external_drive_backup_eligibility_status_checked_details] - Available if
 * .tag is external_drive_backup_eligibility_status_checked_details.
 * @property {TeamLogExternalDriveBackupStatusChangedDetails}
 * [external_drive_backup_status_changed_details] - Available if .tag is
 ...
 * @property {TeamLogEncryptedFolderCancelTeamKeyRotationDetails}
 * [encrypted_folder_cancel_team_key_rotation_details] - Available if .tag is
 * encrypted_folder_cancel_team_key_rotation_details.
 * @property {TeamLogEncryptedFolderEnrollBackupKeyDetails}
 * [encrypted_folder_enroll_backup_key_details] - Available if .tag is
 * encrypted_folder_enroll_backup_key_details.
 * @property {TeamLogEncryptedFolderEnrollClientDetails}
 * [encrypted_folder_enroll_client_details] - Available if .tag is
 * encrypted_folder_enroll_client_details.
 * @property {TeamLogEncryptedFolderEnrollTeamDetails}
 * [encrypted_folder_enroll_team_details] - Available if .tag is
 * encrypted_folder_enroll_team_details.
 * @property {TeamLogEncryptedFolderFinishTeamUnenrollmentDetails}
 * [encrypted_folder_finish_team_unenrollment_details] - Available if .tag is
 * encrypted_folder_finish_team_unenrollment_details.
 * @property {TeamLogEncryptedFolderInitTeamKeyRotationDetails}
 * [encrypted_folder_init_team_key_rotation_details] - Available if .tag is
 * encrypted_folder_init_team_key_rotation_details.
 * @property {TeamLogEncryptedFolderInitTeamUnenrollmentDetails}
 * [encrypted_folder_init_team_unenrollment_details] - Available if .tag is
 * encrypted_folder_init_team_unenrollment_details.
 * @property {TeamLogEncryptedFolderRemoveBackupKeyDetails}
 * [encrypted_folder_remove_backup_key_details] - Available if .tag is
 * encrypted_folder_remove_backup_key_details.
 * @property {TeamLogEncryptedFolderRotateTeamKeyDetails}
 * [encrypted_folder_rotate_team_key_details] - Available if .tag is
 * encrypted_folder_rotate_team_key_details.
 * @property {TeamLogEncryptedFolderUnenrollClientDetails}
 * [encrypted_folder_unenroll_client_details] - Available if .tag is
 * encrypted_folder_unenroll_client_details.
 * @property {TeamLogTeamEncryptionKeyActivateKeyDetails}
 * [team_encryption_key_activate_key_details] - Available if .tag is
 * team_encryption_key_activate_key_details.
 * @property {TeamLogTeamEncryptionKeyCancelKeyDeletionDetails}
 * [team_encryption_key_cancel_key_deletion_details] - Available if .tag is
 * team_encryption_key_cancel_key_deletion_details.
 * @property {TeamLogTeamEncryptionKeyCreateKeyDetails}
 * [team_encryption_key_create_key_details] - Available if .tag is
 * team_encryption_key_create_key_details.
 * @property {TeamLogTeamEncryptionKeyDeactivateKeyDetails}
 * [team_encryption_key_deactivate_key_details] - Available if .tag is
 * team_encryption_key_deactivate_key_details.
 * @property {TeamLogTeamEncryptionKeyDeleteKeyDetails}
 * [team_encryption_key_delete_key_details] - Available if .tag is
 * team_encryption_key_delete_key_details.
 * @property {TeamLogTeamEncryptionKeyDisableKeyDetails}
 * [team_encryption_key_disable_key_details] - Available if .tag is
 * team_encryption_key_disable_key_details.
 * @property {TeamLogTeamEncryptionKeyEnableKeyDetails}
 * [team_encryption_key_enable_key_details] - Available if .tag is
 * team_encryption_key_enable_key_details.
 * @property {TeamLogTeamEncryptionKeyRotateKeyDetails}
 * [team_encryption_key_rotate_key_details] - Available if .tag is
 * team_encryption_key_rotate_key_details.
 * @property {TeamLogTeamEncryptionKeyScheduleKeyDeletionDetails}
 * [team_encryption_key_schedule_key_deletion_details] - Available if .tag is
 * team_encryption_key_schedule_key_deletion_details.
 * @property {TeamLogApplyNamingConventionDetails}
 * [apply_naming_convention_details] - Available if .tag is
 ...
 * file_add_details.
 * @property {TeamLogFileAddFromAutomationDetails}
 * [file_add_from_automation_details] - Available if .tag is
 ...
 * @property {TeamLogMediaHubFileDownloadedDetails}
 * [media_hub_file_downloaded_details] - Available if .tag is
 * media_hub_file_downloaded_details.
 * @property {TeamLogObjectLabelAddedDetails} [object_label_added_details] -
 * Available if .tag is object_label_added_details.
 * @property {TeamLogObjectLabelRemovedDetails} [object_label_removed_details] -
 * Available if .tag is object_label_removed_details.
 * @property {TeamLogObjectLabelUpdatedValueDetails}
 * [object_label_updated_value_details] - Available if .tag is
 * object_label_updated_value_details.
 * @property {TeamLogOrganizeFolderWithTidyDetails}
 * [organize_folder_with_tidy_details] - Available if .tag is
 * organize_folder_with_tidy_details.
 * @property {TeamLogReplayFileDeleteDetails} [replay_file_delete_details] -
 * Available if .tag is replay_file_delete_details.
 * @property {TeamLogReplayFileDownloadedDetails}
 * [replay_file_downloaded_details] - Available if .tag is
 * replay_file_downloaded_details.
 * @property {TeamLogReplayTeamProjectCreatedDetails}
 * [replay_team_project_created_details] - Available if .tag is
 ...
 * @property {TeamLogUndoNamingConventionDetails}
 * [undo_naming_convention_details] - Available if .tag is
 * undo_naming_convention_details.
 * @property {TeamLogUndoOrganizeFolderWithTidyDetails}
 * [undo_organize_folder_with_tidy_details] - Available if .tag is
 * undo_organize_folder_with_tidy_details.
 * @property {TeamLogUserTagsAddedDetails} [user_tags_added_details] - Available
 * if .tag is user_tags_added_details.
 * @property {TeamLogUserTagsRemovedDetails} [user_tags_removed_details] -
 * Available if .tag is user_tags_removed_details.
 * @property {TeamLogEmailIngestReceiveFileDetails}
 * [email_ingest_receive_file_details] - Available if .tag is
 * email_ingest_receive_file_details.
 * @property {TeamLogFileRequestAutoCloseDetails}
 * [file_request_auto_close_details] - Available if .tag is
 ...
 * @property {TeamLogGroupExternalSharingSettingOverrideChangedDetails}
 * [group_external_sharing_setting_override_changed_details] - Available if .tag
 * is group_external_sharing_setting_override_changed_details.
 ...
 * sso_error_details.
 * @property {TeamLogAddonAssignedDetails} [addon_assigned_details] - Available
 * if .tag is addon_assigned_details.
 * @property {TeamLogAddonRemovedDetails} [addon_removed_details] - Available if
 * .tag is addon_removed_details.
 * @property {TeamLogBackupAdminInvitationSentDetails}
 * [backup_admin_invitation_sent_details] - Available if .tag is
 * backup_admin_invitation_sent_details.
 * @property {TeamLogBackupInvitationOpenedDetails}
 * [backup_invitation_opened_details] - Available if .tag is
 ...
 * @property {TeamLogMemberChangeResellerRoleDetails}
 * [member_change_reseller_role_details] - Available if .tag is
 ...
 * @property {TeamLogProductAssignedToMemberDetails}
 * [product_assigned_to_member_details] - Available if .tag is
 * product_assigned_to_member_details.
 * @property {TeamLogProductRemovedFromMemberDetails}
 * [product_removed_from_member_details] - Available if .tag is
 * product_removed_from_member_details.
 ...
 * @property {TeamLogProtectActionRemoveDomainsDetails}
 * [protect_action_remove_domains_details] - Available if .tag is
 ...
 * @property {TeamLogProtectReportViewDetails} [protect_report_view_details] -
 * Available if .tag is protect_report_view_details.
 ...
 * @property {TeamLogClassificationCreateReportFailDetails}
 * [classification_create_report_fail_details] - Available if .tag is
 ...
 * @property {TeamLogExternalSharingCreateReportDetails}
 * [external_sharing_create_report_details] - Available if .tag is
 * external_sharing_create_report_details.
 * @property {TeamLogExternalSharingReportFailedDetails}
 * [external_sharing_report_failed_details] - Available if .tag is
 * external_sharing_report_failed_details.
 * @property {TeamLogMemberAccessDetailsCreateReportDetails}
 * [member_access_details_create_report_details] - Available if .tag is
 * member_access_details_create_report_details.
 * @property {TeamLogMemberAccessDetailsCreateReportFailedDetails}
 * [member_access_details_create_report_failed_details] - Available if .tag is
 ...
 * @property {TeamLogRansomwareAlertCreateReportDetails}
 * [ransomware_alert_create_report_details] - Available if .tag is
 * ransomware_alert_create_report_details.
 * @property {TeamLogRansomwareAlertCreateReportFailedDetails}
 * [ransomware_alert_create_report_failed_details] - Available if .tag is
 * ransomware_alert_create_report_failed_details.
 * @property {TeamLogSharedFoldersCreateReportDetails}
 * [shared_folders_create_report_details] - Available if .tag is
 * shared_folders_create_report_details.
 * @property {TeamLogSharedFoldersCreateReportFailedDetails}
 * [shared_folders_create_report_failed_details] - Available if .tag is
 * shared_folders_create_report_failed_details.
 ...
 * @property {TeamLogTeamFoldersCreateReportDetails}
 * [team_folders_create_report_details] - Available if .tag is
 * team_folders_create_report_details.
 * @property {TeamLogTeamFoldersCreateReportFailedDetails}
 * [team_folders_create_report_failed_details] - Available if .tag is
 * team_folders_create_report_failed_details.
 * @property {TeamLogTeamStorageCreateReportDetails}
 * [team_storage_create_report_details] - Available if .tag is
 * team_storage_create_report_details.
 * @property {TeamLogTeamStorageCreateReportFailedDetails}
 * [team_storage_create_report_failed_details] - Available if .tag is
 * team_storage_create_report_failed_details.
 ...
 * @property {TeamLogMediaHubProjectTeamAddDetails}
 * [media_hub_project_team_add_details] - Available if .tag is
 * media_hub_project_team_add_details.
 * @property {TeamLogMediaHubProjectTeamDeleteDetails}
 * [media_hub_project_team_delete_details] - Available if .tag is
 * media_hub_project_team_delete_details.
 * @property {TeamLogMediaHubProjectTeamRoleChangedDetails}
 * [media_hub_project_team_role_changed_details] - Available if .tag is
 * media_hub_project_team_role_changed_details.
 * @property {TeamLogMediaHubSharedLinkAudienceChangedDetails}
 * [media_hub_shared_link_audience_changed_details] - Available if .tag is
 * media_hub_shared_link_audience_changed_details.
 * @property {TeamLogMediaHubSharedLinkCreatedDetails}
 * [media_hub_shared_link_created_details] - Available if .tag is
 * media_hub_shared_link_created_details.
 * @property {TeamLogMediaHubSharedLinkDownloadSettingChangedDetails}
 * [media_hub_shared_link_download_setting_changed_details] - Available if .tag
 * is media_hub_shared_link_download_setting_changed_details.
 * @property {TeamLogMediaHubSharedLinkRevokedDetails}
 * [media_hub_shared_link_revoked_details] - Available if .tag is
 * media_hub_shared_link_revoked_details.
 ...
 * @property {TeamLogReplayFileSharedLinkCreatedDetails}
 * [replay_file_shared_link_created_details] - Available if .tag is
 * replay_file_shared_link_created_details.
 * @property {TeamLogReplayFileSharedLinkModifiedDetails}
 * [replay_file_shared_link_modified_details] - Available if .tag is
 * replay_file_shared_link_modified_details.
 * @property {TeamLogReplayProjectTeamAddDetails}
 * [replay_project_team_add_details] - Available if .tag is
 * replay_project_team_add_details.
 * @property {TeamLogReplayProjectTeamDeleteDetails}
 * [replay_project_team_delete_details] - Available if .tag is
 * replay_project_team_delete_details.
 * @property {TeamLogSendAndTrackFileAddedDetails}
 * [send_and_track_file_added_details] - Available if .tag is
 * send_and_track_file_added_details.
 * @property {TeamLogSendAndTrackFileRenamedDetails}
 * [send_and_track_file_renamed_details] - Available if .tag is
 * send_and_track_file_renamed_details.
 * @property {TeamLogSendAndTrackFileUpdatedDetails}
 * [send_and_track_file_updated_details] - Available if .tag is
 * send_and_track_file_updated_details.
 * @property {TeamLogSendAndTrackLinkCreatedDetails}
 * [send_and_track_link_created_details] - Available if .tag is
 * send_and_track_link_created_details.
 * @property {TeamLogSendAndTrackLinkDeletedDetails}
 * [send_and_track_link_deleted_details] - Available if .tag is
 * send_and_track_link_deleted_details.
 * @property {TeamLogSendAndTrackLinkUpdatedDetails}
 * [send_and_track_link_updated_details] - Available if .tag is
 * send_and_track_link_updated_details.
 * @property {TeamLogSendAndTrackLinkViewedDetails}
 * [send_and_track_link_viewed_details] - Available if .tag is
 * send_and_track_link_viewed_details.
 * @property {TeamLogSendAndTrackRemovedFileAndAssociatedLinksDetails}
 * [send_and_track_removed_file_and_associated_links_details] - Available if
 * .tag is send_and_track_removed_file_and_associated_links_details.
 ...
 * @property {TeamLogSharedLinkRemoveVisitorDetails}
 * [shared_link_remove_visitor_details] - Available if .tag is
 * shared_link_remove_visitor_details.
 ...
 * @property {TeamLogShmodelDisableDownloadsDetails}
 * [shmodel_disable_downloads_details] - Available if .tag is
 * shmodel_disable_downloads_details.
 * @property {TeamLogShmodelEnableDownloadsDetails}
 * [shmodel_enable_downloads_details] - Available if .tag is
 ...
 * @property {TeamLogSignSignatureRequestCanceledDetails}
 * [sign_signature_request_canceled_details] - Available if .tag is
 * sign_signature_request_canceled_details.
 * @property {TeamLogSignSignatureRequestCompletedDetails}
 * [sign_signature_request_completed_details] - Available if .tag is
 * sign_signature_request_completed_details.
 * @property {TeamLogSignSignatureRequestDeclinedDetails}
 * [sign_signature_request_declined_details] - Available if .tag is
 * sign_signature_request_declined_details.
 * @property {TeamLogSignSignatureRequestOpenedDetails}
 * [sign_signature_request_opened_details] - Available if .tag is
 * sign_signature_request_opened_details.
 * @property {TeamLogSignSignatureRequestReminderSentDetails}
 * [sign_signature_request_reminder_sent_details] - Available if .tag is
 * sign_signature_request_reminder_sent_details.
 * @property {TeamLogSignSignatureRequestSentDetails}
 * [sign_signature_request_sent_details] - Available if .tag is
 * sign_signature_request_sent_details.
 * @property {TeamLogSignTemplateCreatedDetails} [sign_template_created_details]
 * - Available if .tag is sign_template_created_details.
 * @property {TeamLogSignTemplateSharedDetails} [sign_template_shared_details] -
 * Available if .tag is sign_template_shared_details.
 * @property {TeamLogRiscSecurityEventDetails} [risc_security_event_details] -
 * Available if .tag is risc_security_event_details.
 ...
 * @property {TeamLogTeamFolderSpaceLimitsChangeCapsTypeDetails}
 * [team_folder_space_limits_change_caps_type_details] - Available if .tag is
 * team_folder_space_limits_change_caps_type_details.
 * @property {TeamLogTeamFolderSpaceLimitsChangeLimitDetails}
 * [team_folder_space_limits_change_limit_details] - Available if .tag is
 * team_folder_space_limits_change_limit_details.
 * @property {TeamLogTeamFolderSpaceLimitsChangeNotificationTargetDetails}
 * [team_folder_space_limits_change_notification_target_details] - Available if
 * .tag is team_folder_space_limits_change_notification_target_details.
 ...
 * @property {TeamLogAdminEmailRemindersChangedDetails}
 * [admin_email_reminders_changed_details] - Available if .tag is
 * admin_email_reminders_changed_details.
 * @property {TeamLogAiThirdPartySharingDropboxBasePolicyChangedDetails}
 * [ai_third_party_sharing_dropbox_base_policy_changed_details] - Available if
 * .tag is ai_third_party_sharing_dropbox_base_policy_changed_details.
 ...
 * @property {TeamLogAppleLoginChangePolicyDetails}
 * [apple_login_change_policy_details] - Available if .tag is
 * apple_login_change_policy_details.
 * @property {TeamLogAppPermissionsChangedDetails}
 * [app_permissions_changed_details] - Available if .tag is
 ...
 * @property {TeamLogCaptureTeamSpacePolicyChangedDetails}
 * [capture_team_space_policy_changed_details] - Available if .tag is
 * capture_team_space_policy_changed_details.
 * @property {TeamLogCaptureTranscriptPolicyChangedDetails}
 * [capture_transcript_policy_changed_details] - Available if .tag is
 * capture_transcript_policy_changed_details.
 * @property {TeamLogClassificationChangePolicyDetails}
 * [classification_change_policy_details] - Available if .tag is
 * classification_change_policy_details.
 * @property {TeamLogComputerBackupPolicyChangedDetails}
 * [computer_backup_policy_changed_details] - Available if .tag is
 * computer_backup_policy_changed_details.
 * @property {TeamLogContentAdministrationPolicyChangedDetails}
 * [content_administration_policy_changed_details] - Available if .tag is
 * content_administration_policy_changed_details.
 * @property {TeamLogContentDeletionProtectionChangePolicyDetails}
 * [content_deletion_protection_change_policy_details] - Available if .tag is
 * content_deletion_protection_change_policy_details.
 * @property {TeamLogDashExternalSharingPolicyChangedDetails}
 * [dash_external_sharing_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogDropboxPasswordsPolicyChangedDetails}
 * [dropbox_passwords_policy_changed_details] - Available if .tag is
 * dropbox_passwords_policy_changed_details.
 * @property {TeamLogEmailIngestPolicyChangedDetails}
 * [email_ingest_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogExternalDriveBackupPolicyChangedDetails}
 * [external_drive_backup_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogFileProviderMigrationPolicyChangedDetails}
 * [file_provider_migration_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogFlexibleFileNamesPolicyChangedDetails}
 * [flexible_file_names_policy_changed_details] - Available if .tag is
 * flexible_file_names_policy_changed_details.
 * @property {TeamLogFolderLinkRestrictionPolicyChangedDetails}
 * [folder_link_restriction_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogInviteAcceptanceEmailPolicyChangedDetails}
 * [invite_acceptance_email_policy_changed_details] - Available if .tag is
 * invite_acceptance_email_policy_changed_details.
 * @property {TeamLogMediaHubAddingPeoplePolicyChangedDetails}
 * [media_hub_adding_people_policy_changed_details] - Available if .tag is
 * media_hub_adding_people_policy_changed_details.
 * @property {TeamLogMediaHubDownloadPolicyChangedDetails}
 * [media_hub_download_policy_changed_details] - Available if .tag is
 * media_hub_download_policy_changed_details.
 * @property {TeamLogMediaHubLinkSharingPolicyChangedDetails}
 * [media_hub_link_sharing_policy_changed_details] - Available if .tag is
 * media_hub_link_sharing_policy_changed_details.
 ...
 * @property {TeamLogMicrosoftLoginChangePolicyDetails}
 * [microsoft_login_change_policy_details] - Available if .tag is
 * microsoft_login_change_policy_details.
 ...
 * @property {TeamLogMultiTeamIdentityPolicyChangedDetails}
 * [multi_team_identity_policy_changed_details] - Available if .tag is
 * multi_team_identity_policy_changed_details.
 ...
 * @property {TeamLogPasskeyLoginPolicyChangedDetails}
 * [passkey_login_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogPreviewsAiPolicyChangedDetails}
 * [previews_ai_policy_changed_details] - Available if .tag is
 * previews_ai_policy_changed_details.
 * @property {TeamLogReplayAddingPeoplePolicyChangedDetails}
 * [replay_adding_people_policy_changed_details] - Available if .tag is
 * replay_adding_people_policy_changed_details.
 * @property {TeamLogReplaySharingPolicyChangedDetails}
 * [replay_sharing_policy_changed_details] - Available if .tag is
 * replay_sharing_policy_changed_details.
 ...
 * @property {TeamLogSendAndTrackPolicyChangedDetails}
 * [send_and_track_policy_changed_details] - Available if .tag is
 * send_and_track_policy_changed_details.
 * @property {TeamLogSendExternalSharingPolicyChangedDetails}
 * [send_external_sharing_policy_changed_details] - Available if .tag is
 * send_external_sharing_policy_changed_details.
 * @property {TeamLogSendForSignaturePolicyChangedDetails}
 * [send_for_signature_policy_changed_details] - Available if .tag is
 * send_for_signature_policy_changed_details.
 * @property {TeamLogSharedLinkDefaultPermissionsPolicyChangedDetails}
 * [shared_link_default_permissions_policy_changed_details] - Available if .tag
 * is shared_link_default_permissions_policy_changed_details.
 ...
 * @property {TeamLogSharingChangeLinkAllowChangeExpirationPolicyDetails}
 * [sharing_change_link_allow_change_expiration_policy_details] - Available if
 * .tag is sharing_change_link_allow_change_expiration_policy_details.
 * @property {TeamLogSharingChangeLinkDefaultExpirationPolicyDetails}
 * [sharing_change_link_default_expiration_policy_details] - Available if .tag
 * is sharing_change_link_default_expiration_policy_details.
 * @property {TeamLogSharingChangeLinkEnforcePasswordPolicyDetails}
 * [sharing_change_link_enforce_password_policy_details] - Available if .tag is
 ...
 * @property {TeamLogSignExternalSharingPolicyChangedDetails}
 * [sign_external_sharing_policy_changed_details] - Available if .tag is
 * sign_external_sharing_policy_changed_details.
 * @property {TeamLogSignTemplateCreationPermissionChangedDetails}
 * [sign_template_creation_permission_changed_details] - Available if .tag is
 ...
 * @property {TeamLogStackCrossTeamAccessPolicyChangedDetails}
 * [stack_cross_team_access_policy_changed_details] - Available if .tag is
 * stack_cross_team_access_policy_changed_details.
 * @property {TeamLogTeamBrandingPolicyChangedDetails}
 * [team_branding_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogTeamExternalSharingControlsActivationStateChangedDetails}
 * [team_external_sharing_controls_activation_state_changed_details] - Available
 * if .tag is team_external_sharing_controls_activation_state_changed_details.
 * @property {TeamLogTeamExternalSharingControlsRecipientListsChangedDetails}
 * [team_external_sharing_controls_recipient_lists_changed_details] - Available
 * if .tag is team_external_sharing_controls_recipient_lists_changed_details.
 * @property {TeamLogTeamMemberStorageRequestPolicyChangedDetails}
 * [team_member_storage_request_policy_changed_details] - Available if .tag is
 ...
 * @property {TeamLogTopLevelContentPolicyChangedDetails}
 * [top_level_content_policy_changed_details] - Available if .tag is
 * top_level_content_policy_changed_details.
 ...
 * [data_residency_migration_request_successful_details] - Available if .tag is
 * data_residency_migration_request_successful_details.
 * @property {TeamLogDataResidencyMigrationRequestUnsuccessfulDetails}
 * [data_residency_migration_request_unsuccessful_details] - Available if .tag
 * is data_residency_migration_request_unsuccessful_details.
 ...
 * @property {TeamLogTeamProfileAddBackgroundDetails}
 * [team_profile_add_background_details] - Available if .tag is
 ...
 * @property {TeamLogTeamProfileChangeBackgroundDetails}
 * [team_profile_change_background_details] - Available if .tag is
 ...
 * @property {TeamLogTeamProfileRemoveBackgroundDetails}
 * [team_profile_remove_background_details] - Available if .tag is
 ...
 * @property {TeamLogPasskeyAddDetails} [passkey_add_details] - Available if
 * .tag is passkey_add_details.
 * @property {TeamLogPasskeyRemoveDetails} [passkey_remove_details] - Available
 * if .tag is passkey_remove_details.
 ...
 * comment
 * @property {TeamLogDashAddedCommentToStackType} [dash_added_comment_to_stack]
 * - Available if .tag is dash_added_comment_to_stack. (dash) Added a comment to
 * a stack
 * @property {TeamLogDashAddedConnectorType} [dash_added_connector] - Available
 * if .tag is dash_added_connector. (dash) Connected to a user connector
 * @property {TeamLogDashAddedLinkToStackType} [dash_added_link_to_stack] -
 * Available if .tag is dash_added_link_to_stack. (dash) Added a link to a stack
 * @property {TeamLogDashAddedTeamEmailDomainAllowlistType}
 * [dash_added_team_email_domain_allowlist] - Available if .tag is
 * dash_added_team_email_domain_allowlist. (dash) Admin added an email domain to
 * the team allowlist
 * @property {TeamLogDashAdminAddedOrgWideConnectorType}
 * [dash_admin_added_org_wide_connector] - Available if .tag is
 * dash_admin_added_org_wide_connector. (dash) Admin added an admin connector
 * @property {TeamLogDashAdminDisabledConnectorType}
 * [dash_admin_disabled_connector] - Available if .tag is
 * dash_admin_disabled_connector. (dash) Admin disabled a user connector
 * @property {TeamLogDashAdminEnabledConnectorType}
 * [dash_admin_enabled_connector] - Available if .tag is
 * dash_admin_enabled_connector. (dash) Admin enabled a user connector
 * @property {TeamLogDashAdminRemovedOrgWideConnectorType}
 * [dash_admin_removed_org_wide_connector] - Available if .tag is
 * dash_admin_removed_org_wide_connector. (dash) Admin removed an admin
 * connector
 * @property {TeamLogDashArchivedStackType} [dash_archived_stack] - Available if
 * .tag is dash_archived_stack. (dash) Archived a stack
 * @property {TeamLogDashChangedAudienceOfSharedLinkToStackType}
 * [dash_changed_audience_of_shared_link_to_stack] - Available if .tag is
 * dash_changed_audience_of_shared_link_to_stack. (dash) Changed the audience of
 * a shared link to a stack
 * @property {TeamLogDashClonedStackType} [dash_cloned_stack] - Available if
 * .tag is dash_cloned_stack. (dash) Cloned stack
 * @property {TeamLogDashConnectorToolsCallType} [dash_connector_tools_call] -
 * Available if .tag is dash_connector_tools_call. (dash) Called a tool on a
 * connector
 * @property {TeamLogDashCreatedStackType} [dash_created_stack] - Available if
 * .tag is dash_created_stack. (dash) Created a stack
 * @property {TeamLogDashDeletedCommentFromStackType}
 * [dash_deleted_comment_from_stack] - Available if .tag is
 * dash_deleted_comment_from_stack. (dash) Deleted a comment from a stack
 * @property {TeamLogDashDeletedStackType} [dash_deleted_stack] - Available if
 * .tag is dash_deleted_stack. (dash) Deleted a stack
 * @property {TeamLogDashEditedCommentInStackType}
 * [dash_edited_comment_in_stack] - Available if .tag is
 * dash_edited_comment_in_stack. (dash) Edited a comment in a stack
 * @property {TeamLogDashExternalUserOpenedStackType}
 * [dash_external_user_opened_stack] - Available if .tag is
 * dash_external_user_opened_stack. (dash) External user opened a stack
 * @property {TeamLogDashFirstLaunchedDesktopType} [dash_first_launched_desktop]
 * - Available if .tag is dash_first_launched_desktop. (dash) Opened the desktop
 * app for the first time
 * @property {TeamLogDashFirstLaunchedExtensionType}
 * [dash_first_launched_extension] - Available if .tag is
 * dash_first_launched_extension. (dash) Opened the extension for the first time
 * @property {TeamLogDashFirstLaunchedWebStartPageType}
 * [dash_first_launched_web_start_page] - Available if .tag is
 * dash_first_launched_web_start_page. (dash) Opened the web Start Page for the
 * first time
 * @property {TeamLogDashOpenedSharedLinkToStackType}
 * [dash_opened_shared_link_to_stack] - Available if .tag is
 * dash_opened_shared_link_to_stack. (dash) Checked access permissions to a
 * stack
 * @property {TeamLogDashOpenedStackType} [dash_opened_stack] - Available if
 * .tag is dash_opened_stack. (dash) Opened a stack
 * @property {TeamLogDashPreviewOptOutStatusChangedType}
 * [dash_preview_opt_out_status_changed] - Available if .tag is
 * dash_preview_opt_out_status_changed. (dash) Changed the preview opt-out
 * status
 * @property {TeamLogDashRemovedConnectorType} [dash_removed_connector] -
 * Available if .tag is dash_removed_connector. (dash) Disconnected a user
 * connector
 * @property {TeamLogDashRemovedLinkFromStackType}
 * [dash_removed_link_from_stack] - Available if .tag is
 * dash_removed_link_from_stack. (dash) Removed a link from a stack
 * @property {TeamLogDashRemovedSharedLinkToStackType}
 * [dash_removed_shared_link_to_stack] - Available if .tag is
 * dash_removed_shared_link_to_stack. (dash) Removed a shared link to a stack
 * @property {TeamLogDashRemovedTeamEmailDomainAllowlistType}
 * [dash_removed_team_email_domain_allowlist] - Available if .tag is
 * dash_removed_team_email_domain_allowlist. (dash) Admin removed an email
 * domain from the team allowlist
 * @property {TeamLogDashRenamedStackType} [dash_renamed_stack] - Available if
 * .tag is dash_renamed_stack. (dash) Renamed a stack
 * @property {TeamLogDashSharedLinkToStackType} [dash_shared_link_to_stack] -
 * Available if .tag is dash_shared_link_to_stack. (dash) Shared a link to a
 * stack
 * @property {TeamLogDashUnarchivedStackType} [dash_unarchived_stack] -
 * Available if .tag is dash_unarchived_stack. (dash) Unarchived a stack
 * @property {TeamLogDashViewedCompanyStackType} [dash_viewed_company_stack] -
 * Available if .tag is dash_viewed_company_stack. (dash) Member viewed a
 * company stack
 * @property {TeamLogDashViewedExternalAiActivityReportType}
 * [dash_viewed_external_ai_activity_report] - Available if .tag is
 * dash_viewed_external_ai_activity_report. (dash) Admin viewed the external AI
 * activity report
 * @property {TeamLogGovernancePolicyAddFoldersType}
 * [governance_policy_add_folders] - Available if .tag is
 * governance_policy_add_folders. (data_governance) Added folders to policy
 * @property {TeamLogGovernancePolicyAddFolderFailedType}
 * [governance_policy_add_folder_failed] - Available if .tag is
 * governance_policy_add_folder_failed. (data_governance) Couldn't add a folder
 * to a policy
 * @property {TeamLogGovernancePolicyContentDisposedType}
 * [governance_policy_content_disposed] - Available if .tag is
 * governance_policy_content_disposed. (data_governance) Content disposed
 * @property {TeamLogGovernancePolicyCreateType} [governance_policy_create] -
 * Available if .tag is governance_policy_create. (data_governance) Activated a
 * new policy
 * @property {TeamLogGovernancePolicyDeleteType} [governance_policy_delete] -
 * Available if .tag is governance_policy_delete. (data_governance) Deleted a
 * policy
 * @property {TeamLogGovernancePolicyEditDetailsType}
 * [governance_policy_edit_details] - Available if .tag is
 * governance_policy_edit_details. (data_governance) Edited policy
 * @property {TeamLogGovernancePolicyEditDurationType}
 * [governance_policy_edit_duration] - Available if .tag is
 * governance_policy_edit_duration. (data_governance) Changed policy duration
 * @property {TeamLogGovernancePolicyExportCreatedType}
 * [governance_policy_export_created] - Available if .tag is
 * governance_policy_export_created. (data_governance) Created a policy download
 * @property {TeamLogGovernancePolicyExportRemovedType}
 * [governance_policy_export_removed] - Available if .tag is
 * governance_policy_export_removed. (data_governance) Removed a policy download
 * @property {TeamLogGovernancePolicyRemoveFoldersType}
 * [governance_policy_remove_folders] - Available if .tag is
 * governance_policy_remove_folders. (data_governance) Removed folders from
 * policy
 * @property {TeamLogGovernancePolicyReportCreatedType}
 * [governance_policy_report_created] - Available if .tag is
 * governance_policy_report_created. (data_governance) Created a summary report
 * for a policy
 * @property {TeamLogGovernancePolicyZipPartDownloadedType}
 * [governance_policy_zip_part_downloaded] - Available if .tag is
 * governance_policy_zip_part_downloaded. (data_governance) Downloaded content
 * from a policy
 * @property {TeamLogLegalHoldsActivateAHoldType} [legal_holds_activate_a_hold]
 * - Available if .tag is legal_holds_activate_a_hold. (data_governance)
 * Activated a hold
 * @property {TeamLogLegalHoldsAddMembersType} [legal_holds_add_members] -
 * Available if .tag is legal_holds_add_members. (data_governance) Added members
 * to a hold
 * @property {TeamLogLegalHoldsChangeHoldDetailsType}
 * [legal_holds_change_hold_details] - Available if .tag is
 * legal_holds_change_hold_details. (data_governance) Edited details for a hold
 * @property {TeamLogLegalHoldsChangeHoldNameType}
 * [legal_holds_change_hold_name] - Available if .tag is
 * legal_holds_change_hold_name. (data_governance) Renamed a hold
 * @property {TeamLogLegalHoldsExportAHoldType} [legal_holds_export_a_hold] -
 * Available if .tag is legal_holds_export_a_hold. (data_governance) Exported
 * hold
 * @property {TeamLogLegalHoldsExportCancelledType}
 * [legal_holds_export_cancelled] - Available if .tag is
 * legal_holds_export_cancelled. (data_governance) Canceled export for a hold
 * @property {TeamLogLegalHoldsExportDownloadedType}
 * [legal_holds_export_downloaded] - Available if .tag is
 * legal_holds_export_downloaded. (data_governance) Downloaded export for a hold
 * @property {TeamLogLegalHoldsExportRemovedType} [legal_holds_export_removed] -
 * Available if .tag is legal_holds_export_removed. (data_governance) Removed
 * export for a hold
 * @property {TeamLogLegalHoldsReleaseAHoldType} [legal_holds_release_a_hold] -
 * Available if .tag is legal_holds_release_a_hold. (data_governance) Released a
 * hold
 * @property {TeamLogLegalHoldsRemoveMembersType} [legal_holds_remove_members] -
 * Available if .tag is legal_holds_remove_members. (data_governance) Removed
 * members from a hold
 * @property {TeamLogLegalHoldsReportAHoldType} [legal_holds_report_a_hold] -
 * Available if .tag is legal_holds_report_a_hold. (data_governance) Created a
 ...
 * management (deprecated, no longer logged)
 * @property {TeamLogDeviceSyncBackupStatusChangedType}
 * [device_sync_backup_status_changed] - Available if .tag is
 * device_sync_backup_status_changed. (devices) Enabled/disabled backup for
 * computer
 * @property {TeamLogDeviceUnlinkType} [device_unlink] - Available if .tag is
 * device_unlink. (devices) Disconnected device
 * @property {TeamLogDropboxPasswordsExportedType} [dropbox_passwords_exported]
 * - Available if .tag is dropbox_passwords_exported. (devices) Exported
 * passwords
 * @property {TeamLogDropboxPasswordsNewDeviceEnrolledType}
 * [dropbox_passwords_new_device_enrolled] - Available if .tag is
 * dropbox_passwords_new_device_enrolled. (devices) Enrolled new Dropbox
 * Passwords device
 ...
 * @property {TeamLogExternalDriveBackupEligibilityStatusCheckedType}
 * [external_drive_backup_eligibility_status_checked] - Available if .tag is
 * external_drive_backup_eligibility_status_checked. (devices) Checked external
 * drive backup eligibility status
 * @property {TeamLogExternalDriveBackupStatusChangedType}
 * [external_drive_backup_status_changed] - Available if .tag is
 * external_drive_backup_status_changed. (devices) Modified external drive
 * backup
 ...
 * @property {TeamLogEncryptedFolderCancelTeamKeyRotationType}
 * [encrypted_folder_cancel_team_key_rotation] - Available if .tag is
 * encrypted_folder_cancel_team_key_rotation. (encryption) Canceled team key
 * rotation
 * @property {TeamLogEncryptedFolderEnrollBackupKeyType}
 * [encrypted_folder_enroll_backup_key] - Available if .tag is
 * encrypted_folder_enroll_backup_key. (encryption) Added recovery key
 * @property {TeamLogEncryptedFolderEnrollClientType}
 * [encrypted_folder_enroll_client] - Available if .tag is
 * encrypted_folder_enroll_client. (encryption) Enrolled device
 * @property {TeamLogEncryptedFolderEnrollTeamType}
 * [encrypted_folder_enroll_team] - Available if .tag is
 * encrypted_folder_enroll_team. (encryption) Activated team folder encryption
 * @property {TeamLogEncryptedFolderFinishTeamUnenrollmentType}
 * [encrypted_folder_finish_team_unenrollment] - Available if .tag is
 * encrypted_folder_finish_team_unenrollment. (encryption) Deactivated team
 * folder encryption
 * @property {TeamLogEncryptedFolderInitTeamKeyRotationType}
 * [encrypted_folder_init_team_key_rotation] - Available if .tag is
 * encrypted_folder_init_team_key_rotation. (encryption) Initiated team key
 * rotation
 * @property {TeamLogEncryptedFolderInitTeamUnenrollmentType}
 * [encrypted_folder_init_team_unenrollment] - Available if .tag is
 * encrypted_folder_init_team_unenrollment. (encryption) Initiated deactivation
 * of team folder encryption
 * @property {TeamLogEncryptedFolderRemoveBackupKeyType}
 * [encrypted_folder_remove_backup_key] - Available if .tag is
 * encrypted_folder_remove_backup_key. (encryption) Removed recovery key
 * @property {TeamLogEncryptedFolderRotateTeamKeyType}
 * [encrypted_folder_rotate_team_key] - Available if .tag is
 * encrypted_folder_rotate_team_key. (encryption) Rotated team key
 * @property {TeamLogEncryptedFolderUnenrollClientType}
 * [encrypted_folder_unenroll_client] - Available if .tag is
 * encrypted_folder_unenroll_client. (encryption) Unenrolled device
 * @property {TeamLogTeamEncryptionKeyActivateKeyType}
 * [team_encryption_key_activate_key] - Available if .tag is
 * team_encryption_key_activate_key. (encryption) Activated team encryption key
 * @property {TeamLogTeamEncryptionKeyCancelKeyDeletionType}
 * [team_encryption_key_cancel_key_deletion] - Available if .tag is
 * team_encryption_key_cancel_key_deletion. (encryption) Canceled team
 * encryption key deletion
 * @property {TeamLogTeamEncryptionKeyCreateKeyType}
 * [team_encryption_key_create_key] - Available if .tag is
 * team_encryption_key_create_key. (encryption) Created team encryption key
 * @property {TeamLogTeamEncryptionKeyDeactivateKeyType}
 * [team_encryption_key_deactivate_key] - Available if .tag is
 * team_encryption_key_deactivate_key. (encryption) Deactivated team encryption
 * key
 * @property {TeamLogTeamEncryptionKeyDeleteKeyType}
 * [team_encryption_key_delete_key] - Available if .tag is
 * team_encryption_key_delete_key. (encryption) Deleted team encryption key
 * @property {TeamLogTeamEncryptionKeyDisableKeyType}
 * [team_encryption_key_disable_key] - Available if .tag is
 * team_encryption_key_disable_key. (encryption) Disabled team encryption key
 * @property {TeamLogTeamEncryptionKeyEnableKeyType}
 * [team_encryption_key_enable_key] - Available if .tag is
 * team_encryption_key_enable_key. (encryption) Enabled team encryption key
 * @property {TeamLogTeamEncryptionKeyRotateKeyType}
 * [team_encryption_key_rotate_key] - Available if .tag is
 * team_encryption_key_rotate_key. (encryption) Rotated team encryption key
 * (deprecated, no longer logged)
 * @property {TeamLogTeamEncryptionKeyScheduleKeyDeletionType}
 * [team_encryption_key_schedule_key_deletion] - Available if .tag is
 * team_encryption_key_schedule_key_deletion. (encryption) Scheduled encryption
 * key deletion
 * @property {TeamLogApplyNamingConventionType} [apply_naming_convention] -
 * Available if .tag is apply_naming_convention. (file_operations) Applied
 * naming convention
 ...
 * @property {TeamLogFileAddFromAutomationType} [file_add_from_automation] -
 * Available if .tag is file_add_from_automation. (file_operations) Added files
 * and/or folders from automation
 ...
 * if .tag is object_label_removed. (file_operations) Removed a label
 * @property {TeamLogObjectLabelUpdatedValueType} [object_label_updated_value] -
 * Available if .tag is object_label_updated_value. (file_operations) Updated a
 * label's value
 * @property {TeamLogOrganizeFolderWithTidyType} [organize_folder_with_tidy] -
 * Available if .tag is organize_folder_with_tidy. (file_operations) Organized a
 * folder with multi-file organize
 * @property {TeamLogReplayFileDeleteType} [replay_file_delete] - Available if
 * .tag is replay_file_delete. (file_operations) Deleted files in Replay
 * @property {TeamLogReplayFileDownloadedType} [replay_file_downloaded] -
 * Available if .tag is replay_file_downloaded. (file_operations) Downloaded
 * files in Replay
 * @property {TeamLogReplayTeamProjectCreatedType} [replay_team_project_created]
 * - Available if .tag is replay_team_project_created. (file_operations) Created
 * a team project in Replay
 * @property {TeamLogRewindFolderType} [rewind_folder] - Available if .tag is
 * rewind_folder. (file_operations) Rewound a folder
 * @property {TeamLogUndoNamingConventionType} [undo_naming_convention] -
 * Available if .tag is undo_naming_convention. (file_operations) Reverted
 * naming convention
 * @property {TeamLogUndoOrganizeFolderWithTidyType}
 * [undo_organize_folder_with_tidy] - Available if .tag is
 * undo_organize_folder_with_tidy. (file_operations) Removed multi-file organize
 * @property {TeamLogUserTagsAddedType} [user_tags_added] - Available if .tag is
 * user_tags_added. (file_operations) Tagged a file
 * @property {TeamLogUserTagsRemovedType} [user_tags_removed] - Available if
 ...
 * @property {TeamLogFileRequestAutoCloseType} [file_request_auto_close] -
 * Available if .tag is file_request_auto_close. (file_requests) Auto closed
 * file request
 ...
 * (deprecated, no longer logged)
 * @property {TeamLogGroupExternalSharingSettingOverrideChangedType}
 * [group_external_sharing_setting_override_changed] - Available if .tag is
 * group_external_sharing_setting_override_changed. (groups) Changed group's
 ...
 * in')
 * @property {TeamLogAddonAssignedType} [addon_assigned] - Available if .tag is
 * addon_assigned. (members) Add-on Assigned
 * @property {TeamLogAddonRemovedType} [addon_removed] - Available if .tag is
 * addon_removed. (members) Add-on Removed
 * @property {TeamLogBackupAdminInvitationSentType}
 * [backup_admin_invitation_sent] - Available if .tag is
 * backup_admin_invitation_sent. (members) Invited members to activate Backup
 * @property {TeamLogBackupInvitationOpenedType} [backup_invitation_opened] -
 * Available if .tag is backup_invitation_opened. (members) Opened Backup invite
 ...
 * @property {TeamLogMemberChangeResellerRoleType} [member_change_reseller_role]
 * - Available if .tag is member_change_reseller_role. (members) Changed team
 * member reseller role
 ...
 * @property {TeamLogProductAssignedToMemberType} [product_assigned_to_member] -
 * Available if .tag is product_assigned_to_member. (members) Product assigned
 * to team member
 * @property {TeamLogProductRemovedFromMemberType} [product_removed_from_member]
 * - Available if .tag is product_removed_from_member. (members) Product removed
 * from team member
 ...
 * Dropbox Protect
 * @property {TeamLogProtectActionRemoveDomainsType}
 * [protect_action_remove_domains] - Available if .tag is
 * protect_action_remove_domains. (protect) Removed domains via Dropbox Protect
 ...
 * Protect policy
 * @property {TeamLogProtectReportViewType} [protect_report_view] - Available if
 * .tag is protect_report_view. (protect) Viewed a Dropbox Protect report
 ...
 * @property {TeamLogClassificationCreateReportFailType}
 * [classification_create_report_fail] - Available if .tag is
 * classification_create_report_fail. (reports) Couldn't create Classification
 * report
 ...
 * members data report
 * @property {TeamLogExternalSharingCreateReportType}
 * [external_sharing_create_report] - Available if .tag is
 * external_sharing_create_report. (reports) Created External sharing report
 * @property {TeamLogExternalSharingReportFailedType}
 * [external_sharing_report_failed] - Available if .tag is
 * external_sharing_report_failed. (reports) Couldn't create External sharing
 * report
 * @property {TeamLogMemberAccessDetailsCreateReportType}
 * [member_access_details_create_report] - Available if .tag is
 * member_access_details_create_report. (reports) Created member access report
 * @property {TeamLogMemberAccessDetailsCreateReportFailedType}
 * [member_access_details_create_report_failed] - Available if .tag is
 * member_access_details_create_report_failed. (reports) Couldn't generate
 ...
 * Paper docs
 * @property {TeamLogRansomwareAlertCreateReportType}
 * [ransomware_alert_create_report] - Available if .tag is
 * ransomware_alert_create_report. (reports) Created ransomware report
 * @property {TeamLogRansomwareAlertCreateReportFailedType}
 * [ransomware_alert_create_report_failed] - Available if .tag is
 * ransomware_alert_create_report_failed. (reports) Couldn't generate ransomware
 * report
 * @property {TeamLogSharedFoldersCreateReportType}
 * [shared_folders_create_report] - Available if .tag is
 * shared_folders_create_report. (reports) Created shared folders report
 * @property {TeamLogSharedFoldersCreateReportFailedType}
 * [shared_folders_create_report_failed] - Available if .tag is
 * shared_folders_create_report_failed. (reports) Couldn't generate shared
 * folders report
 ...
 * report
 * @property {TeamLogTeamFoldersCreateReportType} [team_folders_create_report] -
 * Available if .tag is team_folders_create_report. (reports) Created team
 * folders report
 * @property {TeamLogTeamFoldersCreateReportFailedType}
 * [team_folders_create_report_failed] - Available if .tag is
 * team_folders_create_report_failed. (reports) Couldn't generate team folders
 * report
 * @property {TeamLogTeamStorageCreateReportType} [team_storage_create_report] -
 * Available if .tag is team_storage_create_report. (reports) Created team
 * storage report
 * @property {TeamLogTeamStorageCreateReportFailedType}
 * [team_storage_create_report_failed] - Available if .tag is
 * team_storage_create_report_failed. (reports) Couldn't generate team storage
 * report
 ...
 * logged)
 * @property {TeamLogReplayFileSharedLinkCreatedType}
 * [replay_file_shared_link_created] - Available if .tag is
 * replay_file_shared_link_created. (sharing) Created shared link in Replay
 * @property {TeamLogReplayFileSharedLinkModifiedType}
 * [replay_file_shared_link_modified] - Available if .tag is
 * replay_file_shared_link_modified. (sharing) Changed shared link in Replay
 * @property {TeamLogReplayProjectTeamAddType} [replay_project_team_add] -
 * Available if .tag is replay_project_team_add. (sharing) Added member to
 * Replay Project
 * @property {TeamLogReplayProjectTeamDeleteType} [replay_project_team_delete] -
 * Available if .tag is replay_project_team_delete. (sharing) Removed member
 * from Replay Project
 * @property {TeamLogSendAndTrackFileAddedType} [send_and_track_file_added] -
 * Available if .tag is send_and_track_file_added. (sharing) File added to Send
 * and Track
 * @property {TeamLogSendAndTrackFileRenamedType} [send_and_track_file_renamed]
 * - Available if .tag is send_and_track_file_renamed. (sharing) File renamed in
 * Send and Track
 * @property {TeamLogSendAndTrackFileUpdatedType} [send_and_track_file_updated]
 * - Available if .tag is send_and_track_file_updated. (sharing) File updated in
 * Send and Track
 * @property {TeamLogSendAndTrackLinkCreatedType} [send_and_track_link_created]
 * - Available if .tag is send_and_track_link_created. (sharing) Link created in
 * Send and Track
 * @property {TeamLogSendAndTrackLinkDeletedType} [send_and_track_link_deleted]
 * - Available if .tag is send_and_track_link_deleted. (sharing) Link deleted in
 * Send and Track
 * @property {TeamLogSendAndTrackLinkUpdatedType} [send_and_track_link_updated]
 * - Available if .tag is send_and_track_link_updated. (sharing) Send and Track
 * Link Updated
 * @property {TeamLogSendAndTrackLinkViewedType} [send_and_track_link_viewed] -
 * Available if .tag is send_and_track_link_viewed. (sharing) Send and Track
 * Link Visited
 * @property {TeamLogSendAndTrackRemovedFileAndAssociatedLinksType}
 * [send_and_track_removed_file_and_associated_links] - Available if .tag is
 * send_and_track_removed_file_and_associated_links. (sharing) Send and Track
 * file and associated links deleted
 ...
 * expiration date
 * @property {TeamLogSharedLinkRemoveVisitorType} [shared_link_remove_visitor] -
 * Available if .tag is shared_link_remove_visitor. (sharing) Removed link
 * visitor
 ...
 * longer logged)
 * @property {TeamLogShmodelDisableDownloadsType} [shmodel_disable_downloads] -
 * Available if .tag is shmodel_disable_downloads. (sharing) Disabled downloads
 * for link (deprecated, no longer logged)
 * @property {TeamLogShmodelEnableDownloadsType} [shmodel_enable_downloads] -
 * Available if .tag is shmodel_enable_downloads. (sharing) Enabled downloads
 * for link (deprecated, no longer logged)
 ...
 * @property {TeamLogSignSignatureRequestCanceledType}
 * [sign_signature_request_canceled] - Available if .tag is
 * sign_signature_request_canceled. (signatures) Canceled signature request
 * @property {TeamLogSignSignatureRequestCompletedType}
 * [sign_signature_request_completed] - Available if .tag is
 * sign_signature_request_completed. (signatures) Completed signature request
 * @property {TeamLogSignSignatureRequestDeclinedType}
 * [sign_signature_request_declined] - Available if .tag is
 * sign_signature_request_declined. (signatures) Declined signature request
 * @property {TeamLogSignSignatureRequestOpenedType}
 * [sign_signature_request_opened] - Available if .tag is
 * sign_signature_request_opened. (signatures) Opened signature request
 * @property {TeamLogSignSignatureRequestReminderSentType}
 * [sign_signature_request_reminder_sent] - Available if .tag is
 * sign_signature_request_reminder_sent. (signatures) Sent signature request
 * reminder
 * @property {TeamLogSignSignatureRequestSentType} [sign_signature_request_sent]
 * - Available if .tag is sign_signature_request_sent. (signatures) Sent
 * signature request
 * @property {TeamLogSignTemplateCreatedType} [sign_template_created] -
 * Available if .tag is sign_template_created. (signatures) Created template
 * @property {TeamLogSignTemplateSharedType} [sign_template_shared] - Available
 * if .tag is sign_template_shared. (signatures) Shared template
 * @property {TeamLogRiscSecurityEventType} [risc_security_event] - Available if
 * .tag is risc_security_event. (sso) RISC security event received from external
 * provider
 ...
 * folder
 * @property {TeamLogTeamFolderSpaceLimitsChangeCapsTypeType}
 * [team_folder_space_limits_change_caps_type] - Available if .tag is
 * team_folder_space_limits_change_caps_type. (team_folders) Changed team folder
 * space limit enforcement type
 * @property {TeamLogTeamFolderSpaceLimitsChangeLimitType}
 * [team_folder_space_limits_change_limit] - Available if .tag is
 * team_folder_space_limits_change_limit. (team_folders) Changed team folder
 * space limit
 * @property {TeamLogTeamFolderSpaceLimitsChangeNotificationTargetType}
 * [team_folder_space_limits_change_notification_target] - Available if .tag is
 * team_folder_space_limits_change_notification_target. (team_folders) Changed
 ...
 * @property {TeamLogAdminEmailRemindersChangedType}
 * [admin_email_reminders_changed] - Available if .tag is
 * admin_email_reminders_changed. (team_policies) Changed admin reminder
 * settings for requests to join the team
 * @property {TeamLogAiThirdPartySharingDropboxBasePolicyChangedType}
 * [ai_third_party_sharing_dropbox_base_policy_changed] - Available if .tag is
 * ai_third_party_sharing_dropbox_base_policy_changed. (team_policies) Changed
 * AI third party sharing policy for team
 ...
 * downloads (deprecated, no longer logged)
 * @property {TeamLogAppleLoginChangePolicyType} [apple_login_change_policy] -
 * Available if .tag is apple_login_change_policy. (team_policies)
 * Enabled/disabled Apple login for team
 * @property {TeamLogAppPermissionsChangedType} [app_permissions_changed] -
 * Available if .tag is app_permissions_changed. (team_policies) Changed app
 * permissions
 ...
 * for team
 * @property {TeamLogCaptureTeamSpacePolicyChangedType}
 * [capture_team_space_policy_changed] - Available if .tag is
 * capture_team_space_policy_changed. (team_policies) Changed Capture team space
 * policy for team
 * @property {TeamLogCaptureTranscriptPolicyChangedType}
 * [capture_transcript_policy_changed] - Available if .tag is
 * capture_transcript_policy_changed. (team_policies) Changed Capture
 * transcription policy for team
 * @property {TeamLogClassificationChangePolicyType}
 * [classification_change_policy] - Available if .tag is
 * classification_change_policy. (team_policies) Changed classification policy
 * for team
 * @property {TeamLogComputerBackupPolicyChangedType}
 * [computer_backup_policy_changed] - Available if .tag is
 * computer_backup_policy_changed. (team_policies) Changed computer backup
 * policy for team
 * @property {TeamLogContentAdministrationPolicyChangedType}
 * [content_administration_policy_changed] - Available if .tag is
 * content_administration_policy_changed. (team_policies) Changed content
 * management setting
 * @property {TeamLogContentDeletionProtectionChangePolicyType}
 * [content_deletion_protection_change_policy] - Available if .tag is
 * content_deletion_protection_change_policy. (team_policies) Changed content
 * deletion protection policy for team
 * @property {TeamLogDashExternalSharingPolicyChangedType}
 * [dash_external_sharing_policy_changed] - Available if .tag is
 * dash_external_sharing_policy_changed. (team_policies) Changed Dash external
 * sharing policy for team
 ...
 * directory restrictions list
 * @property {TeamLogDropboxPasswordsPolicyChangedType}
 * [dropbox_passwords_policy_changed] - Available if .tag is
 * dropbox_passwords_policy_changed. (team_policies) Changed Dropbox Passwords
 * policy for team
 ...
 * @property {TeamLogExternalDriveBackupPolicyChangedType}
 * [external_drive_backup_policy_changed] - Available if .tag is
 * external_drive_backup_policy_changed. (team_policies) Changed external drive
 ...
 * @property {TeamLogFileProviderMigrationPolicyChangedType}
 * [file_provider_migration_policy_changed] - Available if .tag is
 * file_provider_migration_policy_changed. (team_policies) Changed File Provider
 * Migration policy for team
 ...
 * for team
 * @property {TeamLogFlexibleFileNamesPolicyChangedType}
 * [flexible_file_names_policy_changed] - Available if .tag is
 * flexible_file_names_policy_changed. (team_policies) Changed flexible file
 * names policy for team
 * @property {TeamLogFolderLinkRestrictionPolicyChangedType}
 * [folder_link_restriction_policy_changed] - Available if .tag is
 * folder_link_restriction_policy_changed. (team_policies) Changed folder link
 * restrictions policy for team
 ...
 * @property {TeamLogInviteAcceptanceEmailPolicyChangedType}
 * [invite_acceptance_email_policy_changed] - Available if .tag is
 * invite_acceptance_email_policy_changed. (team_policies) Changed invite accept
 * email policy for team
 ...
 * @property {TeamLogMicrosoftLoginChangePolicyType}
 * [microsoft_login_change_policy] - Available if .tag is
 * microsoft_login_change_policy. (team_policies) Enabled/disabled Microsoft
 * login for team
 ...
 * @property {TeamLogMultiTeamIdentityPolicyChangedType}
 * [multi_team_identity_policy_changed] - Available if .tag is
 * multi_team_identity_policy_changed. (team_policies) Changed multi-team
 ...
 * Paper-enabled users list
 * @property {TeamLogPasskeyLoginPolicyChangedType}
 * [passkey_login_policy_changed] - Available if .tag is
 * passkey_login_policy_changed. (team_policies) Changed passkey login policy
 * for team
 ...
 * @property {TeamLogPreviewsAiPolicyChangedType} [previews_ai_policy_changed] -
 * Available if .tag is previews_ai_policy_changed. (team_policies) Changed
 * Dropbox AI policy for team
 * @property {TeamLogReplayAddingPeoplePolicyChangedType}
 * [replay_adding_people_policy_changed] - Available if .tag is
 * replay_adding_people_policy_changed. (team_policies) Changed the policy for
 * adding people to Replay content
 * @property {TeamLogReplaySharingPolicyChangedType}
 * [replay_sharing_policy_changed] - Available if .tag is
 * replay_sharing_policy_changed. (team_policies) Changed the policy for sharing
 * Replay content
 ...
 * policy for team
 * @property {TeamLogSendAndTrackPolicyChangedType}
 * [send_and_track_policy_changed] - Available if .tag is
 * send_and_track_policy_changed. (team_policies) Changed “Send and track”
 * policy for team
 * @property {TeamLogSendExternalSharingPolicyChangedType}
 * [send_external_sharing_policy_changed] - Available if .tag is
 * send_external_sharing_policy_changed. (team_policies) Changed “Send and
 * track” external sharing policy for team
 * @property {TeamLogSendForSignaturePolicyChangedType}
 * [send_for_signature_policy_changed] - Available if .tag is
 * send_for_signature_policy_changed. (team_policies) Changed send for signature
 * policy for team
 * @property {TeamLogSharedLinkDefaultPermissionsPolicyChangedType}
 * [shared_link_default_permissions_policy_changed] - Available if .tag is
 * shared_link_default_permissions_policy_changed. (team_policies) Changed
 * shared link default permissions policy for team
 ...
 * @property {TeamLogSharingChangeLinkAllowChangeExpirationPolicyType}
 * [sharing_change_link_allow_change_expiration_policy] - Available if .tag is
 * sharing_change_link_allow_change_expiration_policy. (team_policies) Changed
 * the allow remove or change expiration policy for the links shared outside of
 * the team
 * @property {TeamLogSharingChangeLinkDefaultExpirationPolicyType}
 * [sharing_change_link_default_expiration_policy] - Available if .tag is
 * sharing_change_link_default_expiration_policy. (team_policies) Changed the
 * default expiration for the links shared outside of the team
 * @property {TeamLogSharingChangeLinkEnforcePasswordPolicyType}
 * [sharing_change_link_enforce_password_policy] - Available if .tag is
 * sharing_change_link_enforce_password_policy. (team_policies) Changed the
 ...
 * @property {TeamLogSignExternalSharingPolicyChangedType}
 * [sign_external_sharing_policy_changed] - Available if .tag is
 * sign_external_sharing_policy_changed. (team_policies) Changed Signatures
 * external sharing policy for team
 * @property {TeamLogSignTemplateCreationPermissionChangedType}
 * [sign_template_creation_permission_changed] - Available if .tag is
 * sign_template_creation_permission_changed. (team_policies) Changed template
 * creation permission
 ...
 * team
 * @property {TeamLogStackCrossTeamAccessPolicyChangedType}
 * [stack_cross_team_access_policy_changed] - Available if .tag is
 * stack_cross_team_access_policy_changed. (team_policies) Changed cross-team
 * Stack access policy for team
 * @property {TeamLogTeamBrandingPolicyChangedType}
 * [team_branding_policy_changed] - Available if .tag is
 * team_branding_policy_changed. (team_policies) Changed team branding policy
 * for team
 ...
 * setting for team
 * @property {TeamLogTeamExternalSharingControlsActivationStateChangedType}
 * [team_external_sharing_controls_activation_state_changed] - Available if .tag
 * is team_external_sharing_controls_activation_state_changed. (team_policies)
 * Changed external sharing controls activation state
 * @property {TeamLogTeamExternalSharingControlsRecipientListsChangedType}
 * [team_external_sharing_controls_recipient_lists_changed] - Available if .tag
 * is team_external_sharing_controls_recipient_lists_changed. (team_policies)
 * Changed approved or blocked entries for external sharing controls
 * @property {TeamLogTeamMemberStorageRequestPolicyChangedType}
 * [team_member_storage_request_policy_changed] - Available if .tag is
 * team_member_storage_request_policy_changed. (team_policies) Changed team
 * member storage request policy for team
 ...
 * .tag is tfa_change_policy. (team_policies) Changed two-factor authentication
 * setting for team
 ...
 * @property {TeamLogTopLevelContentPolicyChangedType}
 * [top_level_content_policy_changed] - Available if .tag is
 * top_level_content_policy_changed. (team_policies) Changed top level content
 * setting for team
 ...
 * @property {TeamLogDataResidencyMigrationRequestSuccessfulType}
 * [data_residency_migration_request_successful] - Available if .tag is
 * data_residency_migration_request_successful. (team_profile) Requested data
 * residency migration for team data
 * @property {TeamLogDataResidencyMigrationRequestUnsuccessfulType}
 * [data_residency_migration_request_unsuccessful] - Available if .tag is
 * data_residency_migration_request_unsuccessful. (team_profile) Request for
 ...
 * @property {TeamLogTeamProfileAddBackgroundType} [team_profile_add_background]
 * - Available if .tag is team_profile_add_background. (team_profile) Added team
 * background to display on shared link headers
 ...
 * @property {TeamLogTeamProfileChangeBackgroundType}
 * [team_profile_change_background] - Available if .tag is
 * team_profile_change_background. (team_profile) Changed team background
 ...
 * name
 * @property {TeamLogTeamProfileRemoveBackgroundType}
 * [team_profile_remove_background] - Available if .tag is
 * team_profile_remove_background. (team_profile) Removed team background
 * displayed on shared link headers
 ...
 * logo displayed on shared link headers
 * @property {TeamLogPasskeyAddType} [passkey_add] - Available if .tag is
 * passkey_add. (tfa) Added passkey for login
 * @property {TeamLogPasskeyRemoveType} [passkey_remove] - Available if .tag is
 * passkey_remove. (tfa) Removed passkey for login
 * @property {TeamLogTfaAddBackupPhoneType} [tfa_add_backup_phone] - Available
 * if .tag is tfa_add_backup_phone. (tfa) Added backup phone for two-factor
 * authentication
 * @property {TeamLogTfaAddSecurityKeyType} [tfa_add_security_key] - Available
 * if .tag is tfa_add_security_key. (tfa) Added security key for two-factor
 * authentication
 ...
 * .tag is tfa_change_status. (tfa) Enabled/disabled/changed two-factor
 ...
 * @typedef {Object} TeamLogExternalDriveBackupEligibilityStatus
 * @property {('exceed_license_cap'|'skip'|'success'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Checked external drive backup eligibility status.
 * @typedef {Object} TeamLogExternalDriveBackupEligibilityStatusCheckedDetails
 * @property {TeamLogDesktopDeviceSessionLogInfo} desktop_device_session_info -
 * Device's session logged information.
 * @property {TeamLogExternalDriveBackupEligibilityStatus} status - Current
 * eligibility status of external drive backup.
 * @property {number} number_of_external_drive_backup - Total number of valid
 * external drive backup for all the team members.
 */

/**
 * @typedef {Object} TeamLogExternalDriveBackupEligibilityStatusCheckedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogExternalDriveBackupPolicyChangedDetails
 * @property {TeamLogExternalDriveBackupPolicy} new_value - New external drive
 * backup policy.
 * @property {TeamLogExternalDriveBackupPolicy} previous_value - Previous
 * external drive backup policy.
 */

/**
 * @typedef {Object} TeamLogExternalDriveBackupPolicyChangedType
 * @property {string} description
 */

/**
 * External Drive Backup status
 * @typedef {Object} TeamLogExternalDriveBackupStatus
 * @property {('broken'|'created'|'created_or_broken'|'deleted'|'empty'|'unknown'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Modified external drive backup.
 * @typedef {Object} TeamLogExternalDriveBackupStatusChangedDetails
 * @property {TeamLogDesktopDeviceSessionLogInfo} desktop_device_session_info -
 * Device's session logged information.
 * @property {TeamLogExternalDriveBackupStatus} previous_value - Previous status
 * of this external drive backup.
 * @property {TeamLogExternalDriveBackupStatus} new_value - Next status of this
 * external drive backup.
 */

/**
 * @typedef {Object} TeamLogExternalDriveBackupStatusChangedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogExternalSharingControlsActivationState
 * @property {('active'|'disabled'|'legacy'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Created External sharing report.
 * @typedef {Object} TeamLogExternalSharingCreateReportDetails
 */

/**
 * @typedef {Object} TeamLogExternalSharingCreateReportType
 * @property {string} description
 */

/**
 * Couldn't create External sharing report.
 * @typedef {Object} TeamLogExternalSharingReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogExternalSharingReportFailedType
 * @property {string} description
 */

/**
 * External sharing setting
 * @typedef {Object} TeamLogExternalSharingSetting
 * @property {('allow'|'forbid'|'unset'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('enterprise_admin'|'not_enterprise_admin'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('organization'|'team'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogFedHandshakeAction
 * @property {('accepted_invite'|'canceled_invite'|'invite_expired'|'invited'|'rejected_invite'|'removed_team'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogFileAddFromAutomationDetails
 */

/**
 * @typedef {Object} TeamLogFileAddFromAutomationType
 * @property {string} description
 */
 ...
 * @property {string} [file_id] - Unique ID.
 ...
 * @typedef {Object} TeamLogFileProviderMigrationPolicyChangedDetails
 * @property {TeamPoliciesFileProviderMigrationPolicyState} new_value - To.
 * @property {TeamPoliciesFileProviderMigrationPolicyState} previous_value -
 * From.
 */

/**
 * @typedef {Object} TeamLogFileProviderMigrationPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogFileRequestAutoCloseDetails
 * @property {string} [file_request_id] - File request id. Might be missing due
 * to historical data gap.
 * @property {string} [reason] - Reason for the auto close.
...
/**
 * @typedef {Object} TeamLogFileRequestAutoCloseType
 * @property {string} description
 */
 ...
 * @property {boolean} [has_password] - Flag represents if this file request has
 * password.
 */
 ...
 * @typedef {Object} TeamLogFlexibleFileNamesPolicy
 * @property {('off'|'off_default'|'optional'|'optional_default'|'required'|'required_default'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed flexible file names policy for team.
 * @typedef {Object} TeamLogFlexibleFileNamesPolicyChangedDetails
 * @property {TeamLogFlexibleFileNamesPolicy} new_value - New flexible file
 * names policy.
 * @property {TeamLogFlexibleFileNamesPolicy} [previous_value] - Previous
 * flexible file names policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogFlexibleFileNamesPolicyChangedType
 * @property {string} description
 */
 ...
 * folders
 * @typedef {Object} TeamLogFolderLinkRestrictionPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed folder link restrictions policy for team.
 * @typedef {Object} TeamLogFolderLinkRestrictionPolicyChangedDetails
 * @property {TeamLogFolderLinkRestrictionPolicy} new_value - To.
 * @property {TeamLogFolderLinkRestrictionPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogFolderLinkRestrictionPolicyChangedType
 * @property {string} description
 */
 ...
 * @property {string} [account_id] - Filter the events by account ID. Return
 * only events with this account_id as either Actor, Context, or Participants.
 ...
 * event_type.
 * @property {TeamLogEventTypeArg} [event_type] - Filter the returned events to
 * a single event type. Note that event_type shouldn't be provided together with
 * category.
 */
 ...
 * @property {('account_id_not_found'|'invalid_time_range'|'invalid_filters'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogGovernancePolicyAddFolderFailedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {string} folder - Folder.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 * @property {string} [reason] - Reason.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyAddFolderFailedType
 * @property {string} description
 */

/**
 * Added folders to policy.
 * @typedef {Object} TeamLogGovernancePolicyAddFoldersDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 * @property {Array.<string>} [folders] - Folders.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyAddFoldersType
 * @property {string} description
 */

/**
 * Content disposed.
 * @typedef {Object} TeamLogGovernancePolicyContentDisposedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogDispositionActionType} disposition_type - Disposition type.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyContentDisposedType
 * @property {string} description
 */

/**
 * Activated a new policy.
 * @typedef {Object} TeamLogGovernancePolicyCreateDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogDurationLogInfo} duration - Duration in days.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 * @property {Array.<string>} [folders] - Folders.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyCreateType
 * @property {string} description
 */

/**
 * Deleted a policy.
 * @typedef {Object} TeamLogGovernancePolicyDeleteDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 */
...
/**
 * @typedef {Object} TeamLogGovernancePolicyDeleteType
 * @property {string} description
 */

/**
 * Edited policy.
 * @typedef {Object} TeamLogGovernancePolicyEditDetailsDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {string} attribute - Attribute.
 * @property {string} previous_value - From.
 * @property {string} new_value - To.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyEditDetailsType
 * @property {string} description
 */

/**
 * Changed policy duration.
 * @typedef {Object} TeamLogGovernancePolicyEditDurationDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogDurationLogInfo} previous_value - From.
 * @property {TeamLogDurationLogInfo} new_value - To.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 */

/**
 * @typedef {Object} TeamLogGovernancePolicyEditDurationType
 * @property {string} description
 */

/**
 * Created a policy download.
 * @typedef {Object} TeamLogGovernancePolicyExportCreatedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
...
/**
 * @typedef {Object} TeamLogGovernancePolicyExportCreatedType
 * @property {string} description
 */

/**
 * Removed a policy download.
 * @typedef {Object} TeamLogGovernancePolicyExportRemovedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {string} export_name - Export name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
...
/**
 * @typedef {Object} TeamLogGovernancePolicyExportRemovedType
 * @property {string} description
 */

/**
 * Removed folders from policy.
 * @typedef {Object} TeamLogGovernancePolicyRemoveFoldersDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 * @property {Array.<string>} [folders] - Folders.
 ...
 * @typedef {Object} TeamLogGovernancePolicyReportCreatedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
 */
...
/**
 * @typedef {Object} TeamLogGovernancePolicyReportCreatedType
 * @property {string} description
 */

/**
 * Downloaded content from a policy.
 * @typedef {Object} TeamLogGovernancePolicyZipPartDownloadedDetails
 * @property {string} governance_policy_id - Policy ID.
 * @property {string} name - Policy name.
 * @property {string} export_name - Export name.
 * @property {TeamLogPolicyType} [policy_type] - Policy type.
...
/**
 * @typedef {Object} TeamLogGovernancePolicyZipPartDownloadedType
 * @property {string} description
 */
 ...
 * @property {boolean} [is_company_managed] - Is company managed group.
 ...
 * @typedef {Object} TeamLogGroupExternalSharingSettingOverrideChangedDetails
 * @property {TeamLogExternalSharingSetting} new_value - New external sharing
 * setting.
 * @property {TeamLogExternalSharingSetting} previous_value - Previous external
 * sharing setting.
 */

/**
 * @typedef {Object} TeamLogGroupExternalSharingSettingOverrideChangedType
 * @property {string} description
 */
 ...
 * @property {string} [group_id] - The unique id of this group.
 * @property {string} [external_id] - External group ID.
 */
 ...
 * @typedef {Object} TeamLogInviteAcceptanceEmailPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed invite accept email policy for team.
 * @typedef {Object} TeamLogInviteAcceptanceEmailPolicyChangedDetails
 * @property {TeamLogInviteAcceptanceEmailPolicy} new_value - To.
 * @property {TeamLogInviteAcceptanceEmailPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogInviteAcceptanceEmailPolicyChangedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogInviteMethod
 * @property {('auto_approve'|'invite_link'|'member_invite'|'moved_from_another_team'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Additional information relevant when a new member joins the team.
 * @typedef {Object} TeamLogJoinTeamDetails
 * @property {Array.<TeamLogUserLinkedAppLogInfo>} linked_apps - Field is
 * deprecated. Linked applications. (Deprecated) Please use has_linked_apps
 * boolean field instead.
 * @property {Array.<TeamLogLinkedDeviceLogInfo>} linked_devices - Field is
 * deprecated. Linked devices. (Deprecated) Please use has_linked_devices
 * boolean field instead.
 * @property {Array.<TeamLogFolderLogInfo>} linked_shared_folders - Field is
 * deprecated. Linked shared folders. (Deprecated) Please use
 * has_linked_shared_folders boolean field instead.
 * @property {boolean} [was_linked_apps_truncated] - Field is deprecated.
 * (Deprecated) True if the linked_apps list was truncated to the maximum
 * supported length (50).
 * @property {boolean} [was_linked_devices_truncated] - Field is deprecated.
 * (Deprecated) True if the linked_devices list was truncated to the maximum
 * supported length (50).
 * @property {boolean} [was_linked_shared_folders_truncated] - Field is
 * deprecated. (Deprecated) True if the linked_shared_folders list was truncated
 ...
 * @property {('personal_information'|'test_only'|'user_defined_tag'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * Link Settings
 * @typedef {Object} TeamLogLinkSettingsLogInfo
 * @property {string} name - Link Name.
 * @property {boolean} require_email - Email Required.
 * @property {boolean} downloadable - Downloadable.
 * @property {boolean} password_required - Password required.
 * @property {string} url - Link URL.
 * @property {Timestamp} [expire_at] - Expires at.
 */
 ...
 * @property {('desktop_device_session'|'legacy_device_session'|'mobile_device_session'|'web_device_session'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('apple_oauth'|'first_party_token_exchange'|'google_oauth'|'kakao_oauth'|'lenovo_oauth'|'passkey'|'password'|'qr_code'|'saml'|'two_factor_authentication'|'web_session'|'microsoft_oauth'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} [login_id] - Login session id.
 */
 ...
 * @typedef {Object} TeamLogMalwareExclusionState
 * @property {number} excluded_file_hashes_count - The number of files that are
 * excluded from the monitoring for malware alerts.
 * @property {string} [file_path_from_last_exclusion] - The file path of the
 * last exclusion operation.
 * @property {string} [file_path_from_last_inclusion] - The file path of the
 * last inclusion operation.
 */

/**
 * Policy for deciding who can be added to Media Hub content
 * @typedef {Object} TeamLogMediaHubAddingPeoplePolicy
 * @property {('anyone'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamLogMediaHubAddingPeoplePolicyChangedType
 * @property {string} description
 */

/**
 * Policy for deciding whether Media Hub content can be downloaded
 * @typedef {Object} TeamLogMediaHubDownloadPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamLogMediaHubDownloadPolicyChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubFileDownloadedType
 * @property {string} description
 */

/**
 * Policy for deciding who Media Hub content can be shared with through links
 * @typedef {Object} TeamLogMediaHubLinkSharingPolicy
 * @property {('no_one'|'public'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamLogMediaHubLinkSharingPolicyChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubProjectTeamAddType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubProjectTeamDeleteType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubProjectTeamRoleChangedType
 * @property {string} description
 */

/**
 * Media Hub shared link audience
 * @typedef {Object} TeamLogMediaHubSharedLinkAudience
 * @property {('no_one'|'public'|'public_logged_in_only'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamLogMediaHubSharedLinkAudience} previous_value - Previous Media
...
/**
 * @typedef {Object} TeamLogMediaHubSharedLinkAudienceChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubSharedLinkCreatedType
 * @property {string} description
 */

/**
 * Media Hub shared link download setting
 * @typedef {Object} TeamLogMediaHubSharedLinkDownloadSetting
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamLogMediaHubSharedLinkTargetType} target_type - Media Hub
 * shared link target type.
 * @property {TeamLogMediaHubSharedLinkDownloadSetting} previous_value -
...
/**
 * @typedef {Object} TeamLogMediaHubSharedLinkDownloadSettingChangedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogMediaHubSharedLinkRevokedType
 * @property {string} description
 */

/**
 * Media Hub shared link target type
 * @typedef {Object} TeamLogMediaHubSharedLinkTargetType
 * @property {('bundle'|'project'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Created member access report.
 * @typedef {Object} TeamLogMemberAccessDetailsCreateReportDetails
 */

/**
 * Couldn't generate member access report.
 * @typedef {Object} TeamLogMemberAccessDetailsCreateReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogMemberAccessDetailsCreateReportFailedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogMemberAccessDetailsCreateReportType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogMemberChangeResellerRoleDetails
 * @property {TeamLogResellerRole} new_value - New reseller role. This field is
 * relevant when the reseller role is changed.
 * @property {TeamLogResellerRole} previous_value - Previous reseller role. This
 * field is relevant when the reseller role is changed or when the reseller role
 * is removed.
 */

/**
 * @typedef {Object} TeamLogMemberChangeResellerRoleType
 * @property {string} description
 */
 ...
 * @property {string} [new_team] - The user's new team name. This field is
 * relevant when the user is transferred off the team.
 * @property {string} [previous_team] - The user's previous team name. This
 * field is relevant when the user is transferred onto the team.
 */
 ...
 * @property {('delete'|'leave'|'offboard'|'offboard_and_retain_team_folders'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('disabled'|'everyone'|'specific_members'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('active'|'invited'|'moved_to_another_team'|'not_joined'|'removed'|'suspended'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogMemberTransferredInternalFields
 * @property {string} source_team_id - Internal only - team user was moved from.
 * @property {string} target_team_id - Internal only - team user was moved to.
 */

/**
 * Enabled/disabled Microsoft login for team.
 * @typedef {Object} TeamLogMicrosoftLoginChangePolicyDetails
 * @property {TeamLogMicrosoftLoginPolicy} new_value - New Microsoft login
 * policy.
 * @property {TeamLogMicrosoftLoginPolicy} [previous_value] - Previous Microsoft
 * login policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogMicrosoftLoginChangePolicyType
 * @property {string} description
 */

/**
 * Microsoft login policy
 * @typedef {Object} TeamLogMicrosoftLoginPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogMultiTeamIdentityPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed multi-team identity policy for team.
 * @typedef {Object} TeamLogMultiTeamIdentityPolicyChangedDetails
 * @property {TeamLogMultiTeamIdentityPolicy} new_value - New multi-team
 * identity policy.
 * @property {TeamLogMultiTeamIdentityPolicy} [previous_value] - Previous
 * multi-team identity policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogMultiTeamIdentityPolicyChangedType
 * @property {string} description
 */
 ...
 * @property {string} [ns_id] - Namespace ID.
...
subtypes.
 * @property {string} [account_id] - User unique ID.
...
/**
 * Added a label.
 * @typedef {Object} TeamLogObjectLabelAddedDetails
...
/**
 * Removed a label.
 * @typedef {Object} TeamLogObjectLabelRemovedDetails
 * @property {TeamLogLabelType} label_type - Labels mark a file or folder.
 */

/**
 * @typedef {Object} TeamLogObjectLabelRemovedType
 * @property {string} description
 */

/**
 * Updated a label's value.
 * @typedef {Object} TeamLogObjectLabelUpdatedValueDetails
 * @property {TeamLogLabelType} label_type - Labels mark a file or folder.
 */

/**
 * @typedef {Object} TeamLogObjectLabelUpdatedValueType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogOrganizeFolderWithTidyDetails
 */

/**
 * @typedef {Object} TeamLogOrganizeFolderWithTidyType
 * @property {string} description
 */
 ...
 * @property {('commenter'|'editor'|'viewer'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * users.
 * @property {string} [team_sharing_policy] - Sharing policy with team.
 */
 ...
 * @property {('group'|'user'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogPassPolicy
 * @property {('allow'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Added passkey for login.
 * @typedef {Object} TeamLogPasskeyAddDetails
 */

/**
 * @typedef {Object} TeamLogPasskeyAddType
 * @property {string} description
 */

/**
 * Passkey login policy
 * @typedef {Object} TeamLogPasskeyLoginPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed passkey login policy for team.
 * @typedef {Object} TeamLogPasskeyLoginPolicyChangedDetails
 * @property {TeamLogPasskeyLoginPolicy} new_value - New passkey login policy.
 * @property {TeamLogPasskeyLoginPolicy} [previous_value] - Previous passkey
 * login policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogPasskeyLoginPolicyChangedType
 * @property {string} description
 */

/**
 * Removed passkey for login.
 * @typedef {Object} TeamLogPasskeyRemoveDetails
 */

/**
 * @typedef {Object} TeamLogPasskeyRemoveType
 * @property {string} description
 */
 ...
 * @property {('australia_only'|'canada_only'|'europe_only'|'japan_only'|'none'|'uk_only'|'us_s3_only'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogPolicyType
 * @property {('disposition'|'retention'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Policy for deciding whether team users can use Previews AI
 * @typedef {Object} TeamLogPreviewsAiPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Dropbox AI policy for team.
 * @typedef {Object} TeamLogPreviewsAiPolicyChangedDetails
 * @property {TeamLogPreviewsAiPolicy} new_value - To.
 * @property {TeamLogPreviewsAiPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogPreviewsAiPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogProductAssignedToMemberDetails
 * @property {TeamLogUserNameLogInfo} user_name - User's name.
 * @property {TeamLogProductLogInfo} product_name - Product name.
 */

/**
 * @typedef {Object} TeamLogProductAssignedToMemberType
 * @property {string} description
 */

/**
 * Product logged information
 * @typedef {Object} TeamLogProductLogInfo
 * @property {string} product_name - Product name.
 */

/**
 * Product removed from team member.
 * @typedef {Object} TeamLogProductRemovedFromMemberDetails
 * @property {TeamLogUserNameLogInfo} user_name - User's name.
 * @property {TeamLogProductLogInfo} product_name - Product name.
 */

/**
 * @typedef {Object} TeamLogProductRemovedFromMemberType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogProtectActionRemoveDomainsDetails
 * @property {string} action_id - Action ID.
 */

/**
 * @typedef {Object} TeamLogProtectActionRemoveDomainsType
 * @property {string} description
 */
 ...
 * domains list.
 * @property {Array.<string>} [domains_removed] - Domains removed from the
 ...
 * @typedef {Object} TeamLogProtectReportCategory
 * @property {('overview'|'stale_access'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * The metric that a Dropbox Protect report corresponds to
 * @typedef {Object} TeamLogProtectReportMetric
 * @property {('external_modified_over_1_year'|'external_modified_over_1_year_company'|'external_modified_over_1_year_outside'|'external_modified_over_1_year_personal'|'external_modified_over_1_year_public'|'external_modified_over_2_years'|'external_modified_over_2_years_company'|'external_modified_over_2_years_outside'|'external_modified_over_2_years_personal'|'external_modified_over_2_years_public'|'external_modified_over_3_years'|'external_modified_over_3_years_company'|'external_modified_over_3_years_outside'|'external_modified_over_3_years_personal'|'external_modified_over_3_years_public'|'external_modified_over_5_years'|'external_modified_over_5_years_company'|'external_modified_over_5_years_outside'|'external_modified_over_5_years_personal'|'external_modified_over_5_years_public'|'folders_company'|'folders_internal'|'folders_outside'|'folders_personal'|'folders_public'|'internal_modified_over_1_year'|'internal_modified_over_1_year_company'|'internal_modified_over_1_year_outside'|'internal_modified_over_1_year_personal'|'internal_modified_over_1_year_public'|'internal_modified_over_2_years'|'internal_modified_over_2_years_company'|'internal_modified_over_2_years_outside'|'internal_modified_over_2_years_personal'|'internal_modified_over_2_years_public'|'internal_modified_over_3_years'|'internal_modified_over_3_years_company'|'internal_modified_over_3_years_outside'|'internal_modified_over_3_years_personal'|'internal_modified_over_3_years_public'|'internal_modified_over_5_years'|'internal_modified_over_5_years_company'|'internal_modified_over_5_years_outside'|'internal_modified_over_5_years_personal'|'internal_modified_over_5_years_public'|'items_all'|'items_company_access'|'items_internally_owned'|'items_modified_over_1_year'|'items_modified_over_3_years'|'items_outside_access'|'items_personal_access'|'items_public_links'|'other_folders'|'other_shared_drives'|'shared_drives_internal'|'shared_drives_outside'|'shared_drives_personal'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * The section that a Dropbox Protect report belongs to
 * @typedef {Object} TeamLogProtectReportSection
 * @property {('items'|'overview_other'|'owned_externally'|'owned_internally'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Viewed a Dropbox Protect report.
 * @typedef {Object} TeamLogProtectReportViewDetails
 * @property {TeamLogProtectReportCategory} report_category - The category of
 * the report that was viewed.
 * @property {TeamLogProtectReportSection} [report_section] - The section of the
 * report that was viewed.
 * @property {TeamLogProtectReportMetric} [report_metric] - The metric of the
 * report that was viewed.
 */

/**
 * @typedef {Object} TeamLogProtectReportViewType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogRansomwareAlertCreateReportDetails
 */

/**
 * Couldn't generate ransomware report.
 * @typedef {Object} TeamLogRansomwareAlertCreateReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogRansomwareAlertCreateReportFailedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogRansomwareAlertCreateReportType
 * @property {string} description
 */

/**
 * Completed ransomware restore process.
 * @typedef {Object} TeamLogRansomwareRestoreProcessCompletedDetails
 * @property {string} status - The status of the restore process.
 * @property {number} restored_files_count - Restored files count.
 * @property {number} restored_files_failed_count - Restored files failed count.
 */

/**
 * @typedef {Object} TeamLogRansomwareRestoreProcessCompletedType
 * @property {string} description
 */

/**
 * Started ransomware restore process.
 * @typedef {Object} TeamLogRansomwareRestoreProcessStartedDetails
 * @property {string} extension - Ransomware filename extension.
 */

/**
 * @typedef {Object} TeamLogRansomwareRestoreProcessStartedType
 * @property {string} description
 */

/**
 * Recipients Configuration
 * @typedef {Object} TeamLogRecipientsConfiguration
 * @property {TeamLogAlertRecipientsSettingType} [recipient_setting_type] -
 * Recipients setting type.
 * @property {Array.<Object>} [emails] - A list of user emails to notify.
 * @property {Array.<string>} [groups] - A list of groups to notify.
 */
 ...
 * @typedef {Object} TeamLogReplayAddingPeoplePolicy
 * @property {('anyone'|'team_and_allowlist'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed the policy for adding people to Replay content.
 * @typedef {Object} TeamLogReplayAddingPeoplePolicyChangedDetails
 * @property {TeamLogReplayAddingPeoplePolicy} new_value - To.
 * @property {TeamLogReplayAddingPeoplePolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogReplayAddingPeoplePolicyChangedType
 * @property {string} description
 */

/**
 * Deleted files in Replay.
 * @typedef {Object} TeamLogReplayFileDeleteDetails
 */

/**
 * @typedef {Object} TeamLogReplayFileDeleteType
 * @property {string} description
 */

/**
 * Downloaded files in Replay.
 * @typedef {Object} TeamLogReplayFileDownloadedDetails
 */

/**
 * @typedef {Object} TeamLogReplayFileDownloadedType
 * @property {string} description
 */

/**
 * Created shared link in Replay.
 * @typedef {Object} TeamLogReplayFileSharedLinkCreatedDetails
 * @property {boolean} [is_watermarked] - Indicates whether it was a watermark
 * share link.
 * @property {TeamLogReplayLinkAccess} [access] - The Replay sharing policy in
 * place when the link was created. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogReplayFileSharedLinkCreatedType
 * @property {string} description
 */

/**
 * Changed shared link in Replay.
 * @typedef {Object} TeamLogReplayFileSharedLinkModifiedDetails
 * @property {boolean} [is_watermarked] - Indicates whether it was a watermark
 * share link.
 * @property {TeamLogReplayLinkAccess} [access] - The Replay sharing policy in
 * place when the link was modified. Might be missing due to historical data
 * gap.
 */

/**
 * @typedef {Object} TeamLogReplayFileSharedLinkModifiedType
 * @property {string} description
 */

/**
 * Who can access this Replay link
 * @typedef {Object} TeamLogReplayLinkAccess
 * @property {('anyone_logged_in'|'no_login_required'|'team_and_approved'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Added member to Replay Project.
 * @typedef {Object} TeamLogReplayProjectTeamAddDetails
 */

/**
 * @typedef {Object} TeamLogReplayProjectTeamAddType
 * @property {string} description
 */

/**
 * Removed member from Replay Project.
 * @typedef {Object} TeamLogReplayProjectTeamDeleteDetails
 */

/**
 * @typedef {Object} TeamLogReplayProjectTeamDeleteType
 * @property {string} description
 */

/**
 * Policy for deciding who Replay content can be shared with through links
 * @typedef {Object} TeamLogReplaySharingPolicy
 * @property {('anyone'|'team_and_allowlist'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed the policy for sharing Replay content.
 * @typedef {Object} TeamLogReplaySharingPolicyChangedDetails
 * @property {TeamLogReplaySharingPolicy} new_value - To.
 * @property {TeamLogReplaySharingPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogReplaySharingPolicyChangedType
 * @property {string} description
 */

/**
 * Created a team project in Replay.
 * @typedef {Object} TeamLogReplayTeamProjectCreatedDetails
 * @property {string} name - Name of the newly created team project.
 */

/**
 * @typedef {Object} TeamLogReplayTeamProjectCreatedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamLogResellerRole
 * @property {('not_reseller'|'reseller_admin'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogRiscSecurityEventDetails
 * @property {string} event_type - RISC event type (e.g., account-disabled,
 * token-revoked).
 * @property {string} reason - Reason for the RISC event.
 * @property {string} issuer - Identity provider issuer (e.g.,
 * https://accounts.google.com).
 */

/**
 * @typedef {Object} TeamLogRiscSecurityEventType
 * @property {string} description
 */
...
/**
 * File added to Send and Track.
 * @typedef {Object} TeamLogSendAndTrackFileAddedDetails
 */

/**
 * @typedef {Object} TeamLogSendAndTrackFileAddedType
 * @property {string} description
 */

/**
 * File renamed in Send and Track.
 * @typedef {Object} TeamLogSendAndTrackFileRenamedDetails
 * @property {string} [previous_value] - Previous file name.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackFileRenamedType
 * @property {string} description
 */

/**
 * File updated in Send and Track.
 * @typedef {Object} TeamLogSendAndTrackFileUpdatedDetails
 */

/**
 * @typedef {Object} TeamLogSendAndTrackFileUpdatedType
 * @property {string} description
 */

/**
 * Link created in Send and Track.
 * @typedef {Object} TeamLogSendAndTrackLinkCreatedDetails
 * @property {TeamLogLinkSettingsLogInfo} link_settings - Link Settings.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackLinkCreatedType
 * @property {string} description
 */

/**
 * Link deleted in Send and Track.
 * @typedef {Object} TeamLogSendAndTrackLinkDeletedDetails
 * @property {string} shared_content_link - Shared content link.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackLinkDeletedType
 * @property {string} description
 */

/**
 * Send and Track Link Updated.
 * @typedef {Object} TeamLogSendAndTrackLinkUpdatedDetails
 * @property {TeamLogLinkSettingsLogInfo} link_settings - Link Settings.
 * @property {string} [previous_link_name] - Previous link name.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackLinkUpdatedType
 * @property {string} description
 */

/**
 * Send and Track Link Visited.
 * @typedef {Object} TeamLogSendAndTrackLinkViewedDetails
 * @property {TeamLogLinkSettingsLogInfo} link_settings - Link Settings.
 * @property {string} [email_address] - Visitor Email address.
 * @property {string} [link_owner] - Link Owner.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackLinkViewedType
 * @property {string} description
 */

/**
 * Policy for deciding whether team users can use Send and Track
 * @typedef {Object} TeamLogSendAndTrackPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed “Send and track” policy for team.
 * @typedef {Object} TeamLogSendAndTrackPolicyChangedDetails
 * @property {TeamLogSendAndTrackPolicy} new_value - To.
 * @property {TeamLogSendAndTrackPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogSendAndTrackPolicyChangedType
 * @property {string} description
 */

/**
 * Send and Track file and associated links deleted.
 * @typedef {Object} TeamLogSendAndTrackRemovedFileAndAssociatedLinksDetails
 */

/**
 * @typedef {Object} TeamLogSendAndTrackRemovedFileAndAssociatedLinksType
 * @property {string} description
 */

/**
 * Policy for deciding whether team users can share Send content externally
 * @typedef {Object} TeamLogSendExternalSharingPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed “Send and track” external sharing policy for team.
 * @typedef {Object} TeamLogSendExternalSharingPolicyChangedDetails
 * @property {TeamLogSendExternalSharingPolicy} new_value - To.
 * @property {TeamLogSendExternalSharingPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogSendExternalSharingPolicyChangedType
 * @property {string} description
 */

/**
 * Policy for controlling team access to send for signature feature
 * @typedef {Object} TeamLogSendForSignaturePolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed send for signature policy for team.
 * @typedef {Object} TeamLogSendForSignaturePolicyChangedDetails
 * @property {TeamLogSendForSignaturePolicy} new_value - New send for signature
 * policy.
 * @property {TeamLogSendForSignaturePolicy} previous_value - Previous send for
 * signature policy.
 */

/**
 * @typedef {Object} TeamLogSendForSignaturePolicyChangedType
 * @property {string} description
 */
...
@property {("desktop"|"mobile"|"web")} .tag - Tag identifying the subtype
variant.
 * @property {string} [session_id] - Session ID.
 */
 ...
 * @property {string} [sharing_permission] - Sharing permission.
 */
 ...
 * list.
 * @property {string} original_folder_name - Original shared folder name.
 * @property {string} [shared_folder_type] - Shared folder type.
 */
 ...
 * list.
 * @property {string} original_folder_name - Original shared folder name.
 * @property {string} [new_sharing_permission] - New sharing permission.
 ...
 * @property {string} [target_ns_id] - Target namespace ID.
 */
 ...
 * @property {('dont_inherit_members'|'inherit_members'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} [new_parent_ns_id] - New parent namespace ID.
 * @property {string} [previous_ns_path] - Previous namespace path.
 * @property {string} [new_ns_path] - New namespace path.
 */
 ...
 * @typedef {Object} TeamLogSharedFoldersCreateReportDetails
 */

/**
 * Couldn't generate shared folders report.
 * @typedef {Object} TeamLogSharedFoldersCreateReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogSharedFoldersCreateReportFailedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogSharedFoldersCreateReportType
 * @property {string} description
 */
 ...
 * @property {boolean} [is_consolidation_action] - Indicates whether this was a
 ...
 * @typedef {Object} TeamLogSharedLinkDefaultPermissionsPolicy
 * @property {('default'|'edit'|'view'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed shared link default permissions policy for team.
 * @typedef {Object} TeamLogSharedLinkDefaultPermissionsPolicyChangedDetails
 * @property {TeamLogSharedLinkDefaultPermissionsPolicy} new_value - To.
 * @property {TeamLogSharedLinkDefaultPermissionsPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogSharedLinkDefaultPermissionsPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogSharedLinkRemoveVisitorDetails
 */

/**
 * @typedef {Object} TeamLogSharedLinkRemoveVisitorType
 * @property {string} description
 */
 ...
 * @property {('no_one'|'password'|'public'|'team_only'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * outside of the team.
 * @typedef {Object} TeamLogSharingChangeLinkAllowChangeExpirationPolicyDetails
 * @property {TeamLogEnforceLinkPasswordPolicy} new_value - To.
 * @property {TeamLogEnforceLinkPasswordPolicy} [previous_value] - From.
 */

/**
 * @typedef {Object} TeamLogSharingChangeLinkAllowChangeExpirationPolicyType
 * @property {string} description
 */

/**
 * Changed the default expiration for the links shared outside of the team.
 * @typedef {Object} TeamLogSharingChangeLinkDefaultExpirationPolicyDetails
 * @property {TeamLogDefaultLinkExpirationDaysPolicy} new_value - To.
 * @property {TeamLogDefaultLinkExpirationDaysPolicy} [previous_value] - From.
 */

/**
 * @typedef {Object} TeamLogSharingChangeLinkDefaultExpirationPolicyType
 * @property {string} description
 */

/**
 * Changed the password requirement for the links shared outside of the team.
 * @typedef {Object} TeamLogSharingChangeLinkEnforcePasswordPolicyDetails
 * @property {TeamLogChangeLinkExpirationPolicy} new_value - To.
 * @property {TeamLogChangeLinkExpirationPolicy} [previous_value] - From.
 */

/**
 * @typedef {Object} TeamLogSharingChangeLinkEnforcePasswordPolicyType
 * @property {string} description
 */
 ...
 * @property {('default_no_one'|'default_private'|'default_public'|'only_private'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogShmodelDisableDownloadsDetails
 * @property
 * {(TeamLogNonTeamMemberLogInfo|TeamLogTeamMemberLogInfo|TeamLogTrustedNonTeamMemberLogInfo|TeamLogUserLogInfo)}
 * [shared_link_owner] - Shared link owner details. Might be missing due to
 * historical data gap.
...
/**
 * @typedef {Object} TeamLogShmodelDisableDownloadsType
 * @property {string} description
 */

/**
 * Enabled downloads for link.
 * @typedef {Object} TeamLogShmodelEnableDownloadsDetails
 * @property
 * {(TeamLogNonTeamMemberLogInfo|TeamLogTeamMemberLogInfo|TeamLogTrustedNonTeamMemberLogInfo|TeamLogUserLogInfo)}
 * [shared_link_owner] - Shared link owner details. Might be missing due to
 * historical data gap.
...
/**
 * @typedef {Object} TeamLogShmodelEnableDownloadsType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogSignExternalSharingPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed Signatures external sharing policy for team.
 * @typedef {Object} TeamLogSignExternalSharingPolicyChangedDetails
 * @property {TeamLogSignExternalSharingPolicy} new_value - To.
 * @property {TeamLogSignExternalSharingPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogSignExternalSharingPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogSignSignatureRequestCanceledDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestCanceledType
 * @property {string} description
 */

/**
 * Completed signature request.
 * @typedef {Object} TeamLogSignSignatureRequestCompletedDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestCompletedType
 * @property {string} description
 */

/**
 * Declined signature request.
 * @typedef {Object} TeamLogSignSignatureRequestDeclinedDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestDeclinedType
 * @property {string} description
 */

/**
 * Opened signature request.
 * @typedef {Object} TeamLogSignSignatureRequestOpenedDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestOpenedType
 * @property {string} description
 */

/**
 * Sent signature request reminder.
 * @typedef {Object} TeamLogSignSignatureRequestReminderSentDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestReminderSentType
 * @property {string} description
 */

/**
 * Sent signature request.
 * @typedef {Object} TeamLogSignSignatureRequestSentDetails
 * @property {string} recipient - The recipient of the signature request.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignSignatureRequestSentType
 * @property {string} description
 */

/**
 * Created template.
 * @typedef {Object} TeamLogSignTemplateCreatedDetails
 * @property {string} access_level - The access level of the template.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignTemplateCreatedType
 * @property {string} description
 */

/**
 * Changed template creation permission.
 * @typedef {Object} TeamLogSignTemplateCreationPermissionChangedDetails
 * @property {TeamLogSignTemplateCreationPermissionPolicy} new_value - New
 * template creation permission policy.
 * @property {TeamLogSignTemplateCreationPermissionPolicy} previous_value -
 * Previous template creation permission policy.
 */

/**
 * @typedef {Object} TeamLogSignTemplateCreationPermissionChangedType
 * @property {string} description
 */

/**
 * Policy for controlling if team members can create templates
 * @typedef {Object} TeamLogSignTemplateCreationPermissionPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Shared template.
 * @typedef {Object} TeamLogSignTemplateSharedDetails
 * @property {string} access_level - The access level of the template.
 * @property {string} file_name - The name of the related file.
 */

/**
 * @typedef {Object} TeamLogSignTemplateSharedType
 * @property {string} description
 */
 ...
 * @property {('near_quota'|'over_quota'|'within_quota'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} [new_value] - New single sign-on logout URL.
 */
 ...
 * teams
 * @typedef {Object} TeamLogStackCrossTeamAccessPolicy
 * @property {('allowed'|'default'|'disallowed'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed cross-team Stack access policy for team.
 * @typedef {Object} TeamLogStackCrossTeamAccessPolicyChangedDetails
 * @property {TeamLogStackCrossTeamAccessPolicy} new_value - New cross-team
 * Stack access policy.
 * @property {TeamLogStackCrossTeamAccessPolicy} [previous_value] - Previous
 * cross-team Stack access policy. Might be missing due to historical data gap.
 */

/**
 * @typedef {Object} TeamLogStackCrossTeamAccessPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogTeamBrandingPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed team branding policy for team.
 * @typedef {Object} TeamLogTeamBrandingPolicyChangedDetails
 * @property {TeamLogTeamBrandingPolicy} new_value - New team branding policy.
 * @property {TeamLogTeamBrandingPolicy} previous_value - Previous team branding
 * policy.
 */

/**
 * @typedef {Object} TeamLogTeamBrandingPolicyChangedType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogTeamEncryptionKeyActivateKeyDetails
 * @property {string} key_management_type - Type of key management.
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyActivateKeyType
 * @property {string} description
 */

/**
 * Canceled team encryption key deletion.
 * @typedef {Object} TeamLogTeamEncryptionKeyCancelKeyDeletionDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyCancelKeyDeletionType
 * @property {string} description
 */

/**
 * Created team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyCreateKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyCreateKeyType
 * @property {string} description
 */

/**
 * Deactivated team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyDeactivateKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyDeactivateKeyType
 * @property {string} description
 */

/**
 * Deleted team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyDeleteKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyDeleteKeyType
 * @property {string} description
 */

/**
 * Disabled team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyDisableKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyDisableKeyType
 * @property {string} description
 */

/**
 * Enabled team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyEnableKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyEnableKeyType
 * @property {string} description
 */

/**
 * Rotated team encryption key.
 * @typedef {Object} TeamLogTeamEncryptionKeyRotateKeyDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyRotateKeyType
 * @property {string} description
 */

/**
 * Scheduled encryption key deletion.
 * @typedef {Object} TeamLogTeamEncryptionKeyScheduleKeyDeletionDetails
 */

/**
 * @typedef {Object} TeamLogTeamEncryptionKeyScheduleKeyDeletionType
 * @property {string} description
 */
 ...
 * behalf the actor performed the action.
...
/**
 * Changed external sharing controls activation state.
 * @typedef {Object} TeamLogTeamExternalSharingControlsActivationStateChangedDetails
 * @property {TeamLogExternalSharingControlsActivationState}
 * previous_activation_state - Previous external sharing controls activation
 * state.
 * @property {TeamLogExternalSharingControlsActivationState}
 * new_activation_state - New external sharing controls activation state.
 */

/**
 * @typedef {Object} TeamLogTeamExternalSharingControlsActivationStateChangedType
 * @property {string} description
 */

/**
 * Changed approved or blocked entries for external sharing controls.
 * @typedef {Object} TeamLogTeamExternalSharingControlsRecipientListsChangedDetails
 * @property {Array.<string>} [added_approved_entries] - Added approved external
 * sharing recipient entries.
 * @property {Array.<string>} [removed_approved_entries] - Removed approved
 * external sharing recipient entries.
 * @property {Array.<string>} [added_blocked_entries] - Added blocked external
 * sharing recipient entries.
 * @property {Array.<string>} [removed_blocked_entries] - Removed blocked
 * external sharing recipient entries.
 */

/**
 * @typedef {Object} TeamLogTeamExternalSharingControlsRecipientListsChangedType
 * @property {string} description
 */
...
/**
 * Team folder space limit notification target
 * @typedef {Object} TeamLogTeamFolderNotificationTarget
 * @property {('admins'|'both'|'editors'|'silent'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogTeamFolderSpaceCapsType
 * @property {('hard'|'off'|'soft'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed team folder space limit enforcement type.
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeCapsTypeDetails
 * @property {TeamLogTeamFolderSpaceCapsType} new_caps_type - New enforcement
 * type.
 * @property {TeamLogTeamFolderSpaceCapsType} [previous_caps_type] - Previous
 * enforcement type.
 */

/**
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeCapsTypeType
 * @property {string} description
 */

/**
 * Changed team folder space limit.
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeLimitDetails
 * @property {number} new_limit_bytes - New limit in bytes.
 * @property {number} [previous_limit_bytes] - Previous limit in bytes.
 */

/**
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeLimitType
 * @property {string} description
 */

/**
 * Changed team folder space limit notification target.
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeNotificationTargetDetails
 * @property {TeamLogTeamFolderNotificationTarget} new_target - New notification
 * target.
 * @property {TeamLogTeamFolderNotificationTarget} [previous_target] - Previous
 * notification target.
 */

/**
 * @typedef {Object} TeamLogTeamFolderSpaceLimitsChangeNotificationTargetType
 * @property {string} description
 */

/**
 * Created team folders report.
 * @typedef {Object} TeamLogTeamFoldersCreateReportDetails
 */

/**
 * Couldn't generate team folders report.
 * @typedef {Object} TeamLogTeamFoldersCreateReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogTeamFoldersCreateReportFailedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogTeamFoldersCreateReportType
 * @property {string} description
 */
 ...
 * the team.
 * @property {boolean} [additional_license_purchase] - True if the invitation
 * incurred an additional license purchase.
 */
 ...
 * @property {string} [display_name] - User display name.
 * @property {string} [email] - User email address.
 * @property {string} [team_member_id] - Team member ID.
...
/**
 * Policy for deciding whether team members can request increased storage limits
 * from admins
 * @typedef {Object} TeamLogTeamMemberStorageRequestPolicy
 * @property {('default'|'disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed team member storage request policy for team.
 * @typedef {Object} TeamLogTeamMemberStorageRequestPolicyChangedDetails
 * @property {TeamLogTeamMemberStorageRequestPolicy} new_value - New team member
 * storage request policy.
 * @property {TeamLogTeamMemberStorageRequestPolicy} [previous_value] - Previous
 * team member storage request policy. Might be missing due to historical data
 * gap.
 */

/**
 * @typedef {Object} TeamLogTeamMemberStorageRequestPolicyChangedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogTeamMembershipType
 * @property {('free'|'full'|'guest'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogTeamProfileAddBackgroundDetails
 */

/**
 * @typedef {Object} TeamLogTeamProfileAddBackgroundType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogTeamProfileChangeBackgroundDetails
 */

/**
 * @typedef {Object} TeamLogTeamProfileChangeBackgroundType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogTeamProfileRemoveBackgroundDetails
 */

/**
 * @typedef {Object} TeamLogTeamProfileRemoveBackgroundType
 * @property {string} description
 */
 ...
 * @typedef {Object} TeamLogTeamStorageCreateReportDetails
 */

/**
 * Couldn't generate team storage report.
 * @typedef {Object} TeamLogTeamStorageCreateReportFailedDetails
 * @property {TeamTeamReportFailureReason} failure_reason - Failure reason.
 */

/**
 * @typedef {Object} TeamLogTeamStorageCreateReportFailedType
 * @property {string} description
 */

/**
 * @typedef {Object} TeamLogTeamStorageCreateReportType
 * @property {string} description
 */

/**
 * Added backup phone for two-factor authentication.
 ...
 * @property {('authenticator'|'disabled'|'enabled'|'sms'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('days'|'hours'|'milliseconds'|'minutes'|'months'|'seconds'|'weeks'|'years'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Policy for deciding whether members can edit team folders at the top level of
 * the team space
 * @typedef {Object} TeamLogTopLevelContentPolicy
 * @property {('admins_only'|'everyone'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * Changed top level content setting for team.
 * @typedef {Object} TeamLogTopLevelContentPolicyChangedDetails
 * @property {TeamLogTopLevelContentPolicy} new_value - To.
 * @property {TeamLogTopLevelContentPolicy} previous_value - From.
 */

/**
 * @typedef {Object} TeamLogTopLevelContentPolicyChangedType
 * @property {string} description
 */
 ...
 * @property {string} [display_name] - User display name.
 * @property {string} [email] - User email address.
 * @property {TeamLogTeamLogInfo} [team] - Details about this user's trusted
 * team.
 */

/**
 * @typedef {Object} TeamLogTrustedNonTeamMemberType
 * @property {('enterprise_admin'|'multi_instance_admin'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamLogTrustedTeamsRequestAction
 * @property {('accepted'|'declined'|'expired'|'invited'|'revoked'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamLogUndoNamingConventionDetails
 */
 ...
 * @typedef {Object} TeamLogUndoOrganizeFolderWithTidyDetails
 */

/**
 * @typedef {Object} TeamLogUndoOrganizeFolderWithTidyType
 * @property {string} description
 */
...
@property {("non_team_member"|"team_member"|"trusted_non_team_member")} .tag -
Tag identifying the subtype variant.
 * @property {string} [account_id] - User unique ID.
 * @property {string} [display_name] - User display name.
 * @property {string} [email] - User email address.
...
/**
 * Tagged a file.
 * @typedef {Object} TeamLogUserTagsAddedDetails
 * @property {Array.<string>} values - values.
 */

/**
 * @typedef {Object} TeamLogUserTagsAddedType
 * @property {string} description
 */

/**
 * Removed tags.
 * @typedef {Object} TeamLogUserTagsRemovedDetails
 * @property {Array.<string>} values - values.
 */

/**
 * @typedef {Object} TeamLogUserTagsRemovedType
 * @property {string} description
 */
...
/**
 * @typedef {Object} TeamPoliciesComputerBackupPolicyState
 ...
 * team.
 * @typedef {Object} TeamPoliciesDefaultLinkExpirationDaysPolicy
 * @property {('none'|'day_1'|'day_3'|'day_7'|'day_30'|'day_90'|'day_180'|'year_1'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @typedef {Object} TeamPoliciesEnforceLinkPasswordPolicy
 * @property {('optional'|'required'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamPoliciesFileProviderMigrationPolicyState
 * @property {('disabled'|'enabled'|'default'|'immediate'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * shared links.
 * @typedef {Object} TeamPoliciesSharedFolderBlanketLinkRestrictionPolicy
 * @property {('members'|'anyone'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('default_public'|'default_team_only'|'team_only'|'default_no_one'|'other')} .tag - Tag identifying the union variant.
 */

/**
 * @typedef {Object} TeamPoliciesSharedLinkDefaultPermissionsPolicy
 * @property {('default'|'edit'|'view'|'other')} .tag - Tag identifying the union variant.
 */
...
/**
 * @typedef {Object} TeamPoliciesSuggestMembersPolicy
 * @property {('disabled'|'enabled'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {TeamPoliciesSuggestMembersPolicy} suggest_members_policy - The
 * team policy on if teammembers are allowed to suggest users for admins to
 * invite to the team.
 * @property {TeamPoliciesTopLevelContentPolicy} top_level_content_policy -
 * Policy for deciding whether members can edit team folders at the top level of
 * the team space.
 */
 ...
 * @property {TeamPoliciesGroupCreation} group_creation_policy - Who can create
 * groups.
 * @property {TeamPoliciesSharedFolderBlanketLinkRestrictionPolicy}
 * shared_folder_link_restriction_policy - Who can view links to content in
 * shared folders.
 * @property {TeamPoliciesEnforceLinkPasswordPolicy}
 * enforce_link_password_policy - If passwords are required for new links shared
 * outside the team.
 * @property {TeamPoliciesDefaultLinkExpirationDaysPolicy}
 * default_link_expiration_days_policy - Default expiration date for new links
 * shared outside the team.
 * @property {TeamPoliciesSharedLinkDefaultPermissionsPolicy}
 * shared_link_default_permissions_policy - Default access level for new links
 * shared by team members.
 */

/**
 * @typedef {Object} TeamPoliciesTopLevelContentPolicy
 * @property {('admin_only'|'everyone'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {string} account_id - The user's unique and stable Dropbox ID.
 * @property {UsersName} name - Details of a user's name.
 * @property {string} email - The user's email address. Do not rely on this
 * without checking the email_verified field. Even then, it's possible that the
 * user has since lost access to their email. Note: email is not a unique or
 * stable identifier for a Dropbox account. Users can change their email, and
 * emails can be reused by different accounts. Apps should not use email as a
 * key for account identification; use account_id instead.
 ...
 * @typedef {Object} UsersDistinctMemberHomeValue
 * @property {boolean} [enabled] - Available if .tag is enabled. When this value
 * is True, the user have distinct home and root ns. When the value is False the
 ...
 * @property {TeamPoliciesTopLevelContentPolicy} top_level_content_policy - Team
 * policy governing whether members can edit team folders at the top level of
 * the team space.
 */
 ...
 * @typedef {Object} UsersTeamSharedDropboxValue
 * @property {boolean} [enabled] - Available if .tag is enabled. When this value
 * is True, the user have a shared team root. When the value is False the user
 * have distinct root.
 * @property {('enabled'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * @property {('paper_as_files'|'file_locking'|'team_shared_dropbox'|'distinct_member_home'|'other')} .tag - Tag identifying the union variant.
 */
 ...
 * file_locking.
 * @property {UsersTeamSharedDropboxValue} [team_shared_dropbox] - Available if
 * .tag is team_shared_dropbox.
 * @property {UsersDistinctMemberHomeValue} [distinct_member_home] - Available
 * if .tag is distinct_member_home.
 * @property {('paper_as_files'|'file_locking'|'team_shared_dropbox'|'distinct_member_home'|'other')} .tag - Tag identifying the union variant.
 */
