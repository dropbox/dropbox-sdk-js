...
/*ROUTES*/
     ...
     * body, in the order delineated by UploadSessionAppendBatchArg.entries and
     * their individual lengths indicated by
     * UploadSessionAppendBatchArgEntry.length. A single request should not
     ...
     * use uploadSessionAppendV2() or uploadSessionAppendBatch() to add more
     * data, then uploadSessionFinish() or uploadSessionFinishBatchV2() to save
     ...
     * be used for a maximum of 7 days. Attempting to use a
     * UploadSessionStartResult.session_id with uploadSessionAppendV2() or other
     ...
     * uploadSessionAppendV2(), and uploadSessionFinish() calls (or their batch
     ...
     * file data in concurrent uploadSessionAppendV2() requests, with a few
     ...
     * uploadSessionAppendV2() or uploadSessionAppendBatch(). Also, the length
     * of the uploaded data in a call to uploadSessionAppendV2() or
     ...
     * in October 2026. Returns a list of LinkMetadata objects for this user,
     ...
     * shared folder is inside another shared folder. You'll need to call
     ...
     * the client should periodically poll membersRemoveJobStatusGet().
     *
     * Route attributes:
     *   scope: members.delete
     *
     ...
     * in the process of archiving (indicated by TeamFolderMetadata.status with
     * 'archive_in_progress'). To confirm that the team folder is fully
     * archived, check the field TeamFolderMetadata.status in the response for
     * the value 'archived'. Permission : Team member file access.
     *
     * Route attributes:
     *   scope: team_data.content.write
     *
