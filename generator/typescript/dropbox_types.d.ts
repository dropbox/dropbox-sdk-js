declare module DropboxTypes {
  ...
  namespace team_log {
    ...
    /**
     * Changed access type of invitee to shared file/folder before invite
     * accepted.
     */
