...
declare module DropboxTypes {
  class Dropbox extends DropboxBase {
     ...
     * input cannot be a single file. Consider this deprecated by
     * downloadZipV2().
     *
     * When an error occurs, the route rejects the promise with type
     ...
     *
     * When an error occurs, the route rejects the promise with type
     * Error<files.DownloadZipErrorV2>.
     * @param arg The request parameters.
     */
    public filesDownloadZipV2(arg: files.DownloadZipArgV2): Promise<files.DownloadZipResultV2>;
